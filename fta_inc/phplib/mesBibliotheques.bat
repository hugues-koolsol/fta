...
rem Ce fichier est un .bat pour windows mais on peut faire un .sh pour linux en recopiant les lignes çi dessous
...
rem =========================================================
rem composer require phpmyadmin/sql-parser