...
function enregistrer_les_sources_en_base(&$data){
 ...
 ';
    ...
    */
    ...
    $tt=sql_62(array( 
     'T0_chi_id_source'       => $data['input']['params']['id_source'], 
...
function remplacer_des_chaine1(&$data){
    ...
    */
    ...
    WHERE  `chp_valeur_rev` = \''.sq0($data['input']['parametre']['chaine_a_remplacer']).'\''.' AND `chx_source_rev` IN ('.sq0($liste_des_id_des_sources).') ';
    /*
