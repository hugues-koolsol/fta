...
CREATE TABLE
    /* meta((table,'tbl_bdds'),(nom_long_de_la_table,'à faire tbl_bdds'),(nom_court_de_la_table,'à faire tbl_bdds'),(nom_bref_de_la_table,'à faire tbl_bdds'),(transform_table_sur_svg,transform(translate(489,238)))) */
     tbl_bdds( 
