...
//
$o1='';
$a=array( 'title' => 'Connexion', 'description' => 'connexion à l\'application');
$o1=html_header1($a);
$o1=concat($o1,session_messages());
//
//  ========================================================
...
if((isset($_SESSION[APP_KEY]['sess_id_utilisateur']) && 0 != $_SESSION[APP_KEY]['sess_id_utilisateur'])){
    ...
    $o1='<form id="boite_de_connexion" method="get"><span>logout</span>
      <input type="hidden" name="a" id="a" value="logout"></input>
      <input type="submit" value="envoyer"></input></form>';
}else{
    //
    //======================================================== 
    //... si oui on lui affiche un formulaire de connexion ...
    //======================================================== 
    //
    $o1='<form id="boite_de_connexion" method="post" onsubmit="return checkSubmit1()">
                                  <label for="nom_de_connexion">Nom de connexion</label>
                                  <input type="text" name="nom_de_connexion" id="nom_de_connexion" value=""></input>
                                  <label for="mot_de_passe">mot de passe</label>
                                  <input type="password" name="mot_de_passe" id="mot_de_passe" value=""></input>
