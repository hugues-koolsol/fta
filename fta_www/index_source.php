...
//  var tarea=dogid('txtar1');
  ...
  // console.log('texteDebut=',texteDebut);
  // console.log('texteFin=',texteFin);
  tarea.value=texteDebut;
//  console.log('avant tarea.scrollTop='+tarea.scrollTop)
  tarea.scrollTo(0,9999999);
//  console.log('apres tarea.scrollTop='+tarea.scrollTop);
