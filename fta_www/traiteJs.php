...
?>
        ...
        <div class="menuScroller">
            <ul>
                ...
                <li><a href="javascript:bouton_dans_traite_js_transform_textarea_js_en_rev_avec_acorn3( 'txtar1' , 'txtar2' )"  class="yysucces">convertir module acorn 3</a>&nbsp;</li>
...
$par=array(
    'js_a_inclure'     =>array('js/javascript.js','js/javascript.js','js/convertit-html-en-rev1.js','js/convertit-js-en-rev1.js','js/jslib/acorn.js'),
