...
function js_tabTojavascript1(tab,id,dansFonction,dansInitialisation,niveau,dansCascade){
    ...
    for(i=id;(i < l01) && (tab[i][3] >= tab[id][3]);i=i+1){
        ...
        if(tab[i][7]==id_du_parent){
            ...
            if(((tab[i][1] == 'break') || (tab[i][1] == 'continue') || ('useStrict' === tab[i][1]) || ('debugger' === tab[i][1])) && (tab[i][2] == 'f')){
                ...
                if(tab[i][8] == 0){
                    ...
                    if(tab[i][8] == 1){
                        if(tab[i+1][2] == 'c'){
                            ...
                            if(obj.status === true){
                                t+='return('+obj.value+')'+terminateur+''; // return _super.call(this, code, options, delegate) || this;
                            }else{
                        ...
                        }else if((tab[i+1][2] == 'f') && (tab[i+1][1] == 'mult' ) ){
                            var objOperation = TraiteOperations1(tab,i+1,niveau);
                            if(objOperation.status == true){
                                t+=espcLigne;
                                t+='return('+objOperation.value+')';
                            }else{
                                return(logerreur({status:false,value:t,id:i,tab:tab,message:'erreur 0165 sur return '}));
                            }
                         
                        }else if((tab[i+1][2] == 'f') && (tab[i+1][1] == 'plus' || (tab[i+1][1] == 'concat') || (tab[i+1][1] == 'moins')  )){
                            t+=espcLigne;
                            ...
                            if(objtestLi.status == true){
                                ...
                                return(logerreur({status:false,value:t,id:i,tab:tab,message:'erreur 0183 sur return'}));
                            }
                        }else{
                ...
                var nomFonction='';
                var typeFonction=''; // lire ou écrire pour les classes
                var modeFonction=''; // privée pour les classes
                var asynchrone='';
                        ...
                        for(j=(positionDeclarationFonction+1);(j < l01) && (tab[j][3] > tab[positionDeclarationFonction][3]);j=j+1){
                            if((tab[j][1] === 'nom') && (tab[j][3] === (tab[positionDeclarationFonction][3]+1))){
                                if(tab[j][8] == 1){
                                    ...
                                    return(logerreur({status:false,value:t,id:id,tab:tab,message:'0206 le nom de la fonction doit être sous la forme   '}));
                                }
                            }else if((tab[j][1] === 'asynchrone') && (tab[j][3] === (tab[positionDeclarationFonction][3]+1))){
                                if(tab[j][8] == 0){
                                    asynchrone='async ';
                                }else{
                                    return(logerreur({status:false,value:t,id:id,tab:tab,message:'0223 asynchrone doit être une fonction sans paramètres   '}));
                                }
                            }else if((tab[j][1] === 'mode') && (tab[j][3] == (tab[positionDeclarationFonction][3]+1))){
                                if(tab[j][8] == 1 && tab[j+1][1] === 'privée' ){
                                    modeFonction='#';
                                }else{
                                    return(logerreur({status:false,value:t,id:id,tab:tab,message:'0212  mode de la classe '}));
                                }
                                ...
                                if(tab[j][8] == 1 && ( tab[j+1][1] === 'lire' ) ){
                                    ...
                                    return(logerreur({status:false,value:t,id:id,tab:tab,message:' 0220 le type de la classe doit être écrire ou lire '}));
                                }
                            }
                        }
                        argumentsFonction='';
                ...
                if(obj.status === true){
                    ...
                    return(logerreur({status:false,value:t,id:i,tab:tab,message:'dans flux cascade, 0216'}));
                }
    ...
    //            debugger
                ...
                for(var j=i+1;j<l01 && tab[j][3]>tab[i][3];j++){
                 if(tab[j][7]==i){
                  if(tab[j][1]==='quand' && tab[j][2]==='f' && tab[j][8]===1 ){
                     ...
                     if(tab[k][1]==='valeurNonPrevue' && tab[k][2]==='f' && tab[k][8]===0 ){
                      ...
                      if(tab[k+1][2]=='f'){
                         ...
                         if(obj.status===true){
                             ...
                             return logerreur({status:false,value:t,id:ind,tab:tab,message:'javascript dans bascule 0274'});
                         }
                      }else{
                      ...
                      if(tab[k][8]>=1){
                       niveau+=2;
                       var obj= js_tabTojavascript1(tab,k+1,true,false,niveau); //obj=php_tabToPhp1(tab,k+1,false,false,niveau);
                       niveau-=2;
                       if(obj.status===true){
                        InstructionsCas=obj.value;
                       }else{
                        return logerreur({status:false,value:t,id:k,tab:tab,message:'javascript dans bascule 0287'});     
                       }
                      }else{
                       InstructionsCas='';
                      }
                     }else{
                      return logerreur({status:false,value:t,id:i,tab:tab,message:'javascript dans bascule 0293'});     
                     }
                    }        
                   }
                   ...
                   return logerreur({status:false,value:t,id:i,tab:tab,message:'javascript dans bascule 0307 '});     
                  }
                 }
                }
                    ...
                    if((tabdeclare[0][2] == 'c') && (tabdeclare[1][2] == 'c')){
                        ...
                        if((tabdeclare[0][2] == 'c') && (tabdeclare[1][2] == 'f')){
                            if((tabdeclare[1][1] == 'new') && (tabdeclare[1][8] == 1) && (tab[i+3][1] == 'appelf')){
                                ...
                                obj=js_traiteAppelFonction(tab,tabdeclare[1][0]+1,true,niveau,false); // tab,i,dansConditionOuDansFonction,niveau,recursif
                                if(obj.status == true){
                                ...
                                if(objOperation.status == true){
                                    t+=prefixe_declaration+tabdeclare[0][1]+' = '+objOperation.value+''+terminateur+'';
                                }else{
                                    return(logerreur({status:false,value:t,id:i,tab:tab,message:'erreur 1048 sur declaration '}));
                                }
                                ...
                                if(objtestLi.status == true){
                                    ...
                                    return(logerreur({status:false,value:t,id:tabdeclare[0][0],tab:tab,message:'erreur sur declaration 0796'}));
                                }
                            }else if((tabdeclare[1][2] === 'f') 
                                && (
                                    tabdeclare[1][1] === 'affecte'
                                 || tabdeclare[1][1] === 'postinc'
                                ) 
                            ){
                                ...
                                if(objtestLi.status == true){
                                    ...
                                    return(logerreur({status:false,value:t,id:tabdeclare[0][0],tab:tab,message:'erreur sur declaration 0803'}));
                                }
                            }else if((tabdeclare[1][1] == 'defTab') && (tabdeclare[1][2] === 'f')){
                                var objtestLi = js_traiteDefinitionTableau(tab,tabdeclare[1][0],niveau,{}); //js_tabTojavascript1(tab,tabdeclare[1][0],true,true,niveau)
                                if(objtestLi.status == true){
                                    t+=prefixe_declaration+tabdeclare[0][1]+' = '+objtestLi.value+''+terminateur+'';
                                }else{
                                    return(logerreur({status:false,value:t,id:tabdeclare[0][0],tab:tab,message:'erreur sur declaration 0803'}));
                ...
                if((tab[i+1][1] == 'new') && (tab[i+1][8] == 1) && (tab[i+2][1] == 'appelf')){
                    ...
                    return(logerreur({status:false,value:t,id:i,tab:tab,message:'erreur dans throw 1040'}));
                }
                ...
                if( (tab[i+1][8] === 0) && (tab[i+1][2] === 'c')){
                   t+='delete '+tab[i+1][1]+''+terminateur+'';
                    ...
                    return(logerreur({status:false,value:t,id:i,tab:tab,message:'erreur dans supprimer 0955'}));
                }
                ...
                if( (tab[i][8] == 1) && (tab[i+1][1] == 'appelf')){
                    ...
                    return(logerreur({status:false,value:t,id:i,tab:tab,message:'erreur dans new 1074'}));
                }
                ...
                if(obj.status == true){
                    ...
                    return(logerreur({status:false,value:t,id:i,tab:tab,message:'erreur js_tabTojavascript1 1037'}));
                }
                ...
                if(objtestLi.status == true){
                    ...
                    return(logerreur({status:false,value:t,id:i,tab:tab,message:'erreur js_tabTojavascript1 1047'}));
                }
...
=====================================================================================================================
*/
function js_traiteDefinitionTableau(tab,id,niveau,options={}){ // id = position de 'obj'
 var t='';
 var j=0;
 var obje={};
 var textObj='';
                 ...
                 if(tab[k][7]===j){
                     if(tab[k][1]==='#' && tab[k][2]==='f'){
                         ...
                         if(obje.status==true){
                             ...
                             return(logerreur({status:false,value:t,id:j,tab:tab,'message':'js_traiteDefinitionTableau 1140 '}));
                         }
                     }
                 }
             }
                 ...
                 if((tab[j][8] === 1) && (tab[j+1][2] === 'f')){
                     if(tab[j+1][1] === 'appelf'){
                         ...
                         if(obj.status == true){
                             ...
                             return(logerreur({status:false,value:t,id:j,tab:tab,message:'1359 erreur dans js_traiteDefinitionTableau'}));
                         }
                     }else{
                         return(logerreur({status:false,value:t,id:j,tab:tab,'message':'1361 erreur dans js_traiteDefinitionTableau '+tab[j][1]}));
                     }
                 }
             }
         }else if(tab[j][1]==='#' && tab[j][2]==='f'){
        ...
        for(j=(i+1);(j < l01) && (tab[j][3] > tab[i][3]);j=j+1){
            ...
            if((tab[j][2] === 'f') && (tab[j][3] === (tab[i][3]+1))){
                if((tab[j][1] === 'nomt') || (tab[j][1] === 'p') || (tab[j][1] === '#') || (tab[j][1] === 'prop' )){
                    ...
                    logerreur({status:false,value:t,id:i,tab:tab,'message':'1361 js_traiteTableau1 les seuls paramètres de tableau sont nomt,p,prop "'+tab[j][1]+'"'});
                }
            }
        }
        argumentsFonction='';
                    ...
                    if((tab[j][8] == 1) && (tab[j+1][1] == 'obj')){
                        ...
                        if(tab[j+1][1] == 'p'){
                            ...
                            if(objOperation.status == true){
                                ...
                                return(logerreur({status:false,value:t,id:j,tab:tab,message:'erreur 1421 js_traiteTableau1 sur des opérations '}));
                            }
                            ...
                            if(objTableau.status === true){
                                ...
                                return(logerreur({status:false,value:t,id:j,tab:tab,message:'erreur 1007 js_traiteTableau1 sur declaration '}));
                            }
                            ...
                            if(obj1.status === true){
                                ...
                                return(logerreur({status:false,value:t,id:j,tab:tab,message:'erreur 1215 js_traiteTableau1 sur declaration '}));
                            }
                            ...
                            if(obj.status == true){
                                ...
                                return(logerreur({status:false,value:t,id:id,tab:tab,message:'dans js_traiteTableau1 1404 '}));
                            }
                         
                        }else{
                            debugger
                            return(logerreur({status:false,value:t,id:j,tab:tab,'message':'erreur js_traiteTableau1 1145 pour '+(tab[j+1][1])}));
                        }
                    }
                }
...
function js_traiteInstruction1(tab,niveau,id){
    ...
    if(tab[id][2] === 'c'){
        ...
        if(obj1.status == true){
            ...
            return(logerreur({status:false,value:t,id:id,tab:tab,message:'erreur sur declaration 0803'}));
        }
    }else if(tab[id][1] === 'affecte' || tab[id][1] === 'cascade'  ){
        var obj=js_tabTojavascript1(tab,id,true,true,niveau); // tab,id,dansFonction,dansInitialisation,niveau
        if(obj.status == true){
            t+=obj.value+'';
        }else{
        ...
        return(logerreur({status:false,value:t,id:id,tab:tab,message:'erreur sur js_traiteInstruction1 1412 pour '+tab[id][1]}));
     ...
     if(tab[i][7]===id){
       if(tab[i][1]==='nom_classe' && tab[i][2]==='f'){
          ...
          if(obj.status == true){
              ...
              return(logerreur({status:false,value:t,id:j,tab:tab,message:'erreur dans le contenu d\'une classe '}));
          }
       }
     }
                    ...
                    if(tab[j+2][2] === 'f'){
                        if(tab[j+2][1] == 'obj'){
                            ...
                            if(obj.status === true){
                                ...
                                return(logerreur({status:false,value:t,id:i,tab:tab,'message':'erreur dans js_traiteDefinitionObjet, 1438 '}));
                            }
                            ...
                            if(objtestLi.status == true){
                                ...
                                return(logerreur({status:false,value:t,id:i,tab:tab,message:'erreur js_traiteDefinitionObjet 1476'}));
                            }
...
function js_traiteAppelFonction(tab,i,dansConditionOuDansFonction,niveau,recursif){
    ...
    if((positionAppelFonction > 0) && (nomFonction != '')){
        ...
        for(j=(i+1);(j < l01) && (tab[j][3] > tab[i][3]);j=j+1){
            ...
            if((tab[j][2] == 'f') && (tab[j][3] == (tab[i][3]+1))){
                if((tab[j][1] == 'element') || (tab[j][1] == 'nomf') || (tab[j][1] == 'p') || (tab[j][1] == 'appelf') || (tab[j][1] == 'r') || (tab[j][1] == 'prop') || (tab[j][1] == '#') || (tab[j][1] == 'contenu' ) || (tab[j][1] == 'id') || (tab[j][1] == 'flechee')){
                    continue;
                }else{
                    logerreur({status:false,value:t,id:i,tab:tab,'message':'1852 les seuls paramètres de appelf sont nomf,p,r,element,flechee et non pas "'+tab[j][1]+'"'});
                }
            }
        }
        argumentsFonction='';
                ...
                if((tab[j][8] == 0) && (tab[j+1][2] == 'f')){
                    ...
                    if((tab[j][8] == 1) && (tab[j+1][1] == 'obj')){
                        ...
                        if(tab[j][8]>1){
                          ...
                          for(var k=j+1;k<l01 && tab[k][3]>tab[j][3] && a_un_commentaire===false;k++){
                           if(tab[k][7]===j){
                            if(tab[k][1]==='#' && tab[k][2]==='f'){
                          ...
                          if(a_un_commentaire===false){
                               return(logerreur({status:false,value:t,id:j,tab:tab,message:'2036 erreur un paramètre p() a trop d\'arguments '}));
...
*/                                      
                                 ...
                                 }else if(tab[k][2] == 'f' && (tab[k][1] == 'mult') || (tab[k][1] == 'plus') || (tab[k][1] == 'divi') || (tab[k][1] == 'moins') || (tab[k][1] == 'concat')){
                                      var objOperation = TraiteOperations1(tab,k,niveau);
                                      if(objOperation.status == true){
                                          argumentsFonction+=objOperation.value;
                                      }else{
                                          return(logerreur({status:false,value:t,id:k,tab:tab,message:'erreur 2107 sur des opérations '}));
                                      }
                                      ...
                                      if(objTableau.status == true){
                                          ...
                                          return(logerreur({status:false,value:t,id:k,tab:tab,message:'erreur 1007 sur declaration '}));
                                      }
                                      ...
                                      if(objJs.status == true){
                                          ...
                                          return(logerreur({status:false,value:t,id:tab[k][0],tab:tab,'message':'erreur 1425 dans js_traiteAppelFonction '}));
                                      }
    ...
    */
    if(tab[id][8]===1){
     ...
     if(tab[id+1][2]==='c'){
      ...
      if((tab[id+1][1] == 'mult') || (tab[id+1][1] == 'plus') || (tab[id+1][1] == 'concat') || (tab[id+1][1] == 'moins') || (tab[id+1][1] == 'mult') || (tab[id+1][1] == 'divi')  || (tab[id+1][1] == 'modulo') || (tab[id+1][1] == 'etBin') || (tab[id+1][1] == 'decalDroite' )){
    ...
    for(var i=id+1;i<l01 && tab[i][3]>tab[id][3];i++){
        if(tab[i][7]===id){
           ...
           if(tab[i][2] == 'c'){
               ...
               if((tab[i][1] == 'mult') || (tab[i][1] == 'plus') || (tab[i][1] == 'concat') || (tab[i][1] == 'moins') || (tab[i][1] == 'mult') || (tab[i][1] == 'divi')  || (tab[i][1] == 'modulo') || (tab[i][1] == 'etBin') || (tab[i][1] == 'decalDroite' )){
                   ...
                   if(objtestLi.status === true){
                    ...
                    if(obj.status == true){
                        ...
                        return(logerreur({status:false,value:t,id:i,tab:tab,message:'2367 erreur dans TraiteOperations1'}));
                    }
                    ...
                    if(tab[tabPar[0]][2] == 'c'){
                        ...
                        if((tab[tabPar[0]][2] == 'f') && (tab[tabPar[0]][1] == 'appelf')){
                            ...
                            if(objOperation.status == true){
                                ...
                                return(logerreur({status:false,value:t,'id':tabAffecte['par1'][0],tab:tab,message:'erreur 1607 sur js_condition1 '}));
                            }
                            ...
                            if(objTableau.status == true){
                                ...
                                return(logerreur({status:false,value:t,id:j,tab:tab,message:'erreur 1007 sur js_condition1 '}));
                            }
                           ...
                           if(obj.status == true){
                               ...
                               return(logerreur({status:false,value:t,id:i,tab:tab,message:'1964 js_condition1 '}));
                           }
                        ...
                        */
                        ...
                        if((tab[tabPar[1]][2] == 'f') && (tab[tabPar[1]][1] == 'appelf')){
                            ...
                            if(obj.status == true){
                                ...
                                return(logerreur({status:false,value:t,id:i,tab:tab,message:'erreur 2173 sur condition '}));
                            }
                           
                         
//                            return(logerreur({status:false,value:t,id:id,'message':'erreur 1568 dans une condition pour un test egal, diff...'+tab[tabPar[1]][1]}));
                        }
                    }
                    i=max-1;
                }else{
                ...
                if(obj.status === true){
                    ...
                    return(logerreur({status:false,value:t,id:i,tab:tab,'message':'2046 problème sur la condition '}));
                }
                i=max-1;
              ...
              if(obj.status == true){
                  ...
                  return(logerreur({status:false,value:t,id:i,tab:tab,message:'2057 dans obj de "return" ou "dans" il y a un problème'}));
              }
