                            ...
                            if((tab[j][1] === 'argument') && (tab[j][3] === (tab[positionDeclarationFonction][3] + 1))){
                                if(tab[j][8] === 1){
                                    ...
                                    for(var k=j+1;k<l01 && tab[k][3]>tab[j][3];k++){
                                        if(tab[k][7]===j){
                                            if(tab[k][2]==='c'){
                                                nom_argument=maConstante(tab[k]);;
                    ...
                    if(tabchoix[j][1] === 'pourChaque'){
                        ...
                        if(obj.__xst === true){
                            ...
                            return(logerreur({
                                ...
                                id:tabchoix[j][0],
                                tab:tab,
                                __xme:'0491 problème sur la pour de boucleSurObjet en indice ' + tabchoix[j][0]
                            }));
                        }
                ...
                for(k=j + 1;(k < l01) && (tab[k][3] > tab[j][3]);k++){
                    if(tab[k][7] === j){
                        if((tab[k][1] === '#') && (tab[k][2] === 'f')){
                            ...
                            if(tab[k][2]==='c'){                            
                              seule_propriete=maConstante(tab[k]);
                            }
                        }
                    }
                }
...
function js_traiteInstruction1(tab,niveau,id){
    ...
    if(tab[id][2] === 'c'){
        ...
        var obj = TraiteOperations2(tab,tab[id][0],0,0);
        if(obj.__xst === false){
     ...
     if(tab[tab[id][7]][1]==='dans'){
      for(var j=id+1;j<l01 && tab[j][3]>tab[id][3];j++){
       if(tab[j][7]===id){
        if(tab[j][2]==='c'){
          return({__xst:true,__xva:'var '+maConstante(tab[j])});
        }
       }
      }
                ...
                if(tab[j][8] === 2){
                    ...
                    if(tab[j + 2][2] === 'f'){
                        if(tab[j + 2][1] === 'obj'){
                            ...
                            var objOperation = TraiteOperations2(tab,(j + 2),0,0);
                            if(objOperation.__xst === true){
                                var droite=objOperation.__xva;
                        ...
                        textObj+='"'+tab[j + 1][1]+ '" : ' + maConstante(tab[j + 2]);
                    }
                }
            }
        }
        ...
        if((tab[j][1] === 'nomf') && (tab[j][2] === 'f') && (tab[j][3] === (tab[i][3] + 1))){
            ...
            if((tab[j][8] === 1) && (tab[j + 1][2] === 'c')){
                ...
                if(obj1.__xst === true){
                    ...
                    logerreur({__xst:false,__xva:t,id:i,tab:tab,__xme:'1069 erreur sur appel de fonction "' + tab[j][1] + '"'});
                }
                ...
                if(objTableau.__xst === true){
                    ...
                    logerreur({__xst:false,__xva:t,id:i,tab:tab,__xme:'2349 erreur sur appel de tableau "' + tab[j][1] + '"'});
                }
                ...
                if(objTableau.__xst === true){
                    ...
                    logerreur({__xst:false,__xva:t,id:i,tab:tab,__xme:'2401 erreur sur test en ligne "' + tab[j][1] + '"'});
                }
                ...
                if(objOperation.__xst === true){
                    ...
                    logerreur({__xst:false,__xva:t,id:i,tab:tab,__xme:'2409 erreur sur test en ligne "' + tab[j][1] + '"'});
                }
    ...
    if((recursif === true) && (nomRetour === '') && ( !(dansConditionOuDansFonction))){
        ...
        if(nomElement!==''){
             if(nomElement.substr(nomElement.length-1,1)===']'){
                 var tab_mots_cles_a_ne_pas_transformer=['fromCharCode','fromCodePoint','raw','addEventListener','appendChild','at','bind','call','charAt','charCodeAt','codePointAt','concat',
                 'endsWith','getBBox','getAttribute','hasOwnProperty','includes','indexOf','isWellFormed',
                 'lastIndexOf','localeCompare','match','matchAll','normalize','padEnd','padStart','push','repeat','replace','replaceAll','search','setAttribute','slice','splice','split','startsWith','substr','substring',
                 'toLocaleLowerCase','toLocaleUpperCase','toLowerCase','toString','toUpperCase','toWellFormed','trim','trimEnd','trimStart','valueOf'];
    ...
    */
    ...
    if(tab[id][1]==='' && tab[id][2]==='f'){
        ...
        if(!tableau_des_opérateurs_js.hasOwnProperty(tab[id][1])){
            ...
            if(tab[id][2]==='f' && ( tab[id][1]==='appelf' ||  tab[id][1]==='defTab' ||  tab[id][1]==='tableau' ||  tab[id][1]==='testEnLigne'  ||  tab[id][1]==='affecte'  ||  tab[id][1]==='affectop' ||  tab[id][1]==='obj' )){ //  
                if(tab[id][1]==='appelf'){
    ...
    if(operateur_principal===','){ // 'virgule' est une plaie
        ...
        if(tab[i][7] === id){
            if(premier_operande === true){
                 if(!(
                      ...
                      || (oop.type_operateur==='m0' && tab[id][8]>=0)
                     )
                 ){
                     debugger
