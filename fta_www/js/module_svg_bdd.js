...
class module_svg_bdd{
    ...
    */
    ajouter_un_champ_de_modale(id_svg_conteneur_table,nom_de_la_table){
        ...
        for(i=0;i < lst.length;i++){
            if(lst[i].getAttribute('type_element')){
                if((lst[i].getAttribute('type_element') === 'conteneur_de_champ') || (lst[i].getAttribute('type_element') === 'conteneur_de_nom_de_table') || ('conteneur_d_index' === lst[i].getAttribute('type_element'))){
                    numero_de_boite++;
                }
            }
        }
    ...
    */
    #modale_modifier_la_table(element_g_conteneur_de_nom_de_table){
        var nom_de_la_table='';
        ...
        t+=('<a href="javascript:' + this.#nom_de_la_variable + '.changer_le_nom_de_table(' + id_svg_du_texte + ',' + element_g_conteneur_de_nom_de_table.getAttribute('id_svg_conteneur_table') + ')">modifier</a>');
        t+='<hr />';
        t+='<h2>modifier</h2>';
        ...
        t+=('<a href="javascript:' + this.#nom_de_la_variable + '.ajouter_un_champ_de_modale(' + element_g_conteneur_de_nom_de_table.getAttribute('id_svg_conteneur_table') + ',&quot;' + nom_de_la_table + '&quot;)">ajouter</a>');
        t+='<hr />';
    ...
    */
    #ajouter_nom_de_table_au_svg(nom_de_la_table,indice_courant,id_svg_conteneur_table,largeur_de_la_boite){
        ...
        this.#arbre[this.#id_bdd_de_la_base_en_cours].arbre_svg[indice_courant]={type:'g',id:indice_courant,id_parent:id_svg_conteneur_table,'proprietes':{id:indice_courant,type_element:'conteneur_de_nom_de_table',id_svg_de_la_base_en_cours:this.#id_svg_de_la_base_en_cours,id_bdd_de_la_base_en_cours:this.#id_bdd_de_la_base_en_cours,id_svg_conteneur_table:id_svg_conteneur_table,id_svg_champ_en_cours:id_svg_champ_en_cours,nom_de_la_table:nom_de_la_table,decallage_x:this.#taille_bordure,decallage_y:this.#taille_bordure,'transform':('translate(' + this.#taille_bordure + ',' + this.#taille_bordure + ')')}};
        indice_courant++;
        /*
            ...
            if(donnees.status === 'OK'){
                ...
                */
                ...
                for(id_bdd_de_la_base in this.#arbre){
                    ...
                    this.#arbre[id_bdd_de_la_base].arbre_svg[indice_courant]={type:'g',id:this.#id_svg_de_la_base_en_cours,id_parent:-1,'proprietes':{type_element:'conteneur_de_base',id_bdd_de_la_base_en_cours:id_bdd_de_la_base,id:indice_courant,id_svg_de_la_base_en_cours:this.#id_svg_de_la_base_en_cours,transform:'translate(0,0)',decallage_x:0,decallage_y:0}};
                    indice_courant++;
                    id_svg_rectangle_base_en_cours=indice_courant;
                    this.#arbre[id_bdd_de_la_base].arbre_svg[indice_courant]={type:'rect',id:indice_courant,id_parent:this.#id_svg_de_la_base_en_cours,'proprietes':{type_element:'rectangle_de_base',id_bdd_de_la_base_en_cours:id_bdd_de_la_base,id:indice_courant,id_svg_de_la_base_en_cours:this.#id_svg_de_la_base_en_cours,x:0,y:0,width:120,height:120,'style':("stroke:red;stroke-width:" + this.#taille_bordure + ";fill:yellow;fill-opacity:0.2;")}};
                    indice_courant++;
                    var id_conteneur_texte_base=indice_courant;
                    this.#arbre[id_bdd_de_la_base].arbre_svg[indice_courant]={type:'g',id:indice_courant,id_parent:this.#id_svg_de_la_base_en_cours,'proprietes':{type_element:'conteneur_du_texte_de_la_base',id:indice_courant,id_svg_de_la_base_en_cours:this.#id_svg_de_la_base_en_cours,transform:'translate(0,0)'}};
                    indice_courant++;
                    this.#arbre[id_bdd_de_la_base].arbre_svg[indice_courant]={type:'text',id:indice_courant,'id_parent':(indice_courant - 1),'contenu':('(' + id_bdd_de_la_base + ') ' + this.#arbre[id_bdd_de_la_base]['chp_nom_basedd'] + ' <a style="fill:green;" href="javascript:' + this.#nom_de_la_variable + '.sauvegarder_la_base(' + id_bdd_de_la_base + ')">sauvegarder</a>'),'proprietes':{id:indice_courant,type_element:'texte_id_bdd_de_la_base',id_svg_de_la_base_en_cours:this.#id_svg_de_la_base_en_cours,x:this.#taille_bordure,'y':(this.#taille_bordure + CSS_TAILLE_REFERENCE_TEXTE),style:"fill:blue;"}};
                    indice_courant++;
                    ...
                    for(indice_matr=1;indice_matr < l01;indice_matr++){
                        if((tab[indice_matr][7] === 0) && (tab[indice_matr][1] === 'create_table')){
                                            ...
                                            for(k=(i + 1);(k < l01) && (tab[k][3] > tab[i][3]);k++){
                                                if(tab[k][7] === i){
                                                    if('index_name' === tab[k][1]){
                                                        ...
                                                        */
                                                        this.#arbre[id_bdd_de_la_base].arbre_svg[indice_courant]={type:'g',id:indice_courant,id_parent:id_svg_conteneur_table,'proprietes':{id:indice_courant,type_element:'conteneur_d_index',id_svg_de_la_base_en_cours:this.#id_svg_de_la_base_en_cours,id_svg_conteneur_table:id_svg_conteneur_table,nom_de_la_table_pour_l_index:nom_de_la_table,decallage_x:this.#taille_bordure,'decallage_y':((this.#hauteur_de_boite_affichage * numero_de_boite) + this.#taille_bordure),'transform':('translate(' + this.#taille_bordure + ',' + (((this.#hauteur_de_boite_affichage * numero_de_boite) + this.#taille_bordure)) + ')')}};
                                                        indice_courant++;
                                                        ...
                                                        this.#arbre[id_bdd_de_la_base].arbre_svg[indice_courant]={type:'rect',id:indice_courant,'id_parent':(indice_courant - 1),'proprietes':{id:indice_courant,type_element:'rectangle_d_index',id_svg_de_la_base_en_cours:this.#id_svg_de_la_base_en_cours,id_svg_conteneur_table:id_svg_conteneur_table,nom_de_la_table_pour_l_index:nom_de_la_table,nom_de_l_index:nom_de_l_index,donnees_rev_de_l_index:donnees_rev_de_l_index,x:0,y:0,width:18,height:this.#hauteur_de_boite,'style':("stroke:green;stroke-width:" + this.#taille_bordure + ";fill:green;fill-opacity:0.2;")}};
                                                        indice_courant++;
                                                        liste_de_indices_des_elements_a_ajuster_en_largeur.push((indice_courant - 1));
                                                        this.#arbre[id_bdd_de_la_base].arbre_svg[indice_courant]={type:'text',id:indice_courant,'id_parent':(indice_courant - 2),contenu:nom_de_l_index,'proprietes':{id:indice_courant,type_element:'texte_d_index',id_svg_de_la_base_en_cours:this.#id_svg_de_la_base_en_cours,id_svg_conteneur_table:id_svg_conteneur_table,nom_de_la_table_pour_l_index:nom_de_la_table,x:this.#taille_bordure,'y':(this.#hauteur_de_boite - (0.3 * CSS_TAILLE_REFERENCE_TEXTE) - this.#taille_bordure),style:"fill:green;"}};
                                                        indice_courant++;
                                                        liste_de_indices_des_elements_a_ajuster_en_largeur.push((indice_courant - 1));
                                                        hauteur_de_la_table+=this.#hauteur_de_boite_affichage;
                                                        numero_de_boite++;
                            ...
                            */
                            ...
                            var k=0;
                            for(k=0;k < liste_de_indices_des_elements_a_ajuster_en_largeur.length;k++){
                                /*
                ...
                */
                ...
                /*
                  ...
                  this.#modale_modifier_la_table(document.getElementById(78));
                */
            }else{
