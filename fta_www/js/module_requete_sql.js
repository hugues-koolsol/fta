        ...
        for(var indice_de_la_base in init.bases){
            ...
            for(var j=0;j<l02  ;j++){
                if(tab2[j][2]==='f' && tab2[j][1]==='create_table'){
                    for(var k=j+1;k<l02  && tab2[k][3]>tab2[j][3];k++){
...
//                                   console.log(indice_de_la_base);
    ...
    */
    apres_chargement_des_bases(init,that){
        ...
        if(globale_requete_en_cours.hasOwnProperty('T0.chi_id_requete') && globale_requete_en_cours['T0.chi_id_requete']>0){ // globale_id_requete
    ...
    */
    #transformer_requete_en_fonction_php( type_de_requete , obj3  ){
        ...
        if(type_de_requete==='delete' ){
            ...
            t+='    $texte_sql_'+id_requete_en_base+'=\'UPDATE `\'.$GLOBALS[BDD][BDD_1][\'nom_bdd\'].\'`.`'+nom_de_la_table+'` SET \'.CRLF;'+CRLF;
            var liste_des_champs_pour_update='';
            
            var lng_max=0;
            for(var champ_sortie=0;champ_sortie<this.#obj_webs['champs_sortie'].length;champ_sortie++){
...
//                                                        var obj = traite_sqlite_fonction_de_champ(tab,m,niveau,{});
                    ...
                    if(
                        champ_de_la_base.type_du_champ.toLowerCase().indexOf('int')>=0 || 
