...
function traiteUneComposante(element,niveau,parentEstCrochet,dansSiOuBoucle,parent){
    ...
    if('Literal' === element.type){
        ...
        debugger
        var obj1 = traiteMemberExpression1(element,niveau+1,element,'');
        if(obj1.__xst === true){
...
//        debugger        
//        console.log('%cajouter des parenthèses ????','background:yellow;color:red;','parent=',parent);
        ...
        var obj1 = traiteAssignmentExpress1(element,niveau+1,{'sansLF':true});
        if(obj1.__xst === true){
...
function traiteBinaryExpress1(element,niveau,parentEstCrochet,dansSiOuBoucle){
    ...
    if((t.substr(0,10) === 'plus(plus(') || (t.substr(0,12) === 'moins(moins(') || (t.substr(0,10) === 'mult(mult(') || (t.substr(0,10) === 'divi(divi(') ){
...
function traiteCallExpression1(element,niveau,parent,opt){
        ...
        for(i=0;i < element.arguments.length;i++){
            ...
            if('CallExpression' === element.arguments[i].type){
                ...
                if(obj1.__xst === true){
                    ...
                    if('FunctionExpression'=== element.arguments[i].type && parent && parent.callee && parent.callee.type && parent.callee.type==='FunctionExpression'){
    ...
    if(element.callee){
        ...
        if(element.callee.property){
            ...
            if((element.callee.property.type === 'Identifier') || (element.callee.property.type === 'PrivateIdentifier') || (element.callee.property.type === 'Literal') ){
                ...
                if((element.callee.object) && (element.callee.object.type === 'Identifier')){
                    ...
                    if(element.callee.property.type === 'Literal'){ // Symbol.iterator
                        /* a['Symbol.iterator'](); => appelf(nomf(tableau(nomt(a),p('element.callee.property')))) */
                        if(element.callee.object.type ==='Identifier'){ // a
                    ...
                    if(contenu === ''){
                        ...
                        t+='appelf(element(' + element.callee.object.raw + '),nomf(' + nom_de_la_fonction + ')' + lesArguments + ')';
                    }else{
                        t+='appelf(element(' + element.callee.object.raw + '),nomf(' + nom_de_la_fonction + ')' + lesArguments + ',contenu(' + contenu + '))';
                    }
                }else{
                    if((element.callee.object) && (element.callee.object.type === 'MemberExpression') && ( !(((element.callee.object.object) && (element.callee.object.property) && (element.callee.object.object.type === 'Identifier')) && (element.callee.object.property.type === 'Identifier')))){
                        ...
                        if(obj1.__xst === true){
                            ...
                            if(contenu === ''){
                                ...
                                t+='appelf(element(' + obj1.__xva + '),nomf(' + nom_de_la_fonction + ')' + lesArguments + ')';
                            }else{
                                t+='appelf(element(' + obj1.__xva + '),nomf(' + nom_de_la_fonction + ')' + lesArguments + ',contenu(' + contenu + '))';
                            }
                        }else{
            ...
            if(element.callee.object.type === 'CallExpression'){
                ...
                if((element.callee.object.object) && (element.callee.object.property) && (element.callee.object.object.type === 'Identifier') && (element.callee.object.property.type === 'Identifier')){
                 ...
                 if(element.callee.property && element.callee.property.type ==='MemberExpression'){
                    var obj = traiteMemberExpression1(element.callee.property,niveau,element,'');
                    if(obj.__xst===true){
                        if(element.callee.hasOwnProperty('computed') && element.callee.computed===true){
...
function traiteArrayExpression1(element,niveau){
    ...
    for(i in element.elements){
        ...
        }else if( (element.elements[i].type === "ConditionalExpression") ||  (element.elements[i].type === "BinaryExpression") || (element.elements[i].type === "UnaryExpression") || (element.elements[i].type === "ObjectExpression")){
        ...
        */
        if(('ArrayExpression' === val.value.type)
         ...
         || ('UnaryExpression' === val.value.type)
            ...
            var obj1 = traiteUneComposante(val.value,niveau,false,false,val);
            if(obj1.__xst === true){
    ...
    if(element.computed === false){
        ...
        if(element.object){
            ...
            if(element.object.type === 'MemberExpression'){
                ...
                var objass = traiteAssignmentExpress1(element.object,niveau+1,{'sansLF':true});
                if(objass.__xst === true){
                    objTxt=objass.__xva;
                    var prop = recupProp(element.property);
                    if(prop.__xst === true){
...
function traiteAssignmentExpress1(element,niveau,opt){
    ...
    if((element.left) && (element.left.type === 'Identifier')){
        ...
        if((element.right) && (element.right.type === 'Literal')){
            ...
            var objass = traiteAssignmentExpress1(element.right,niveau+1,{'sansLF':true});
            if(objass.__xst === true){
...
function traiteDeclaration1(element,niveau){
    ...
    for(decl in element.declarations){
        ...
        if(element.declarations[decl].init){
            ...
            }else if(('SequenceExpression' === element.declarations[decl].init.type) || ('UpdateExpression' === element.declarations[decl].init.type) || ("ThisExpression" === element.declarations[decl].init.type) || ("AssignmentExpression" === element.declarations[decl].init.type) || ("AwaitExpression" === element.declarations[decl].init.type)){
...
function TransformAstEnRev(les_elements,niveau){
    ...
    if(les_elements.length){
        ...
        for(i=0;i < les_elements.length;i++){
            ...
            t+=ajouteCommentaireAvant(element,niveau+1);
            var bodyTrouve=false;
            if(t !== ''){
            ...
            if(element.type === 'FunctionDeclaration'){
                ...
                var objDecl = traiteDeclaration1(element,niveau+1);
                if(objDecl.__xst === true){
                ...
                var objexp1 = traiteExpression1(element,niveau,null);
                ...
                }else if(element.argument.type === 'SequenceExpression'){
                ...
                var obj1 = traiteUneComposante(element,niveau+1,false,false,null);
                if(obj1.__xst === true){
