...
//        var obj1 = traiteUneComposante(element.id   , niveau,parentEstCrochet , dansSiOuBoucle);
     ...
     if(element.specifiers && element.specifiers.length>0){
      for(var j=0;j<element.specifiers.length;j++){
...
function traiteDo1(element,niveau){
    ...
    if(element.body){
        ...
        if(element.expression){
            var obj3=traiteUneComposante(element.expression , niveau+1, false , false ); //parentEstCrochet , dansSiOuBoucle );
        }else{
...
function traiteAssignmentExpress1(element,niveau,opt){
    ...
    if((element.left) && (element.left.type === 'Identifier')){
        ...
        if((element.right) && (element.right.type === 'Literal')){
            ...
            }else if((element.right.operator === 'void')){ //  && (element.right.argument.type === 'Literal')
...
//    console.log('typeof les_elements=' , typeof les_elements , Array.isArray(les_elements)  )
    
    if(les_elements.length){
        var i=0;

        for(i=0;i < les_elements.length;i=i+1){
            ...
            if(element.type == 'FunctionDeclaration'){
             ...
             if(element.body && element.body.type==="ClassBody" && element.body.body && element.body.body.length>0 ){
                 for(var j=0;j<element.body.body.length;j++){
