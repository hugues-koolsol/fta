/*
 ...
 @author Nick Wronski <nick@javascript.com>
  ...
  var t='select * from test'  ;
  var a=sqliteParser(t);
  console.log(a);
...
require = function a(b, c, d) {
  ...
  function g(a, b) {
    function c(a, b) {
      return {type:"literal", text:a, ignoreCase:b};
    }
    function d(a, b, c) {
      return {type:"class", parts:a, inverted:b, ignoreCase:c};
    }
    function g() {
      return {type:"any"};
    }
    ...
    function k(b) {
      ...
      for (d = K[c], d = {line:d.line, column:d.column}; c < b;) {
        10 === a.charCodeAt(c) ? (d.line++, d.column = 1) : d.column++, c++;
      }
      return K[b] = d, d;
    }
    function l(a, b) {
      var c = k(a), d = k(b);
      return {start:{offset:a, line:c.line, column:c.column}, end:{offset:b, line:d.line, column:d.column}};
    }
    function m(a) {
    ...
    function p(b) {
      var c, d = H[b], e = 0, f = [], g = d.length, h = [], i = [], j = I;
      R.trace({type:"rule.enter", rule:P[b], description:Q[b], location:l(j, j)});
      var k = 545 * I + b, n = O[k];
      if (n) {
        return I = n.nextPos, n.result !== D ? R.trace({type:"rule.match", rule:P[b], description:Q[b], result:n.result, location:l(j, I)}) : R.trace({type:"rule.fail", rule:P[b], description:Q[b], location:l(j, j)}), n.result;
      }
      for (;;) {
        for (; e < g;) {
          switch(d[e]) {
      ...
      return O[k] = {nextPos:I, result:i[0]}, i[0] !== D ? R.trace({type:"rule.match", rule:P[b], description:Q[b], result:i[0], location:l(j, I)}) : R.trace({type:"rule.fail", rule:P[b], description:Q[b], location:l(j, j)}), i[0];
    }
    function q(a) {
    ...
    function s(a) {
      var b = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : " ", c = a.filter(function(a) {
        return r(a);
      }).reduce(function(a, c) {
        return "" + a + x(c) + b;
      }, "");
    ...
    function w(a) {
      var b = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "'", c = new RegExp(b + "{2}", "g");
    ...
    function B(a, b) {
      return b.reduce(function(a, b) {
        var c = h(b, 4), d = (c[0], c[1]), e = (c[2], c[3]);
        return {type:"expression", format:"binary", variant:"operation", operation:z(d), left:a, right:e};
      }, a);
    }
    b = void 0 !== b ? b : {};
    var C, D = {}, E = {start:0, start_streaming:1}, F = 0, G = [function(a) {
      return a;
    }, function(a, b) {
      return {type:"statement", variant:"list", statement:v([a, b])};
    }, function(a) {
      return a;
    }, j("Type Definition"), function(a, b) {
      return Object.assign(a, b);
    }, function(a) {
      return {type:"datatype", variant:a[0], affinity:a[1]};
    }, j("Custom Datatype Name"), function(a, b) {
      var c = u([a, b]), d = "numeric";
      return /int/i.test(c) ? d = "integer" : /char|clob|text/i.test(c) ? d = "text" : /blob/i.test(c) ? d = "blob" : /real|floa|doub/i.test(c) && (d = "real"), {type:"datatype", variant:c, affinity:d};
    }, /^[\t ]/, d(["\t", " "], !1, !1), function(a) {
      return a;
    }, j("Type Definition Arguments"), function(a, b) {
      return {args:{type:"expression", variant:"list", expression:v([a, b])}};
    }, function(a) {
      return a;
    }, j("Null Literal"), function(a) {
      return {type:"literal", variant:"null", value:z(a)};
    }, j("Date Literal"), function(a) {
      return {type:"literal", variant:"date", value:z(a)};
    }, j("String Literal"), function(a, b) {
      return {type:"literal", variant:"text", value:b};
    }, j("Single-quoted String Literal"), function(a) {
      return w(a, "'");
    }, "''", c("''", !1), /^[^']/, d(["'"], !0, !1), j("Blob Literal"), /^[x]/i, d(["x"], !1, !0), function(a) {
      return {type:"literal", variant:"blob", value:a};
    }, function(a) {
      return {type:"literal", variant:"text", value:a};
    }, j("Number Sign"), function(a, b) {
      return r(a) && (b.value = t([a, b.value])), b;
    }, function(a, b) {
      return {type:"literal", variant:"decimal", value:t([a, b])};
      ...
      return {type:"literal", variant:"hexidecimal", value:t([a, b])};
    }, /^[0-9a-f]/i, d([["0", "9"], ["a", "f"]], !1, !0), /^[0-9]/, d([["0", "9"]], !1, !1), j("Bind Parameter"), function(a) {
      return Object.assign({type:"variable"}, a);
    }, j("Numbered Bind Parameter"), function(a, b) {
      return {format:"numbered", name:t([a, b])};
    }, /^[1-9]/, d([["1", "9"]], !1, !1), function(a, b) {
      return t([a, b]);
    }, j("Named Bind Parameter"), /^[:@]/, d([":", "@"], !1, !1), function(a, b) {
      return {format:"named", name:t([a, b])};
    }, j("TCL Bind Parameter"), "$", c("$", !1), ":", c(":", !1), function(a, b, c) {
      return Object.assign({format:"tcl", name:t([a, b])}, c);
    }, function(a) {
      return {suffix:a};
    }, j("EXISTS Expression"), function(a, b) {
      return r(a) ? {type:"expression", format:"unary", variant:"exists", expression:b, operator:z(a)} : b;
    }, j("EXISTS Keyword"), function(a, b) {
      return u([a, b]);
    }, j("RAISE Expression"), function(a, b) {
      return Object.assign({type:"expression", format:"unary", variant:z(a), expression:b}, b);
    }, j("RAISE Expression Arguments"), function(a) {
      return Object.assign({type:"error"}, a);
    }, j("IGNORE Keyword"), function(a) {
      return {action:z(a)};
    }, function(a, b) {
      return {action:z(a), message:b};
    }, function(a) {
      return a;
    }, function(a, b) {
      return Object.assign(b, {expression:a});
    }, function(a, b) {
      return {type:"expression", format:"unary", variant:"operation", expression:b, operator:z(a)};
    }, j("COLLATE Expression"), function(a) {
      return Object.assign({type:"expression", format:"unary", variant:"operation", operator:"collate"}, a);
    }, function(a, b) {
      return B(a, b);
    }, function(a) {
      return [null, a, null, {type:"literal", variant:"null", value:"null"}];
    }, "not ", c("NOT ", !0), "null", c("NULL", !0), function() {
      return "not";
    }, function() {
      return "is";
    }, j("CAST Expression"), function(a, b, c) {
      return {type:"expression", format:"unary", variant:z(a), expression:b, as:c};
    }, j("Type Alias"), function(a) {
      return a;
    }, j("CASE Expression"), function(a, b, c, d) {
      return Object.assign({type:"expression", variant:z(a), expression:v([c, d])}, b);
    }, function(a) {
      return {discriminant:a};
    }, j("WHEN Clause"), function(a, b, c) {
      return {type:"condition", variant:z(a), condition:b, consequent:c};
    }, j("ELSE Clause"), function(a, b) {
      return {type:"condition", variant:z(a), consequent:b};
    }, function(a, b) {
      return Object.assign(b, {left:a});
    }, j("Comparison Expression"), function(a, b, c, d) {
      return Object.assign({type:"expression", format:"binary", variant:"operation", operation:u([a, b]), right:c}, d);
    }, j("ESCAPE Expression"), function(a, b) {
      return {escape:b};
    }, j("BETWEEN Expression"), function(a, b, c) {
      return {type:"expression", format:"binary", variant:"operation", operation:u([a, b]), right:c};
    }, function(a, b) {
      return B(a, [b]);
    }, function(a) {
      return z(a);
      ...
      return {type:"expression", variant:"list", expression:r(a) ? a : []};
    }, function(a, b) {
      return v([a, b]);
    }, j("Function Call"), function(a, b) {
      return Object.assign({type:"function", name:a}, b);
    }, j("Function Call Arguments"), function(a) {
      return {args:{type:"identifier", variant:"star", name:a}};
    }, function(a, b) {
      return !r(a) || b.expression.length > 0;
    }, function(a, b) {
      return {args:Object.assign(b, a)};
    }, function(a) {
      return {filter:z(a)};
      ...
      return Object.assign({type:"statement", variant:"transaction", action:"begin"}, b, d);
    }, function(a) {
      return a;
    }, function(a) {
      return {defer:z(a)};
    }, j("ROLLBACK Statement"), function(a, b) {
      return Object.assign({type:"statement", variant:"transaction", action:"rollback"}, b);
    }, j("TO Clause"), function(a) {
      return {savepoint:a};
    }, function(a) {
      return z(a);
    }, j("SAVEPOINT Statement"), function(a, b) {
      return {type:"statement", variant:a, target:b};
    }, j("RELEASE Statement"), function(a, b, c) {
      return {type:"statement", variant:z(a), target:c};
    }, j("ALTER TABLE Statement"), function(a, b, c) {
      return Object.assign({type:"statement", variant:z(a), target:b}, c);
    }, j("ALTER TABLE Keyword"), function(a, b) {
      return u([a, b]);
    }, j("RENAME TO Keyword"), function(a, b) {
      return {action:z(a), name:b};
    }, j("ADD COLUMN Keyword"), function(a, b) {
      return {action:z(a), definition:b};
    }, function(a, b) {
      return Object.assign(b, a);
    }, j("WITH Clause"), function(a, b, c) {
      var d = {variant:r(b) ? "recursive" : "common"};
      ...
      return Object.assign({type:"expression", format:"table", variant:"common", target:a}, b);
    }, function(a) {
      return {expression:a};
    }, function(a, b) {
      return Object.assign(b, a);
    }, j("ATTACH Statement"), function(a, b, c, d) {
      return {type:"statement", variant:z(a), target:d, attach:c};
    }, j("DETACH Statement"), function(a, b, c) {
      return {type:"statement", variant:z(a), target:c};
    }, j("VACUUM Statement"), function(a, b) {
      return Object.assign({type:"statement", variant:"vacuum"}, b);
    }, function(a) {
      return {target:a};
    }, j("ANALYZE Statement"), function(a, b) {
      return Object.assign({type:"statement", variant:z(a)}, b);
    }, function(a) {
      return {target:a.name};
    }, j("REINDEX Statement"), function(a) {
      return {target:a.name};
    }, j("PRAGMA Statement"), function(a, b, c) {
      return {type:"statement", variant:z(a), target:b, args:{type:"expression", variant:"list", expression:c}};
    }, function(a) {
      return a;
    }, function(a) {
      return /^(yes|no|on|off|false|true|0|1)$/i.test(a);
    }, function(a) {
      return {type:"literal", variant:"boolean", normalized:/^(yes|on|true|1)$/i.test(a) ? "1" : "0", value:a};
    }, function(a) {
      return z(a);
    }, function(a) {
      return {type:"identifier", variant:"name", name:a};
    }, j("SELECT Statement"), function(a, b, c) {
      return Object.assign(a, b, c);
    }, j("ORDER BY Clause"), function(a) {
      return {order:a.result};
    }, j("LIMIT Clause"), function(a, b, c) {
      return {limit:Object.assign({type:"expression", variant:"limit", start:b}, c)};
    }, j("OFFSET Clause"), function(a, b) {
      return {offset:b};
    }, function(a, b) {
      return A(b) ? {type:"statement", variant:"compound", statement:a, compound:b} : a;
    }, j("Union Operation"), function(a, b) {
      return {type:"compound", variant:a, statement:b};
    }, function(a, b, c, d) {
      return Object.assign({type:"statement", variant:"select"}, a, b, c, d);
    }, j("SELECT Results Clause"), function(a, b) {
      return Object.assign({result:b}, a);
      ...
      return Object.assign({group:b}, c);
    }, j("HAVING Clause"), function(a, b) {
      return {having:b};
    }, function(a, b) {
      return {type:"identifier", variant:"star", name:t([a, b])};
    }, function(a, b) {
      return t([a, b]);
    }, function(a, b) {
      return Object.assign(a, b);
    }, function(a, b) {
      return A(b) ? {type:"map", variant:"join", source:a, map:b} : a;
    }, function(a, b) {
      return Object.assign(a, b);
    }, j("CROSS JOIN Operation"), function(a) {
      return {type:"join", variant:"cross join", source:a};
    }, j("JOIN Operation"), function(a, b) {
      return {type:"join", variant:z(a), source:b};
    }, function(a, b, c) {
      return Object.assign({type:"function", variant:"table", name:a, args:b}, c);
      ...
      return {constraint:Object.assign({type:"constraint", variant:"join"}, a)};
    }, j("Join ON Clause"), function(a, b) {
      return {format:z(a), on:b};
    }, j("Join USING Clause"), function(a, b) {
      return {format:z(a), using:b};
    }, j("VALUES Clause"), function(a, b) {
      return {type:"statement", variant:"select", result:b};
    }, function(a, b) {
      return {result:v([a, b])};
    }, function(a) {
      return a;
    }, j("Ordering Expression"), function(a, b) {
      return r(b) ? Object.assign({type:"expression", variant:"order", expression:a}, b) : a;
    }, j("Star"), j("Fallback Type"), j("INSERT Statement"), function(a, b) {
      return Object.assign({type:"statement", variant:"insert"}, a, b);
    }, j("INSERT Keyword"), function(a, b) {
      return Object.assign({action:z(a)}, b);
    }, j("REPLACE Keyword"), function(a) {
      return {action:z(a)};
    }, j("INSERT OR Modifier"), function(a, b) {
      return {or:z(b)};
    }, function(a, b) {
      return Object.assign({into:a}, b);
    }, j("INTO Clause"), function(a, b) {
      return b;
    }, j("INTO Keyword"), function(a) {
      return {result:a};
    }, j("Column List"), function(a, b) {
      return {columns:v([a, b])};
    }, function(a) {
      return a;
    }, j("Column Name"), function(a) {
      return {type:"identifier", variant:"column", name:a};
    }, function(a, b) {
      return b;
      ...
      return Object.assign({type:"statement", variant:a, into:c}, b, d, e, f, g);
    }, j("UPDATE Keyword"), j("UPDATE OR Modifier"), function(a) {
      return {or:z(a)};
    }, j("SET Clause"), function(a) {
      return {set:a};
    }, j("Column Assignment"), function(a, b) {
      return {type:"assignment", target:a, value:b};
    }, j("DELETE Statement"), function(a, b, c, d, e) {
      return Object.assign({type:"statement", variant:a, from:b}, c, d, e);
    }, j("DELETE Keyword"), j("CREATE Statement"), j("CREATE TABLE Statement"), function(a, b, c, d) {
      return Object.assign({type:"statement", name:c}, a, d, b);
    }, function(a, b, c) {
      return Object.assign({variant:a, format:z(c)}, b);
    }, function(a) {
      return {temporary:r(a)};
    }, j("IF NOT EXISTS Modifier"), function(a, b, c) {
      return {condition:q({type:"condition", variant:z(a), condition:{type:"expression", variant:z(c), operator:u([b, c])}})};
    }, j("Table Definition"), function(a, b, c) {
      return Object.assign({definition:v([a, b])}, c);
    }, function(a, b) {
      return {optimization:[{type:"optimization", value:u([a, b])}]};
    }, function(a) {
      return a;
    }, j("Column Definition"), function(a, b, c) {
      return Object.assign({type:"definition", variant:"column", name:a, definition:r(c) ? c : []}, b);
      ...
      return {type:"constraint", variant:z(a), value:b};
    }, j("COLLATE Column Constraint"), function(a) {
      return {type:"constraint", variant:"collate", collate:a};
    }, j("Table Constraint"), function(a, b, c) {
      return Object.assign({type:"definition", variant:"constraint"}, b, a);
    }, j("CHECK Table Constraint"), function(a) {
      return {definition:q(a)};
    }, j("PRIMARY KEY Table Constraint"), function(a, b, c) {
      return {definition:q(Object.assign(a, c, b[1])), columns:b[0]};
    }, function(a) {
      return {type:"constraint", variant:z(a)};
    }, function(a, b) {
      return u([a, b]);
      ...
      var d = a;
      return r(b) && (d = Object.assign({type:"expression", variant:"order", expression:a}, b)), [d, c];
    }, j("Collation"), function(a) {
      return {collate:q(a)};
    }, j("Column Direction"), function(a) {
      return {direction:z(a)};
    }, function(a, b) {
      return {conflict:z(b)};
    }, j("ON CONFLICT Keyword"), function(a, b) {
      return u([a, b]);
    }, function(a, b) {
      return {type:"constraint", variant:z(a), expression:b};
    }, j("FOREIGN KEY Table Constraint"), function(a, b, c) {
      return Object.assign({definition:q(Object.assign(a, c))}, b);
    }, j("FOREIGN KEY Keyword"), function(a, b) {
      return {type:"constraint", variant:u([a, b])};
    }, function(a, b, c) {
      return Object.assign({type:"constraint"}, a, b, c);
    }, j("REFERENCES Clause"), function(a, b) {
      return {references:b};
    }, function(a, b) {
      return {action:v([a, b])};
    }, j("FOREIGN KEY Action Clause"), function(a, b, c) {
      return {type:"action", variant:z(a), action:z(c)};
      ...
      return {type:"action", variant:z(a), action:b};
    }, j("DEFERRABLE Clause"), function(a, b, c) {
      return {defer:u([a, b, c])};
    }, function(a, b) {
      return u([a, b]);
    }, function(a) {
      return {definition:q(a)};
    }, j("CREATE INDEX Statement"), function(a, b, c, d, e) {
      return Object.assign({type:"statement", target:c, on:d}, a, b, e);
    }, function(a, b, c) {
      return Object.assign({variant:z(a), format:z(c)}, b);
    }, function(a) {
      return {unique:!0};
    }, j("ON Clause"), function(a, b, c) {
      return {type:"identifier", variant:"expression", format:"table", name:b.name, columns:c};
    }, j("CREATE TRIGGER Statement"), function(a, b, c, d, e, f, g, h) {
      return Object.assign({type:"statement", target:c, on:e, event:d, by:r(f) ? f : "row", action:q(h)}, a, b, g);
    }, function(a, b, c) {
      return Object.assign({variant:z(a), format:z(c)}, b);
    }, j("Conditional Clause"), function(a, b) {
      return Object.assign({type:"event"}, a, b);
    }, function(a) {
      return {occurs:z(a)};
    }, function(a, b) {
      return u([a, b]);
      ...
      return Object.assign({type:"statement", target:c, result:d}, a, b);
    }, function(a, b) {
      return Object.assign({type:"identifier", variant:"expression", format:"view", name:a.name, columns:[]}, b);
    }, function(a, b, c) {
      return Object.assign({variant:z(a), format:z(c)}, b);
    }, j("CREATE VIRTUAL TABLE Statement"), function(a, b, c, d) {
      return Object.assign({type:"statement", target:c, result:d}, a, b);
    }, function(a, b, c) {
      return {variant:z(a), format:z(b)};
    }, function(a, b) {
      return Object.assign({type:"module", variant:"virtual", name:a}, b);
    }, j("Module Arguments"), function(a) {
      return {args:{type:"expression", variant:"list", expression:r(a) ? a : []}};
    }, function(a, b) {
      ...
      return Object.assign({type:"statement", target:Object.assign(b, {variant:a.format})}, a);
    }, j("DROP Keyword"), function(a, b, c) {
      return Object.assign({variant:z(a), format:b, condition:[]}, c);
    }, j("DROP Type"), j("IF EXISTS Keyword"), function(a, b) {
      return {condition:[{type:"condition", variant:z(a), condition:{type:"expression", variant:z(b), operator:z(b)}}]};
      ...
      return {type:"identifier", variant:"database", name:a};
    }, j("Function Identifier"), function(a, b) {
      return {type:"identifier", variant:"function", name:t([a, b])};
    }, j("Table Identifier"), function(a, b) {
      return {type:"identifier", variant:"table", name:t([a, b])};
    }, function(a, b) {
      return t([a, b]);
    }, j("Column Identifier"), function(a, b) {
      return {type:"identifier", variant:"column", name:t([a, b])};
    }, function() {
      return "";
    }, function(a, b) {
      return t([a, b]);
    }, j("Collation Identifier"), function(a) {
      return {type:"identifier", variant:"collation", name:a};
    }, j("Savepoint Identifier"), function(a) {
      return {type:"identifier", variant:"savepoint", name:a};
    }, j("Index Identifier"), function(a, b) {
      return {type:"identifier", variant:"index", name:t([a, b])};
    }, j("Trigger Identifier"), function(a, b) {
      return {type:"identifier", variant:"trigger", name:t([a, b])};
    }, j("View Identifier"), function(a, b) {
      return {type:"identifier", variant:"view", name:t([a, b])};
    }, j("Pragma Identifier"), function(a, b) {
      return {type:"identifier", variant:"pragma", name:t([a, b])};
    }, j("CTE Identifier"), function(a) {
      return a;
    }, function(a, b) {
      return Object.assign({type:"identifier", variant:"expression", format:"table", name:a.name, columns:[]}, b);
    }, j("Table Constraint Identifier"), function(a) {
      return {type:"identifier", variant:"constraint", format:"table", name:a};
    }, j("Column Constraint Identifier"), function(a) {
      return {type:"identifier", variant:"constraint", format:"column", name:a};
      ...
      return t([a, b]);
    }, j("BLOB Datatype Name"), "blob", c("BLOB", !0), /^[a-z0-9$_]/i, d([["a", "z"], ["0", "9"], "$", "_"], !1, !0), "\\u", c("\\u", !1), /^[a-f0-9]/i, d([["a", "f"], ["0", "9"]], !1, !0), function(a, b) {
      ...
      return w(a, "`");
    }, j("Open Bracket"), "[", c("[", !1), j("Close Bracket"), "]", c("]", !1), j("Open Parenthesis"), "(", c("(", !1), j("Close Parenthesis"), ")", c(")", !1), j("Comma"), ",", c(",", !1), j("Period"), ".", c(".", !1), j("Asterisk"), "*", c("*", !1), j("Question Mark"), "?", c("?", !1), j("Single Quote"), j("Double Quote"), j("Backtick"), j("Tilde"), "~", c("~", !1), j("Plus"), "+", c("+", !1), j("Minus"), "-", c("-", !1), "=", c("=", !1), j("Ampersand"), "&", c("&", !1), j("Pipe"), "|", c("|", 
    !1), "%", c("%", !1), "<", c("<", !1), ">", c(">", !1), j("Exclamation"), "!", c("!", !1), j("Semicolon"), ";", c(";", !1), j("Colon"), j("Forward Slash"), "/", c("/", !1), j("Backslash"), "\\", c("\\", !1), "abort", c("ABORT", !0), "action", c("ACTION", !0), "add", c("ADD", !0), "after", c("AFTER", !0), "all", c("ALL", !0), "alter", c("ALTER", !0), "analyze", c("ANALYZE", !0), "and", c("AND", !0), "as", c("AS", !0), "asc", c("ASC", !0), "attach", c("ATTACH", !0), "autoincrement", c("AUTOINCREMENT", 
    !0), "before", c("BEFORE", !0), "begin", c("BEGIN", !0), "between", c("BETWEEN", !0), "by", c("BY", !0), "cascade", c("CASCADE", !0), "case", c("CASE", !0), "cast", c("CAST", !0), "check", c("CHECK", !0), "collate", c("COLLATE", !0), "column", c("COLUMN", !0), "commit", c("COMMIT", !0), "conflict", c("CONFLICT", !0), "constraint", c("CONSTRAINT", !0), "create", c("CREATE", !0), "cross", c("CROSS", !0), "current_date", c("CURRENT_DATE", !0), "current_time", c("CURRENT_TIME", !0), "current_timestamp", 
    c("CURRENT_TIMESTAMP", !0), "database", c("DATABASE", !0), "default", c("DEFAULT", !0), "deferrable", c("DEFERRABLE", !0), "deferred", c("DEFERRED", !0), "delete", c("DELETE", !0), "desc", c("DESC", !0), "detach", c("DETACH", !0), "distinct", c("DISTINCT", !0), "drop", c("DROP", !0), "each", c("EACH", !0), "else", c("ELSE", !0), "end", c("END", !0), "escape", c("ESCAPE", !0), "except", c("EXCEPT", !0), "exclusive", c("EXCLUSIVE", !0), "exists", c("EXISTS", !0), "explain", c("EXPLAIN", !0), "fail", 
    c("FAIL", !0), "for", c("FOR", !0), "foreign", c("FOREIGN", !0), "from", c("FROM", !0), "full", c("FULL", !0), "glob", c("GLOB", !0), "group", c("GROUP", !0), "having", c("HAVING", !0), "if", c("IF", !0), "ignore", c("IGNORE", !0), "immediate", c("IMMEDIATE", !0), "in", c("IN", !0), "index", c("INDEX", !0), "indexed", c("INDEXED", !0), "initially", c("INITIALLY", !0), "inner", c("INNER", !0), "insert", c("INSERT", !0), "instead", c("INSTEAD", !0), "intersect", c("INTERSECT", !0), "into", c("INTO", 
    !0), "is", c("IS", !0), "isnull", c("ISNULL", !0), "join", c("JOIN", !0), "key", c("KEY", !0), "left", c("LEFT", !0), "like", c("LIKE", !0), "limit", c("LIMIT", !0), "match", c("MATCH", !0), "natural", c("NATURAL", !0), "no", c("NO", !0), "not", c("NOT", !0), "notnull", c("NOTNULL", !0), "of", c("OF", !0), "offset", c("OFFSET", !0), "on", c("ON", !0), "or", c("OR", !0), "order", c("ORDER", !0), "outer", c("OUTER", !0), "plan", c("PLAN", !0), "pragma", c("PRAGMA", !0), "primary", c("PRIMARY", 
    !0), "query", c("QUERY", !0), "raise", c("RAISE", !0), "recursive", c("RECURSIVE", !0), "references", c("REFERENCES", !0), "regexp", c("REGEXP", !0), "reindex", c("REINDEX", !0), "release", c("RELEASE", !0), "rename", c("RENAME", !0), "replace", c("REPLACE", !0), "restrict", c("RESTRICT", !0), "right", c("RIGHT", !0), "rollback", c("ROLLBACK", !0), "row", c("ROW", !0), "rowid", c("ROWID", !0), "savepoint", c("SAVEPOINT", !0), "select", c("SELECT", !0), "set", c("SET", !0), "table", c("TABLE", 
    !0), "temp", c("TEMP", !0), "temporary", c("TEMPORARY", !0), "then", c("THEN", !0), "to", c("TO", !0), "transaction", c("TRANSACTION", !0), "trigger", c("TRIGGER", !0), "union", c("UNION", !0), "unique", c("UNIQUE", !0), "update", c("UPDATE", !0), "using", c("USING", !0), "vacuum", c("VACUUM", !0), "values", c("VALUES", !0), "view", c("VIEW", !0), "virtual", c("VIRTUAL", !0), "when", c("WHEN", !0), "where", c("WHERE", !0), "with", c("WITH", !0), "without", c("WITHOUT", !0), function(a) {
      ...
      return null;
    }, j("Line Comment"), "--", c("--", !1), /^[\n\v\f\r]/, d(["\n", "\v", "\f", "\r"], !1, !1), j("Block Comment"), "/*", c("/*", !1), "*/", c("*/", !1), /^[\n\v\f\r\t ]/, d(["\n", "\v", "\f", "\r", "\t", " "], !1, !1), j("Whitespace"), "__TODO__", c("__TODO__", !1)], H = [o("%;\u023f/H#;#/?$;\".\" &\"/1$;#/($8$: $!!)($'#(#'#(\"'#&'#"), o("%;\u023f/C#;#/:$;x/1$;#/($8$: $!!)($'#(#'#(\"'#&'#"), o("%;x/B#;\u023f/9$$;%0#*;%&/)$8#:!#\"\" )(#'#(\"'#&'#"), o("$;\u01b30#*;\u01b3&"), o("$;\u01b3/&#0#*;\u01b3&&&#"), 
    o("%;$/:#;x/1$;\u023f/($8#:\"#!!)(#'#(\"'#&'#"), o('<%;\'.# &;(/@#;\u023f/7$;*." &"/)$8#:$#"" )(#\'#("\'#&\'#=." 7#'), o("%;\u018b/' 8!:%!! )"), o('<%;\u0195/9#$;)0#*;)&/)$8":\'""! )("\'#&\'#=." 7&'), o('%4(""5!7)/1#;\u0197/($8":*"! )("\'#&\'#'), o("<%;\u01a0/R#;5/I$;\u023f/@$;+.\" &\"/2$;\u01a1/)$8%:,%\"#!)(%'#($'#(#'#(\"'#&'#=.\" 7+"), o("%;\u01a2/C#;\u023f/:$;5/1$;\u023f/($8$:-$!!)($'#(#'#(\"'#&'#"), o(";5.; &;6.5 &;2./ &;-.) &;..# &;/"), o('<%;\u0206/1#;\u023f/($8":/"!!)("\'#&\'#=." 7.'), 
    o('<%;\u01d2.) &;\u01d4.# &;\u01d3/1#;\u023f/($8":1"!!)("\'#&\'#=." 70'), o('<%;4." &"/2#;0/)$8":3""! )("\'#&\'#=." 72'), o("<%;\u01a6/A#$;10#*;1&/1$;\u01a6/($8#:5#!!)(#'#(\"'#&'#=.\" 74"), o('26""6677.) &48""5!79'), o('<%4;""5!7</1#;0/($8":="! )("\'#&\'#=." 7:'), o("%;\u0197.# &;\u019b/' 8!:>!! )"), o('<%;\u01aa.# &;\u01ab/\' 8!:"!! )=." 7?'), o('%;4." &"/2#;6/)$8":@""! )("\'#&\'#'), o(";<.# &;7"), o('%;8/7#;;." &"/)$8":A""! )("\'#&\'#'), o('<;9.# &;:=." 7B'), o('%$;>/&#0#*;>&&&#/7#;:." &"/)$8":C""! )("\'#&\'#'), 
    o('%;\u01a3/9#$;>0#*;>&/)$8":D""! )("\'#&\'#'), o('<%3F""5!7G/T#4H""5!7I." &"/@$$;>/&#0#*;>&&&#/*$8#:J##"! )(#\'#("\'#&\'#=." 7E'), o('<%3L""5"7M/?#$;=/&#0#*;=&&&#/)$8":N""! )("\'#&\'#=." 7K'), o('4O""5!7P'), o('4Q""5!7R'), o("<%;@.) &;B.# &;C/' 8!:T!! )=.\" 7S"), o('<%;\u01a5/@#;A." &"/2$;\u023f/)$8#:V#""!)(#\'#("\'#&\'#=." 7U'), o('%4W""5!7X/9#$;>0#*;>&/)$8":Y""! )("\'#&\'#'), o('<%4[""5!7\\/H#$;\u0193/&#0#*;\u0193&&&#/2$;\u023f/)$8#:]#""!)(#\'#("\'#&\'#=." 7Z'), o('<%2_""6_7`/o#$;\u0193.) &2a""6a7b/2#0/*;\u0193.) &2a""6a7b&&&#/A$;\u023f/8$;D." &"/*$8$:c$##" )($\'#(#\'#("\'#&\'#=." 7^'), 
    o('%;\u019b/1#;\u023f/($8":d"!!)("\'#&\'#'), o('<%;F." &"/;#;\u023f/2$;\u0094/)$8#:f#"" )(#\'#("\'#&\'#=." 7e'), o('<%;k." &"/;#;\u01e4/2$;\u023f/)$8#:h#""!)(#\'#("\'#&\'#=." 7g'), o("<%;\u0211/_#;\u023f/V$;\u01a0/M$;\u023f/D$;H/;$;\u023f/2$;\u01a1/)$8':j'\"&\")(''#(&'#(%'#($'#(#'#(\"'#&'#=.\" 7i"), o("<%;I.# &;J/' 8!:l!! )=.\" 7k"), o("<%;\u01ef/' 8!:n!! )=.\" 7m"), o("%;\u021b.) &;\u01b7.# &;\u01e6/M#;\u023f/D$;\u01a2/;$;\u023f/2$;w/)$8%:o%\"$ )(%'#($'#(#'#(\"'#&'#"), o(";?./ &;t.) &;,.# &;\u017d"), 
    o("%;\u01a0/L#;\u023f/C$;o/:$;\u023f/1$;\u01a1/($8%:p%!\")(%'#($'#(#'#(\"'#&'#"), o(";L.; &;E.5 &;_./ &;a.) &;G.# &;K"), o("%;M/;#;\u023f/2$;Q/)$8#:q#\"\" )(#'#(\"'#&'#.# &;M"), o("%;P/A#;\u023f/8$;N.# &;o/)$8#:r#\"\" )(#'#(\"'#&'#.# &;N"), o(";\u01a9.U &;\u01ab.O &;\u01aa.I &%%;k/8#%<;\u01e4=.##&&!&'#/#$+\")(\"'#&'#/\"!&,)"), o("<%;\u012d/' 8!:t!! )=.\" 7s"), o("%;O/\u0083#$%;\u023f/>#;\u0166/5$;\u023f/,$;O/#$+$)($'#(#'#(\"'#&'#0H*%;\u023f/>#;\u0166/5$;\u023f/,$;O/#$+$)($'#(#'#(\"'#&'#&/)$8\":u\"\"! )(\"'#&'#"), 
    o("%;R/\u0083#$%;\u023f/>#;T/5$;\u023f/,$;R/#$+$)($'#(#'#(\"'#&'#0H*%;\u023f/>#;T/5$;\u023f/,$;R/#$+$)($'#(#'#(\"'#&'#&/)$8\":u\"\"! )(\"'#&'#"), o(";\u0169.) &;\u016a.# &;\u016b"), o("%;S/\u0083#$%;\u023f/>#;V/5$;\u023f/,$;S/#$+$)($'#(#'#(\"'#&'#0H*%;\u023f/>#;V/5$;\u023f/,$;S/#$+$)($'#(#'#(\"'#&'#&/)$8\":u\"\"! )(\"'#&'#"), o(";\u0167.# &;\u0168"), o("%;U/\u0083#$%;\u023f/>#;X/5$;\u023f/,$;U/#$+$)($'#(#'#(\"'#&'#0H*%;\u023f/>#;X/5$;\u023f/,$;U/#$+$)($'#(#'#(\"'#&'#&/)$8\":u\"\"! )(\"'#&'#"), 
    o(";\u016c.U &;\u016d.O &;\u016e.I &%%;\u016f/8#%<;\u016f=.##&&!&'#/#$+\")(\"'#&'#/\"!&,)"), o("%;W/\u0083#$%;\u023f/>#;Z/5$;\u023f/,$;W/#$+$)($'#(#'#(\"'#&'#0H*%;\u023f/>#;Z/5$;\u023f/,$;W/#$+$)($'#(#'#(\"'#&'#&/)$8\":u\"\"! )(\"'#&'#"), o(";\u0172.{ &;\u0173.u &%%;\u0170/8#%<;X=.##&&!&'#/#$+\")(\"'#&'#/\"!&,).I &%%;\u0171/8#%<;X=.##&&!&'#/#$+\")(\"'#&'#/\"!&,)"), o('%;Y/9#$;\\0#*;\\&/)$8":u""! )("\'#&\'#'), o("%;\u023f/1#;]/($8\":v\"! )(\"'#&'#.H &%;\u023f/>#;^/5$;\u023f/,$;Y/#$+$)($'#(#'#(\"'#&'#"), 
    o('%3w""5$7x/?#;\u023f/6$3y""5$7z/\'$8#:{# )(#\'#("\'#&\'#.? &%;\u01fb/& 8!:|! ).. &%;\u0205/& 8!:{! )'), o(";\u0177./ &;\u0175.) &;\u0176.# &;\u0174"), o("<%;\u01c9/i#;\u023f/`$;\u01a0/W$;o/N$;\u023f/E$;`/<$;\u023f/3$;\u01a1/*$8(:~(#'$\")(('#(''#(&'#(%'#($'#(#'#(\"'#&'#=.\" 7}"), o("<%;\u01bf/:#;\u023f/1$;&/($8#:\u0080#! )(#'#(\"'#&'#=.\" 7\u007f"), o("<%;\u01c8/\u0093#;\u023f/\u008a$;b.\" &\"/|$;\u023f/s$$;c/&#0#*;c&&&#/]$;\u023f/T$;d.\" &\"/F$;\u023f/=$;\u01e0/4$;\u023f/+$8*:\u0082*$)'%#)(*'#()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#=.\" 7\u0081"), 
    o("%%<;\u0230=.##&&!&'#/1#;o/($8\":\u0083\"! )(\"'#&'#"), o("<%;\u0230/i#;\u023f/`$;o/W$;\u023f/N$;\u0224/E$;\u023f/<$;o/3$;\u023f/*$8(:\u0085(#'%!)(('#(''#(&'#(%'#($'#(#'#(\"'#&'#=.\" 7\u0084"), o("<%;\u01df/D#;\u023f/;$;o/2$;\u023f/)$8$:\u0087$\"#!)($'#(#'#(\"'#&'#=.\" 7\u0086"), o("%;[/;#;\u023f/2$;f/)$8#:\u0088#\"\" )(#'#(\"'#&'#.# &;["), o(";l.) &;i.# &;g"), o('<%;k." &"/o#;\u01ff./ &;\u01eb.) &;\u0214.# &;\u0201/T$;\u023f/K$;o/B$;\u023f/9$;h." &"/+$8&:\u008a&$%$" )(&\'#(%\'#($\'#(#\'#("\'#&\'#=." 7\u0089'), 
    o("<%;\u01e1/D#;\u023f/;$;o/2$;\u023f/)$8$:\u008c$\"#!)($'#(#'#(\"'#&'#=.\" 7\u008b"), o('<%;k." &"/E#;\u01c5/<$;\u023f/3$;j/*$8$:\u008e$##" )($\'#(#\'#("\'#&\'#=." 7\u008d'), o("%;e/W#%;\u023f/>#;\u01be/5$;\u023f/,$;e/#$+$)($'#(#'#(\"'#&'#/)$8\":\u008f\"\"! )(\"'#&'#"), o('%;\u0204/1#;\u023f/($8":\u0090"!!)("\'#&\'#'), o('<%;k." &"/E#;\u01f1/<$;\u023f/3$;m/*$8$:\u0092$##" )($\'#(#\'#("\'#&\'#=." 7\u0091'), o(";n.# &;\u017b"), o("%;\u01a0/I#;\u0095.# &;q/:$;\u023f/1$;\u01a1/($8$:\u0093$!\")($'#(#'#(\"'#&'#"), 
    o("%;e/\u0083#$%;\u023f/>#;p/5$;\u023f/,$;e/#$+$)($'#(#'#(\"'#&'#0H*%;\u023f/>#;p/5$;\u023f/,$;e/#$+$)($'#(#'#(\"'#&'#&/)$8\":u\"\"! )(\"'#&'#"), o(";\u01be.# &;\u020a"), o('<%;r." &"/1#;\u023f/($8":\u0095"!!)("\'#&\'#=." 7\u0094'), o("%;o/B#;\u023f/9$$;s0#*;s&/)$8#:\u0096#\"\" )(#'#(\"'#&'#"), o("%;\u01a2/:#;o/1$;\u023f/($8#:\u0093#!!)(#'#(\"'#&'#"), o("<%;\u017a/[#;\u023f/R$;\u01a0/I$;u.\" &\"/;$;\u023f/2$;\u01a1/)$8&:\u0098&\"%\")(&'#(%'#($'#(#'#(\"'#&'#=.\" 7\u0097"), o('<%;\u00db/\' 8!:\u009a!! ).V &%;v." &"/G#;q/>$9:\u009b "! -""&!&#/)$8#:\u009c#""!)(#\'#("\'#&\'#=." 7\u0099'), 
    o('%;\u01dc.# &;\u01bb/1#;\u023f/($8":\u009d"!!)("\'#&\'#'), o("<%;//' 8!:\u009f!! )=.\" 7\u009e"), o('<%;y." &"/;#;{/2$;\u023f/)$8#:\u00a1#""!)(#\'#("\'#&\'#=." 7\u00a0'), o('<%;\u01e5/@#;\u023f/7$;z." &"/)$8#:\u00a3#"" )(#\'#("\'#&\'#=." 7\u00a2'), o("<%;\u0210/D#;\u023f/;$;\u020d/2$;\u023f/)$8$:\u00a5$\"#!)($'#(#'#(\"'#&'#=.\" 7\u00a4"), o(";\u008c.S &;\u00fb.M &;\u0162.G &;}.A &;|.; &;\u0086.5 &;\u0080./ &;\u0084.) &;\u0085.# &;\u0096"), o('<%;\u01cd.# &;\u01e0/@#;\u023f/7$;~." &"/)$8#:\u00a7#"" )(#\'#("\'#&\'#=." 7\u00a6'), 
    o('<%;\u01c4/^#;\u023f/U$;\u007f." &"/G$;~." &"/9$;\u0082." &"/+$8%:\u00a9%$$"! )(%\'#($\'#(#\'#("\'#&\'#=." 7\u00a8'), o('%;\u0226/1#;\u023f/($8":\u00aa"!!)("\'#&\'#'), o('%;\u01d8.) &;\u01f0.# &;\u01e3/1#;\u023f/($8":\u00ab"!!)("\'#&\'#'), o('<%;\u021b/N#;\u023f/E$;~." &"/7$;\u0081." &"/)$8$:\u00ad$"# )($\'#(#\'#("\'#&\'#=." 7\u00ac'), o('<%%;\u0225/,#;\u023f/#$+")("\'#&\'#." &"/?#;\u0083." &"/1$;\u0082/($8#:p#! )(#\'#("\'#&\'#=." 7\u00ae'), o('%;\u0182/1#;\u023f/($8":\u00af"!!)("\'#&\'#'), 
    o('%;\u021e/1#;\u023f/($8":\u00b0"!!)("\'#&\'#'), o('<%;\u0083/2#;\u0082/)$8":\u00b2""! )("\'#&\'#=." 7\u00b1'), o("<%;\u0216/J#;\u023f/A$;\u0083.\" &\"/3$;\u0082/*$8$:\u00b4$##! )($'#(#'#(\"'#&'#=.\" 7\u00b3"), o("<%;\u0087/N#;\u017b/E$;\u023f/<$;\u0088/3$;\u023f/*$8%:\u00b6%#$#!)(%'#($'#(#'#(\"'#&'#=.\" 7\u00b5"), o("<%;\u01bc/D#;\u023f/;$;\u0221/2$;\u023f/)$8$:\u00b8$\"#!)($'#(#'#(\"'#&'#=.\" 7\u00b7"), o(";\u0089.# &;\u008a"), o("<%;\u0217/M#;\u023f/D$;\u0225/;$;\u023f/2$;\u017b/)$8%:\u00ba%\"$ )(%'#($'#(#'#(\"'#&'#=.\" 7\u00b9"), 
    o('<%;\u01b9/I#;\u023f/@$;\u008b." &"/2$;\u010c/)$8$:\u00bc$"# )($\'#(#\'#("\'#&\'#=." 7\u00bb'), o('%;\u01cc/1#;\u023f/($8":\u00b0"!!)("\'#&\'#'), o('%;\u008d/2#;\u00a7/)$8":\u00bd""! )("\'#&\'#'), o('<%;\u008e." &"/1#;\u023f/($8":*"!!)("\'#&\'#=." 7\u00be'), o("%;\u0232/J#;\u023f/A$;\u008f.\" &\"/3$;\u0090/*$8$:\u00bf$##! )($'#(#'#(\"'#&'#"), o('%;\u0212/1#;\u023f/($8":\u00b0"!!)("\'#&\'#'), o("%;\u0092/B#;\u023f/9$$;\u00910#*;\u0091&/)$8#:\u00c0#\"\" )(#'#(\"'#&'#"), o("%;\u01a2/:#;\u0092/1$;\u023f/($8#:\u0093#!!)(#'#(\"'#&'#"), 
    o('<%;\u0187/2#;\u0093/)$8":\u00c2""! )("\'#&\'#=." 7\u00c1'), o("%;\u01bf/:#;\u023f/1$;\u0094/($8#:\u00c3#! )(#'#(\"'#&'#"), o("%;\u01a0/C#;\u0095/:$;\u023f/1$;\u01a1/($8$: $!\")($'#(#'#(\"'#&'#"), o('%;\u008d/2#;\u00a8/)$8":\u00c4""! )("\'#&\'#'), o(";\u0097.; &;\u0099.5 &;\u009a./ &;\u009c.) &;\u009e.# &;\u00a0"), o("<%;\u01c1/\u008b#;\u023f/\u0082$%;\u01d5/,#;\u023f/#$+\")(\"'#&'#.\" &\"/a$;o/X$;\u023f/O$;\u01bf/F$;\u023f/=$;\u0098/4$;\u023f/+$8):\u00c6)$(&%!)()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#=.\" 7\u00c5"), 
    o(";\u0179.) &;-.# &;?"), o("<%;\u01db/f#;\u023f/]$%;\u01d5/,#;\u023f/#$+\")(\"'#&'#.\" &\"/<$;\u0098/3$;\u023f/*$8%:\u00c8%#$\"!)(%'#($'#(#'#(\"'#&'#=.\" 7\u00c7"), o('<%;\u022c/@#;\u023f/7$;\u009b." &"/)$8#:\u00ca#"" )(#\'#("\'#&\'#=." 7\u00c9'), o('%;\u0179/1#;\u023f/($8":\u00cb"!!)("\'#&\'#'), o('<%;\u01bd/@#;\u023f/7$;\u009d." &"/)$8#:\u00cd#"" )(#\'#("\'#&\'#=." 7\u00cc'), o('%;\u017b.) &;\u0183.# &;\u0179/1#;\u023f/($8":\u00ce"!!)("\'#&\'#'), o('<%;\u0215/I#;\u023f/@$;\u009f." &"/2$;\u023f/)$8$:\u00cd$"#!)($\'#(#\'#("\'#&\'#=." 7\u00cf'), 
    o('%;\u017b.) &;\u0183.# &;\u0181/1#;\u023f/($8":\u00d0"!!)("\'#&\'#'), o("<%;\u020e/S#;\u023f/J$;\u0186/A$;\u023f/8$;\u00a1.\" &\"/*$8%:\u00d2%#$\" )(%'#($'#(#'#(\"'#&'#=.\" 7\u00d1"), o("%;\u01a0/C#;\u00a2/:$;\u023f/1$;\u01a1/($8$:\u00d3$!\")($'#(#'#(\"'#&'#.D &%;\u01ac/:#;\u00a2/1$;\u023f/($8#:\u00d3#!!)(#'#(\"'#&'#"), o(";\u00a4.) &;\u00a3.# &;\u00a6"), o(";5.) &;/.# &;3"), o('%;\u00a5/<#9:\u00d4 ! -""&!&#/($8":\u00d5"!!)("\'#&\'#'), o("%$;\u0193/&#0#*;\u0193&&&#/' 8!:\u00d6!! )"), o("%;\u00a5/' 8!:\u00d7!! )"), 
    o(";\u00a8./ &;\u00dd.) &;\u00f2.# &;\u00f9"), o('<%;\u00ae/X#;\u023f/O$;\u00a9." &"/A$;\u023f/8$;\u00aa." &"/*$8%:\u00d9%#$" )(%\'#($\'#(#\'#("\'#&\'#=." 7\u00d8'), o("<%;\u020b/L#;\u023f/C$;\u01c6/:$;\u023f/1$;\u00d8/($8%:\u00db%! )(%'#($'#(#'#(\"'#&'#=.\" 7\u00da"), o("<%;\u0200/S#;\u023f/J$;o/A$;\u023f/8$;\u00ab.\" &\"/*$8%:\u00dd%#$\" )(%'#($'#(#'#(\"'#&'#=.\" 7\u00dc"), o('<%;\u00ac/2#;o/)$8":\u00df""! )("\'#&\'#=." 7\u00de'), o(";\u00ad.# &;\u01a2"), o('%;\u0208/1#;\u023f/($8":\u00b0"!!)("\'#&\'#'), 
    o("%;\u00b0/B#;\u023f/9$$;\u00af0#*;\u00af&/)$8#:\u00e0#\"\" )(#'#(\"'#&'#"), o("<%;\u00ef/D#;\u023f/;$;\u00b0/2$;\u023f/)$8$:\u00e2$\"#!)($'#(#'#(\"'#&'#=.\" 7\u00e1"), o(";\u00b1.# &;\u00d7"), o('%;\u00b2/U#;\u00b8." &"/G$;\u00b9." &"/9$;\u00ba." &"/+$8$:\u00e3$$#"! )($\'#(#\'#("\'#&\'#'), o('<%;\u021f/R#;\u023f/I$;\u00b3." &"/;$;\u023f/2$;\u00b6/)$8%:\u00e5%"" )(%\'#($\'#(#\'#("\'#&\'#=." 7\u00e4'), o('<;\u00b4.# &;\u00b5=." 7\u00e6'), o('%;\u01dc/1#;\u023f/($8":\u00e7"!!)("\'#&\'#'), o('%;\u01bb/1#;\u023f/($8":\u00e8"!!)("\'#&\'#'), 
    o("%;\u00bc/B#;\u023f/9$$;\u00b70#*;\u00b7&/)$8#:\u00c0#\"\" )(#'#(\"'#&'#"), o("%;\u01a2/:#;\u00bc/1$;\u023f/($8#:-#!!)(#'#(\"'#&'#"), o("<%;\u01e9/D#;\u023f/;$;\u00c0/2$;\u023f/)$8$:\u00ea$\"#!)($'#(#'#(\"'#&'#=.\" 7\u00e9"), o("<%;\u0231/D#;\u023f/;$;o/2$;\u023f/)$8$:\u00ec$\"#!)($'#(#'#(\"'#&'#=.\" 7\u00eb"), o("<%;\u01ec/e#;\u023f/\\$;\u01c6/S$;\u023f/J$;q/A$;\u023f/8$;\u00bb.\" &\"/*$8':\u00ee'#&\" )(''#(&'#(%'#($'#(#'#(\"'#&'#=.\" 7\u00ed"), o("<%;\u01ed/D#;\u023f/;$;o/2$;\u023f/)$8$:\u00f0$\"#!)($'#(#'#(\"'#&'#=.\" 7\u00ef"), 
    o(";\u00bd.# &;\u00bf"), o('%;\u00be." &"/2#;\u00db/)$8":\u00f1""! )("\'#&\'#'), o('%;\u0195/2#;\u01a3/)$8":\u00f2""! )("\'#&\'#'), o('%;o/@#;\u023f/7$;\u00cd." &"/)$8#:\u00f3#"" )(#\'#("\'#&\'#'), o("%;\u00c4/B#;\u023f/9$$;\u00c10#*;\u00c1&/)$8#:\u00f4#\"\" )(#'#(\"'#&'#"), o('%;\u00c2.# &;\u00c3/7#;\u00d4." &"/)$8":\u00f5""! )("\'#&\'#'), o("<%;\u01a2/:#;\u00c4/1$;\u023f/($8#:\u00f7#!!)(#'#(\"'#&'#=.\" 7\u00f6"), o("<%;\u00ce/D#;\u023f/;$;\u00c4/2$;\u023f/)$8$:\u00f9$\"#!)($'#(#'#(\"'#&'#=.\" 7\u00f8"), 
    o(";\u00cb.5 &;?./ &;\u00c5.) &;\u00c6.# &;\u00cc"), o("%;\u017a/S#;\u023f/J$;\u00ed/A$;\u023f/8$;\u00cd.\" &\"/*$8%:\u00fa%#$\" )(%'#($'#(#'#(\"'#&'#"), o('<%;\u00c7/@#;\u023f/7$;\u00c8." &"/)$8#:\u00fc#"" )(#\'#("\'#&\'#=." 7\u00fb'), o('<%;\u017b/@#;\u023f/7$;\u00cd." &"/)$8#:\u00fe#"" )(#\'#("\'#&\'#=." 7\u00fd'), o('<;\u00c9.# &;\u00ca=." 7\u00ff'), o("%;\u01f3/V#;\u023f/M$;\u01c6/D$;\u023f/;$;\u0183/2$;\u023f/)$8&:\u0100&\"%!)(&'#(%'#($'#(#'#(\"'#&'#"), o("%;k/;#;\u01f3/2$;\u023f/)$8#:\u0101#\"\"!)(#'#(\"'#&'#"), 
    o("<%;\u01a0/R#;\u00c0/I$;\u023f/@$;\u01a1/7$;\u00cd.\" &\"/)$8%:\u0103%\"# )(%'#($'#(#'#(\"'#&'#=.\" 7\u0102"), o('<%;\u0094/7#;\u00cd." &"/)$8":\u0105""! )("\'#&\'#=." 7\u0104'), o('<%%;\u01bf/Q#%%<;\u0193.# &;\u0236=.##&&!&\'#/,#;\u023f/#$+")("\'#&\'#/#$+")("\'#&\'#." &"/;#;\u0195/2$;\u023f/)$8#:\u0107#""!)(#\'#("\'#&\'#=." 7\u0106'), o('<%;\u00cf." &"/J#;\u023f/A$;\u00d0." &"/3$;\u01fc/*$8$:\u0109$##! )($\'#(#\'#("\'#&\'#=." 7\u0108'), o('%;\u0202/1#;\u023f/($8":\u0090"!!)("\'#&\'#'), o(";\u00d1.# &;\u00d3"), 
    o('%;\u01fe.) &;\u021a.# &;\u01ea/@#;\u023f/7$;\u00d2." &"/)$8#:\u010a#"" )(#\'#("\'#&\'#'), o('%;\u020c/1#;\u023f/($8":\u010b"!!)("\'#&\'#'), o('%;\u01f5.# &;\u01d1/1#;\u023f/($8":\u010b"!!)("\'#&\'#'), o('<%;\u00d5.# &;\u00d6/1#;\u023f/($8":\u010d"!!)("\'#&\'#=." 7\u010c'), o('<%;\u0209/;#;\u023f/2$;o/)$8#:\u010f#"" )(#\'#("\'#&\'#=." 7\u010e'), o('<%;\u022b/;#;\u023f/2$;\u00e6/)$8#:\u0111#"" )(#\'#("\'#&\'#=." 7\u0110'), o('<%;\u022d/;#;\u023f/2$;\u00eb/)$8#:\u0113#"" )(#\'#("\'#&\'#=." 7\u0112'), 
    o("%;\u00da/B#;\u023f/9$$;\u00d90#*;\u00d9&/)$8#:\u0114#\"\" )(#'#(\"'#&'#"), o("%;\u01a2/:#;\u00da/1$;\u023f/($8#:\u0115#!!)(#'#(\"'#&'#"), o('<%;o/@#;\u023f/7$;\u012f." &"/)$8#:\u0117#"" )(#\'#("\'#&\'#=." 7\u0116'), o('<;\u01a4=." 7\u0118'), o('<;\u0218.5 &;\u021b./ &;\u01b7.) &;\u01e6.# &;\u01ef=." 7\u0119'), o('<%;\u00de/;#;\u023f/2$;\u00e2/)$8#:\u011b#"" )(#\'#("\'#&\'#=." 7\u011a'), o(";\u00df.# &;\u00e0"), o('<%;\u01f6/@#;\u023f/7$;\u00e1." &"/)$8#:\u011d#"" )(#\'#("\'#&\'#=." 7\u011c'), 
    o('<%;\u0218/1#;\u023f/($8":\u011f"!!)("\'#&\'#=." 7\u011e'), o('<%;\u020a/;#;\u023f/2$;\u00dc/)$8#:\u0121#"" )(#\'#("\'#&\'#=." 7\u0120'), o('%;\u00e3/2#;\u00e5/)$8":\u0122""! )("\'#&\'#'), o('<%;\u00e4/2#;\u0187/)$8":\u0124""! )("\'#&\'#=." 7\u0123'), o('<%;\u01f9/,#;\u023f/#$+")("\'#&\'#=." 7\u0125'), o('<%;\u00e9.) &;\u0095.# &;\u00ee/1#;\u023f/($8":\u0126"!!)("\'#&\'#=." 7\u0112'), o("<%;\u01a0/T#;\u00e8/K$;\u023f/B$$;\u00e70#*;\u00e7&/2$;\u01a1/)$8%:\u0128%\"#!)(%'#($'#(#'#(\"'#&'#=.\" 7\u0127"), 
    o("%;\u01a2/:#;\u00e8/1$;\u023f/($8#:\u0129#!!)(#'#(\"'#&'#"), o("<%;\u0178/' 8!:\u012b!! )=.\" 7\u012a"), o('<%;\u00ea/2#;\u00eb/)$8":\u012c""! )("\'#&\'#=." 7\u0112'), o('<%;\u022d/1#;\u023f/($8":\u00b0"!!)("\'#&\'#=." 7\u012d'), o("%;\u00ed/B#;\u023f/9$$;\u00ec0#*;\u00ec&/)$8#:\u012e#\"\" )(#'#(\"'#&'#"), o("%;\u01a2/:#;\u00ed/1$;\u023f/($8#:\u0093#!!)(#'#(\"'#&'#"), o("<%;\u01a0/C#;q/:$;\u023f/1$;\u01a1/($8$:\u0130$!\")($'#(#'#(\"'#&'#=.\" 7\u012f"), o('<%;\u01d6/;#;\u023f/2$;\u022d/)$8#:\u0132#"" )(#\'#("\'#&\'#=." 7\u0131'), 
    o("<%;\u00f0.) &;\u01f8.# &;\u01e2/' 8!:\u00b0!! )=.\" 7\u0133"), o('<%;\u0228/@#;\u023f/7$;\u00f1." &"/)$8#:\u0135#"" )(#\'#("\'#&\'#=." 7\u0134'), o('%;\u01bb/1#;\u023f/($8":\u0136"!!)("\'#&\'#'), o("<%;\u00f3/\u008a#;\u00f4.\" &\"/|$;\u00c6/s$;\u023f/j$;\u00f5/a$;\u00b9.\" &\"/S$;\u00a9.\" &\"/E$;\u023f/<$;\u00aa.\" &\"/.$8):\u0138)'('&$#\" )()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#=.\" 7\u0137"), o('<%;\u022a/1#;\u023f/($8":\u00b0"!!)("\'#&\'#=." 7\u0139'), o("<%;\u020a/C#;\u023f/:$;\u00dc/1$;\u023f/($8$:\u013b$!!)($'#(#'#(\"'#&'#=.\" 7\u013a"), 
    o("<%;\u0220/C#;\u023f/:$;\u00f6/1$;\u023f/($8$:\u013d$!!)($'#(#'#(\"'#&'#=.\" 7\u013c"), o('%;\u00f8/9#$;\u00f70#*;\u00f7&/)$8":\u012e""! )("\'#&\'#'), o("%;\u023f/:#;\u01a2/1$;\u00f8/($8#:\u0129#! )(#'#(\"'#&'#"), o("<%;\u017d/M#;\u023f/D$;\u01ac/;$;o/2$;\u023f/)$8%:\u013f%\"$!)(%'#($'#(#'#(\"'#&'#=.\" 7\u013e"), o('<%;\u00fa/h#;\u00c6/_$;\u023f/V$;\u00b9." &"/H$;\u00a9." &"/:$;\u00aa." &"/,$8&:\u0141&%%$"! )(&\'#(%\'#($\'#(#\'#("\'#&\'#=." 7\u0140'), o("<%;\u01d9/C#;\u023f/:$;\u01e9/1$;\u023f/($8$:\u00b0$!#)($'#(#'#(\"'#&'#=.\" 7\u0142"), 
    o('<;\u00fd.5 &;\u00fe./ &;\u00ff.) &;\u0100.# &;\u0101=." 7\u0143'), o('%;\u01d0/1#;\u023f/($8":\u00b0"!!)("\'#&\'#'), o("%%<%;\u00fc/>#;\u01f2./ &;\u0227.) &;\u022e.# &;\u022f/#$+\")(\"'#&'#=.##&&!&'#/1#;\u0102/($8\":\u0129\"! )(\"'#&'#"), o("%%<%;\u00fc/>#;\u0221./ &;\u0227.) &;\u022e.# &;\u022f/#$+\")(\"'#&'#=.##&&!&'#/1#;\u0143/($8\":\u0129\"! )(\"'#&'#"), o("%%<%;\u00fc/>#;\u0221./ &;\u01f2.) &;\u022e.# &;\u022f/#$+\")(\"'#&'#=.##&&!&'#/1#;\u0147/($8\":\u0129\"! )(\"'#&'#"), o("%%<%;\u00fc/>#;\u0221./ &;\u01f2.) &;\u0227.# &;\u022f/#$+\")(\"'#&'#=.##&&!&'#/1#;\u0156/($8\":\u0129\"! )(\"'#&'#"), 
    o("%%<%;\u00fc/>#;\u0221./ &;\u01f2.) &;\u0227.# &;\u022e/#$+\")(\"'#&'#=.##&&!&'#/1#;\u015a/($8\":\u0129\"! )(\"'#&'#"), o("<%;\u0103/T#;\u0105.\" &\"/F$;\u017b/=$;\u023f/4$;\u0106/+$8%:\u0145%$$#\" )(%'#($'#(#'#(\"'#&'#=.\" 7\u0144"), o("%;\u00fc/J#;\u0104.\" &\"/<$;\u0221/3$;\u023f/*$8$:\u0146$##\"!)($'#(#'#(\"'#&'#"), o('%;\u0223.# &;\u0222/1#;\u023f/($8":\u0147"!!)("\'#&\'#'), o("<%;\u01ee/N#;\u023f/E$;k/<$;\u01e4/3$;\u023f/*$8%:\u0149%#$\"!)(%'#($'#(#'#(\"'#&'#=.\" 7\u0148"), o(";\u0107.# &;\u0142"), 
    o("<%;\u01a0/Z#;\u0109/Q$$;\u010b0#*;\u010b&/A$;\u01a1/8$;\u0108.\" &\"/*$8%:\u014b%##\" )(%'#($'#(#'#(\"'#&'#=.\" 7\u014a"), o("%;\u0233/D#;\u023f/;$;\u021d/2$;\u023f/)$8$:\u014c$\"#!)($'#(#'#(\"'#&'#"), o("%;\u010c/B#;\u023f/9$$;\u010a0#*;\u010a&/)$8#:\u012e#\"\" )(#'#(\"'#&'#"), o("%;\u01a2/:#;\u010c/1$;\u023f/($8#:\u00aa#!!)(#'#(\"'#&'#"), o('%;\u01a2." &"/1#;\u0120/($8":\u014d"! )("\'#&\'#'), o('<%;\u010d/O#;\u023f/F$;\u010e." &"/8$;\u010f." &"/*$8$:\u014f$##! )($\'#(#\'#("\'#&\'#=." 7\u014e'), 
    o("%;\u0195/=#%<;\u023f=/##&'!&&#/($8\":p\"!!)(\"'#&'#.\\ &%%<;\u010e.) &;\u0111.# &;\u0120=.##&&!&'#/:#;\u023f/1$;\u0198/($8#:p#! )(#'#(\"'#&'#"), o('<%;&/1#;\u023f/($8":\u0151"!!)("\'#&\'#=." 7\u0150'), o("%;\u0111/B#$;\u01100#*;\u0110&/2$;\u023f/)$8#:\u012e#\"\"!)(#'#(\"'#&'#"), o('%;\u023f/1#;\u0111/($8":\u0129"! )("\'#&\'#'), o('<%;\u0112." &"/A#;\u0114/8$;\u0112." &"/*$8#:\u0153##"! )(#\'#("\'#&\'#=." 7\u0152'), o("%$;\u0113/&#0#*;\u0113&&&#/' 8!:\u0154!! )"), o("<%;\u01cf/C#;\u023f/:$;\u0195/1$;\u023f/($8$:\u0156$!!)($'#(#'#(\"'#&'#=.\" 7\u0155"), 
    o(";\u0116.; &;\u0119.5 &;\u011c./ &;\u011d.) &;\u011f.# &;\u0115"), o("<%;\u0135/' 8!:\u0158!! )=.\" 7\u0157"), o('<%;\u0117/U#;\u012f." &"/G$;\u0130." &"/9$;\u0118." &"/+$8$:\u015a$$#"! )($\'#(#\'#("\'#&\'#=." 7\u0159'), o("<%;\u020f.# &;\u020e/D#;\u023f/;$;\u01fd/2$;\u023f/)$8$:\u015c$\"#!)($'#(#'#(\"'#&'#=.\" 7\u015b"), o('<%;\u01c2/1#;\u023f/($8":\u015e"!!)("\'#&\'#=." 7\u015d'), o('%;\u011a/@#;\u0130." &"/2$;\u023f/)$8#:\u015f#""!)(#\'#("\'#&\'#'), o('<%;\u011b.# &;\u0229/1#;\u023f/($8":\u010b"!!)("\'#&\'#=." 7\u0160'), 
    o('<%;k." &"/2#;\u0206/)$8":\u0162""! )("\'#&\'#=." 7\u0161'), o('<;\u0132=." 7\u0163'), o("<%;\u01d6/D#;\u023f/;$;\u011e/2$;\u023f/)$8$:\u0165$\"#!)($'#(#'#(\"'#&'#=.\" 7\u0164"), o(";L./ &;5.) &;,.# &;3"), o("<%;\u012d/' 8!:\u0167!! )=.\" 7\u0166"), o('<%;\u0112." &"/J#;\u0121/A$;\u023f/8$;\u0112." &"/*$8$:\u0169$##" )($\'#(#\'#("\'#&\'#=." 7\u0168'), o(";\u0133.) &;\u0123.# &;\u0122"), o("<%;\u0132/' 8!:\u016b!! )=.\" 7\u016a"), o("<%;\u0124/J#;\u023f/A$;\u0129/8$;\u0130.\" &\"/*$8$:\u016d$##! )($'#(#'#(\"'#&'#=.\" 7\u016c"), 
    o('%;\u0125.# &;\u0126/1#;\u023f/($8":\u016e"!!)("\'#&\'#'), o('<%;\u020f/;#;\u023f/2$;\u01fd/)$8#:\u016f#"" )(#\'#("\'#&\'#=." 7\u015b'), o("<%;\u0229/' 8!:\u0171!! )=.\" 7\u0170"), o("%;\u01a0/T#;\u012b/K$;\u023f/B$$;\u012a0#*;\u012a&/2$;\u01a1/)$8%:\u0172%\"#!)(%'#($'#(#'#(\"'#&'#"), o("%;\u0127/' 8!:\u0173!! )"), o("%;\u0127/' 8!:\u0174!! )"), o("%;\u01a2/:#;\u012b/1$;\u023f/($8#:\u0129#!!)(#'#(\"'#&'#"), o('<%;\u012c/O#;\u023f/F$;\u012f." &"/8$;\u0118." &"/*$8$:\u0176$##! )($\'#(#\'#("\'#&\'#=." 7\u0175'), 
    o("%;\u00e8/\\#%<%;\u023f/8#;\u01b3.) &;\u01a1.# &;\u012f/#$+\")(\"'#&'#=/##&'!&&#/($8\":p\"!!)(\"'#&'#.# &;o"), o("<%$;\u012e/&#0#*;\u012e&&&#/' 8!:\u0178!! )=.\" 7\u0177"), o("%;\u01cb/C#;\u023f/:$;\u0181/1$;\u023f/($8$:p$!!)($'#(#'#(\"'#&'#"), o('<%;\u01c0.# &;\u01da/1#;\u023f/($8":\u017a"!!)("\'#&\'#=." 7\u0179'), o("%;\u0131/;#;\u00dc/2$;\u023f/)$8#:\u017b#\"\"!)(#'#(\"'#&'#"), o("<%;\u0209/D#;\u023f/;$;\u01ce/2$;\u023f/)$8$:\u017d$\"#!)($'#(#'#(\"'#&'#=.\" 7\u017c"), o("%;\u01ca/;#;\u023f/2$;L/)$8#:\u017e#\"\" )(#'#(\"'#&'#"), 
    o("<%;\u0134/E#;\u00e6/<$;\u0135/3$;\u023f/*$8$:\u0180$##\"!)($'#(#'#(\"'#&'#=.\" 7\u017f"), o("<%;\u01e8/D#;\u023f/;$;\u01fd/2$;\u023f/)$8$:\u0182$\"#!)($'#(#'#(\"'#&'#=.\" 7\u0181"), o('%;\u0136/F#;\u0137." &"/8$;\u0140." &"/*$8#:\u0183##"! )(#\'#("\'#&\'#'), o("<%;\u0213/D#;\u023f/;$;\u0187/2$;\u023f/)$8$:\u0185$\"#!)($'#(#'#(\"'#&'#=.\" 7\u0184"), o("%;\u0139/B#;\u023f/9$$;\u01380#*;\u0138&/)$8#:\u0186#\"\" )(#'#(\"'#&'#"), o('%;\u0139/1#;\u023f/($8":\u0136"!!)("\'#&\'#'), o('<;\u013a.# &;\u013f=." 7\u0187'), 
    o("%;\u0209/T#;\u023f/K$;\u01d9.# &;\u022a/<$;\u023f/3$;\u013b/*$8%:\u0188%#$\" )(%'#($'#(#'#(\"'#&'#"), o('<;\u013c.) &;\u013d.# &;\u013e=." 7\u0189'), o("%;\u0220/J#;\u023f/A$;\u0206.# &;\u01d6/2$;\u023f/)$8$:\u018a$\"#!)($'#(#'#(\"'#&'#"), o('%;\u01c7.# &;\u0219/1#;\u023f/($8":\u018b"!!)("\'#&\'#'), o("%;\u0203/D#;\u023f/;$;\u01b8/2$;\u023f/)$8$:\u018c$\"#!)($'#(#'#(\"'#&'#"), o("%;\u0201/D#;\u023f/;$;\u0195/2$;\u023f/)$8$:\u018d$\"#!)($'#(#'#(\"'#&'#"), o('<%;k." &"/J#;\u01d7/A$;\u023f/8$;\u0141." &"/*$8$:\u018f$##" )($\'#(#\'#("\'#&\'#=." 7\u018e'), 
    o("%;\u01f4/J#;\u023f/A$;\u01d8.# &;\u01f0/2$;\u023f/)$8$:\u0190$\"#!)($'#(#'#(\"'#&'#"), o("%;\u0159/' 8!:\u0191!! )"), o("<%;\u0144/c#;\u0105.\" &\"/U$;\u0183/L$;\u023f/C$;\u0146/:$;\u00b9.\" &\"/,$8&:\u0193&%%$#! )(&'#(%'#($'#(#'#(\"'#&'#=.\" 7\u0192"), o("%;\u00fc/J#;\u0145.\" &\"/<$;\u01f2/3$;\u023f/*$8$:\u0194$##\"!)($'#(#'#(\"'#&'#"), o('%;\u0229/1#;\u023f/($8":\u0195"!!)("\'#&\'#'), o("<%;\u0209/N#;\u023f/E$;\u017b/<$;\u023f/3$;\u0128/*$8%:\u0197%#$\" )(%'#($'#(#'#(\"'#&'#=.\" 7\u0196"), 
    o("<%;\u0148/\u00a6#;\u0105.\" &\"/\u0098$;\u0184.\" &\"/\u008a$;\u023f/\u0081$;\u0149/x$;\u0209/o$;\u023f/f$;\u017b/]$;\u023f/T$;\u0151.\" &\"/F$;\u0152.\" &\"/8$;\u0153//$8,:\u0199,(+*)'$\"! )(,'#(+'#(*'#()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#=.\" 7\u0198"), o("%;\u00fc/J#;\u0104.\" &\"/<$;\u0227/3$;\u023f/*$8$:\u019a$##\"!)($'#(#'#(\"'#&'#"), o('<%;\u014a." &"/2#;\u014c/)$8":\u019c""! )("\'#&\'#=." 7\u019b'), o('%;\u01c3.) &;\u01ba.# &;\u014b/1#;\u023f/($8":\u019d"!!)("\'#&\'#'), o("%;\u01f7/;#;\u023f/2$;\u0207/)$8#:\u019e#\"\" )(#'#(\"'#&'#"), 
    o('<;\u014d.# &;\u014e=." 7\u019f'), o('%;\u01d9.# &;\u01f6/1#;\u023f/($8":\u01a0"!!)("\'#&\'#'), o('%;\u022a/@#;\u023f/7$;\u014f." &"/)$8#:\u01a1#"" )(#\'#("\'#&\'#'), o("%;\u0207/;#;\u023f/2$;\u0150/)$8#:\u01a2#\"\" )(#'#(\"'#&'#"), o("%;\u00e8/B#;\u023f/9$$;\u00e70#*;\u00e7&/)$8#:\u012e#\"\" )(#'#(\"'#&'#"), o("%;\u01e7/c#;\u023f/Z$;\u01de/Q$;\u023f/H$;\u021c.) &3\u01a3\"\"5)7\u01a4/3$;\u023f/*$8&:\u01a5&#%#!)(&'#(%'#($'#(#'#(\"'#&'#"), o("<%;\u0230/D#;\u023f/;$;o/2$;\u023f/)$8$:\u01a6$\"#!)($'#(#'#(\"'#&'#=.\" 7\u0084"), 
    o("<%;\u01c4/W#;\u023f/N$;\u0154/E$;\u023f/<$;\u01e0/3$;\u023f/*$8&:\u01a8&#%#!)(&'#(%'#($'#(#'#(\"'#&'#=.\" 7\u01a7"), o("%$;\u0155/&#0#*;\u0155&&&#/' 8!:\u01a9!! )"), o("%;\u008c/:#;\u023f/1$;$/($8#:\"#!\")(#'#(\"'#&'#"), o("<%;\u0158/T#;\u0105.\" &\"/F$;\u0157/=$;\u023f/4$;\u0159/+$8%:\u01ab%$$#\" )(%'#($'#(#'#(\"'#&'#=.\" 7\u01aa"), o("%;\u0185/;#;\u023f/2$;\u00e6/)$8#:\u01ac#\"\" )(#'#(\"'#&'#.# &;\u0185"), o("%;\u00fc/J#;\u0104.\" &\"/<$;\u022e/3$;\u023f/*$8$:\u01ad$##\"!)($'#(#'#(\"'#&'#"), 
    o("%;\u01bf/D#;\u023f/;$;\u00a8/2$;\u023f/)$8$:\u012c$\"#!)($'#(#'#(\"'#&'#"), o("<%;\u015b/f#;\u0105.\" &\"/X$;\u017b/O$;\u023f/F$;\u022b/=$;\u023f/4$;\u015c/+$8':\u01af'$&%$ )(''#(&'#(%'#($'#(#'#(\"'#&'#=.\" 7\u01ae"), o("%;\u00fc/N#;\u022f/E$;\u023f/<$;\u0221/3$;\u023f/*$8%:\u01b0%#$#!)(%'#($'#(#'#(\"'#&'#"), o('%;\u0197/@#;\u023f/7$;\u015d." &"/)$8#:\u01b1#"" )(#\'#("\'#&\'#'), o("<%;\u01a0/Z#;\u023f/Q$;\u015e.\" &\"/C$;\u023f/:$;\u01a1/1$;\u023f/($8&:\u01b3&!#)(&'#(%'#($'#(#'#(\"'#&'#=.\" 7\u01b2"), 
    o('%;\u0160/9#$;\u015f0#*;\u015f&/)$8":\u01b4""! )("\'#&\'#'), o("%;\u023f/H#;\u01a2/?$;\u023f/6$;\u0160.\" &\"/($8$:\u01b5$! )($'#(#'#(\"'#&'#"), o("%%<%;\u0195/;#;\u023f/2$;&.# &;\u0111/#$+#)(#'#(\"'#&'#=.##&&!&'#/:#;o/1$;\u023f/($8#:\u0130#!!)(#'#(\"'#&'#.x &%;\u0161/n#%%<;\u0193=.##&&!&'#/,#;\u023f/#$+\")(\"'#&'#/F$;\u010e.\" &\"/8$;\u010f.\" &\"/*$8$:\u014f$##! )($'#(#'#(\"'#&'#"), o(";\u0195.# &;\u0198"), o('<%;\u0163/;#;\u017b/2$;\u023f/)$8#:\u01b7#""!)(#\'#("\'#&\'#=." 7\u01b6'), o("<%;\u01dd/J#;\u023f/A$;\u0164/8$;\u0165.\" &\"/*$8$:\u01b9$##! )($'#(#'#(\"'#&'#=.\" 7\u01b8"), 
    o('<%;\u0221./ &;\u01f2.) &;\u0227.# &;\u022e/1#;\u023f/($8":\u010b"!!)("\'#&\'#=." 7\u01ba'), o("<%;\u01ee/D#;\u023f/;$;\u01e4/2$;\u023f/)$8$:\u01bc$\"#!)($'#(#'#(\"'#&'#=.\" 7\u01bb"), o('<%;\u01ae/,#;\u01ae/#$+")("\'#&\'#=." 7\u01bd'), o('<;\u01aa=." 7\u01be'), o('<;\u01ab=." 7\u01bf'), o('<;\u01a4=." 7\u01c0'), o('<;\u01b5=." 7\u01c1'), o('<;\u01af=." 7\u01c2'), o('<%;\u01b0/,#;\u01b0/#$+")("\'#&\'#=." 7\u01c3'), o('<%;\u01b1/,#;\u01b1/#$+")("\'#&\'#=." 7\u01c4'), o('<;\u01ad=." 7\u01c5'), 
    o('<;\u01ae=." 7\u01c6'), o('<;\u01b0=." 7\u01c7'), o('<;\u01b1=." 7\u01c8'), o('<%;\u01b0/,#;\u01ac/#$+")("\'#&\'#=." 7\u01c9'), o('<%;\u01b1/,#;\u01ac/#$+")("\'#&\'#=." 7\u01ca'), o('<%;\u01ac/1#;\u01ac." &"/#$+")("\'#&\'#=." 7\u01cb'), o('<%;\u01b2/,#;\u01ac/#$+")("\'#&\'#=." 7\u01cc'), o('<%;\u01b0/,#;\u01b1/#$+")("\'#&\'#=." 7\u01cc'), o('<%;\u01fa/@#;\u023f/7$;k." &"/)$8#:\u01ce#"" )(#\'#("\'#&\'#=." 7\u01cd'), o('<;\u0195.# &;\u0198=." 7\u01cf'), o("<%;\u0178/' 8!:\u01d1!! )=.\" 7\u01d0"), 
    o('<%;\u017c." &"/2#;\u0178/)$8":\u01d3""! )("\'#&\'#=." 7\u01d2'), o('<%;\u017c." &"/2#;\u0178/)$8":\u01d5""! )("\'#&\'#=." 7\u01d4'), o('%;\u0178/2#;\u01a3/)$8":\u01d6""! )("\'#&\'#'), o('<%;\u017f.) &;\u0180.# &;\u017e/2#;\u0178/)$8":\u01d8""! )("\'#&\'#=." 7\u01d7'), o("%;\u023f/& 8!:\u01d9! )"), o('%;\u017c/2#;\u0180/)$8":\u01da""! )("\'#&\'#'), o('%;\u0178/2#;\u01a3/)$8":D""! )("\'#&\'#'), o("<%;\u0178/' 8!:\u01dc!! )=.\" 7\u01db"), o("<%;\u0178/' 8!:\u01de!! )=.\" 7\u01dd"), o('<%;\u017c." &"/2#;\u0178/)$8":\u01e0""! )("\'#&\'#=." 7\u01df'), 
    o('<%;\u017c." &"/2#;\u0178/)$8":\u01e2""! )("\'#&\'#=." 7\u01e1'), o('<%;\u017c." &"/2#;\u0178/)$8":\u01e4""! )("\'#&\'#=." 7\u01e3'), o('<%;\u017c." &"/2#;\u0178/)$8":\u01e6""! )("\'#&\'#=." 7\u01e5'), o('<%;\u0188.# &;\u017b/1#;\u023f/($8":\u01e8"!!)("\'#&\'#=." 7\u01e7'), o("%;\u017b/;#;\u023f/2$;\u00e6/)$8#:\u01e9#\"\" )(#'#(\"'#&'#"), o("<%;\u0178/' 8!:\u01eb!! )=.\" 7\u01ea"), o("<%;\u0178/' 8!:\u01ed!! )=.\" 7\u01ec"), o('<%;\u018c/=#%<;\u0193=.##&&!&\'#/($8":\u01ef"!!)("\'#&\'#.\u00c5 &%;\u018d/=#%<;\u0193=.##&&!&\'#/($8":\u01f0"!!)("\'#&\'#.\u009b &%;\u018f/=#%<;\u0193=.##&&!&\'#/($8":\u01f1"!!)("\'#&\'#.q &%;\u0190/=#%<;\u0193=.##&&!&\'#/($8":\u01f2"!!)("\'#&\'#.G &%;\u0192/=#%<;\u0193=.##&&!&\'#/($8":\u01f3"!!)("\'#&\'#=." 7\u01ee'), 
    o('<%%3\u01f5""5!7\u01f6." &"/F#3\u01f7""5#7\u01f8." &"/2$3\u01f9""5$7\u01fa/#$+#)(#\'#("\'#&\'#.k &%3\u01fb""5$7\u01fc.5 &3\u01fd""5&7\u01fe.) &3\u01ff""5$7\u0200." &"/2#3\u0201""5$7\u0202/#$+")("\'#&\'#.) &3\u0203""5$7\u0204/\' 8!:\u010b!! )=." 7\u01f4'), o('<%;\u018e.5 &3\u0206""5%7\u0207.) &3\u0208""5$7\u0209/\' 8!:\u010b!! )=." 7\u0205'), o('<%3\u020b""5&7\u020c/i#%$4(""5!7)/,#0)*4(""5!7)&&&#/2#3\u020d""5)7\u020e/#$+")("\'#&\'#." &"/)$8":\u020f""! )("\'#&\'#=." 7\u020a'), o('<%3\u0211""5\'7\u0212.\u0095 &3\u0213""5\'7\u0214.\u0089 &3\u0215""5\'7\u0216.} &%3\u0217""5$7\u0218/7#3\u0219""5$7\u021a." &"/#$+")("\'#&\'#.S &%3\u0219""5$7\u021a/7#3\u021b""5%7\u021c." &"/#$+")("\'#&\'#.) &3\u021d""5&7\u021e/\' 8!:\u010b!! )=." 7\u0210'), 
    o('<%%3\u0220""5#7\u0221/V#2\u0222""6\u02227\u0223.A &2\u0224""6\u02247\u0225.5 &2\u0226""6\u02267\u0227.) &3\u0228""5$7\u0229/#$+")("\'#&\'#.q &%3\u022a""5#7\u022b.A &3\u01fd""5&7\u01fe.5 &3\u022c""5%7\u022d.) &3\u01fb""5$7\u01fc." &"/2#3\u0220""5#7\u0221/#$+")("\'#&\'#.# &;\u0191/\' 8!:\u010b!! )=." 7\u021f'), o('%3\u022e""5(7\u022f/d#%$4(""5!7)/,#0)*4(""5!7)&&&#/2#3\u0230""5%7\u0231/#$+")("\'#&\'#/)$8":\u0232""! )("\'#&\'#'), o('<%3\u0234""5$7\u0235/\' 8!:\u010b!! )=." 7\u0233'), o('4\u0236""5!7\u0237'), 
    o('%2\u0238""6\u02387\u0239/K#$4\u023a""5!7\u023b/,#0)*4\u023a""5!7\u023b&&&#/)$8":\u023c""! )("\'#&\'#'), o(";\u0196.# &;\u0197"), o(";\u0199./ &;\u019d.) &;\u019b.# &;\u019c"), o("%%<;\u0234.# &;>=.##&&!&'#/J#$;\u0194.# &;\u0193/,#0)*;\u0194.# &;\u0193&&&#/($8\":\u00d6\"! )(\"'#&'#"), o("%%<;\u0236.# &;>=.##&&!&'#/J#$;\u0194.# &;\u0193/,#0)*;\u0194.# &;\u0193&&&#/($8\":\u023d\"! )(\"'#&'#"), o("%;\u019e/\u0099#;\u023f/\u0090$%$%%<;\u019a=.##&&!&'#/1#1\"\"5!7\u023e/#$+\")(\"'#&'#0G*%%<;\u019a=.##&&!&'#/1#1\"\"5!7\u023e/#$+\")(\"'#&'#&/\"!&,)/1$;\u019a/($8$:\u023f$!!)($'#(#'#(\"'#&'#"), 
    o('%$4\u0240""5!7\u02410)*4\u0240""5!7\u0241&/5#;\u019f/,$;\u023f/#$+#)(#\'#("\'#&\'#'), o('%2\u0242""6\u02427\u0243/k#$2\u0244""6\u02447\u0245.) &4\u0246""5!7\u024705*2\u0244""6\u02447\u0245.) &4\u0246""5!7\u0247&/7$2\u0242""6\u02427\u0243/($8#:\u0248#!!)(#\'#("\'#&\'#'), o('%2\u0249""6\u02497\u024a/k#$26""6677.) &48""5!7905*26""6677.) &48""5!79&/7$2\u0249""6\u02497\u024a/($8#:\u024b#!!)(#\'#("\'#&\'#'), o('%2\u024c""6\u024c7\u024d/k#$2\u024e""6\u024e7\u024f.) &4\u0250""5!7\u025105*2\u024e""6\u024e7\u024f.) &4\u0250""5!7\u0251&/7$2\u024c""6\u024c7\u024d/($8#:\u0252#!!)(#\'#("\'#&\'#'), 
    o('<%2\u0254""6\u02547\u0255/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u0253'), o('<%2\u0257""6\u02577\u0258/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u0256'), o('<%2\u025a""6\u025a7\u025b/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u0259'), o('<%2\u025d""6\u025d7\u025e/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u025c'), o('<%2\u0260""6\u02607\u0261/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u025f'), o('<%2\u0263""6\u02637\u0264/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u0262'), o('<%2\u0266""6\u02667\u0267/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u0265'), 
    o('<%2\u0269""6\u02697\u026a/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u0268'), o('<%2\u0249""6\u02497\u024a/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u026b'), o('<%2\u0242""6\u02427\u0243/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u026c'), o('<%2\u024c""6\u024c7\u024d/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u026d'), o('<%2\u026f""6\u026f7\u0270/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u026e'), o('<%2\u0272""6\u02727\u0273/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u0271'), o('<%2\u0275""6\u02757\u0276/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u0274'), 
    o('<%2\u0277""6\u02777\u0278/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u01cb'), o('<%2\u027a""6\u027a7\u027b/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u0279'), o('<%2\u027d""6\u027d7\u027e/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u027c'), o('<%2\u027f""6\u027f7\u0280/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u01c2'), o('<%2\u0281""6\u02817\u0282/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u01c7'), o('<%2\u0283""6\u02837\u0284/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u01c8'), o('<%2\u0286""6\u02867\u0287/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u0285'), 
    o('<%2\u0289""6\u02897\u028a/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u0288'), o('<%2a""6a7b/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u028b'), o('<%2\u028d""6\u028d7\u028e/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u028c'), o('<%2\u0290""6\u02907\u0291/1#;\u023f/($8":""!!)("\'#&\'#=." 7\u028f'), o('%3\u0292""5%7\u0293/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0294""5&7\u0295/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0296""5#7\u0297/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0298""5%7\u0299/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u029a""5#7\u029b/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u029c""5%7\u029d/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u029e\"\"5'7\u029f/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u02a0""5#7\u02a1/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02a2""5"7\u02a3/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02a4""5#7\u02a5/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02a6""5&7\u02a7/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02a8""5-7\u02a9/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u02aa""5&7\u02ab/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02ac""5%7\u02ad/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u02ae\"\"5'7\u02af/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u02b0""5"7\u02b1/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u02b2\"\"5'7\u02b3/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u02b4""5$7\u02b5/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02b6""5$7\u02b7/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02b8""5%7\u02b9/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o("%3\u02ba\"\"5'7\u02bb/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u02bc""5&7\u02bd/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02be""5&7\u02bf/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02c0""5(7\u02c1/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02c2""5*7\u02c3/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02c4""5&7\u02c5/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02c6""5%7\u02c7/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02c8""5,7\u02c9/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u02ca""5,7\u02cb/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02cc""517\u02cd/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02ce""5(7\u02cf/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u02d0\"\"5'7\u02d1/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u02d2""5*7\u02d3/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02d4""5(7\u02d5/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02d6""5&7\u02d7/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02d8""5$7\u02d9/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u02da""5&7\u02db/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02dc""5(7\u02dd/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02de""5$7\u02df/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02e0""5$7\u02e1/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02e2""5$7\u02e3/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02e4""5#7\u02e5/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02e6""5&7\u02e7/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02e8""5&7\u02e9/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u02ea""5)7\u02eb/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02ec""5&7\u02ed/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u02ee\"\"5'7\u02ef/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u02f0""5$7\u02f1/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02f2""5#7\u02f3/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u02f4\"\"5'7\u02f5/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u02f6""5$7\u02f7/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02f8""5$7\u02f9/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u02fa""5$7\u02fb/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02fc""5%7\u02fd/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u02fe""5&7\u02ff/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0300""5"7\u0301/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0302""5&7\u0303/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0304""5)7\u0305/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0306""5"7\u0307/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0308""5%7\u0309/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o("%3\u030a\"\"5'7\u030b/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u030c""5)7\u030d/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u030e""5%7\u030f/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0310""5&7\u0311/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u0312\"\"5'7\u0313/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u0314""5)7\u0315/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0316""5$7\u0317/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0318""5"7\u0319/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u031a""5&7\u031b/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u031c""5$7\u031d/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u031e""5#7\u031f/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0320""5$7\u0321/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0322""5$7\u0323/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0324""5%7\u0325/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0326""5%7\u0327/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u0328\"\"5'7\u0329/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), 
    o('%3\u032a""5"7\u032b/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u032c""5#7\u032d/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u032e\"\"5'7\u032f/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3y""5$7z/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0330""5"7\u0331/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0332""5&7\u0333/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0334""5"7\u0335/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0336""5"7\u0337/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u0338""5%7\u0339/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u033a""5%7\u033b/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u033c""5$7\u033d/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u033e""5&7\u033f/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u0340\"\"5'7\u0341/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u0342""5%7\u0343/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0344""5%7\u0345/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0346""5)7\u0347/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u0348""5*7\u0349/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u034a""5&7\u034b/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u034c\"\"5'7\u034d/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o("%3\u034e\"\"5'7\u034f/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u0350""5&7\u0351/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u0352\"\"5'7\u0353/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u0354""5(7\u0355/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0356""5%7\u0357/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u0358""5(7\u0359/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u035a""5#7\u035b/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u035c""5%7\u035d/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u035e""5)7\u035f/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0360""5&7\u0361/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0362""5#7\u0363/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0364""5%7\u0365/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0366""5$7\u0367/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u0368""5)7\u0369/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u036a""5$7\u036b/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u036c""5"7\u036d/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u036e""5+7\u036f/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u0370\"\"5'7\u0371/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u0372""5%7\u0373/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0374""5&7\u0375/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0376""5&7\u0377/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o('%3\u0378""5%7\u0379/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u037a""5&7\u037b/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u037c""5&7\u037d/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u037e""5$7\u037f/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o("%3\u0380\"\"5'7\u0381/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o('%3\u0382""5$7\u0383/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0384""5%7\u0385/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), o('%3\u0386""5$7\u0387/8#%<;\u0193=.##&&!&\'#/#$+")("\'#&\'#'), 
    o("%3\u0388\"\"5'7\u0389/8#%<;\u0193=.##&&!&'#/#$+\")(\"'#&'#"), o("%;\u0235/' 8!:\u038a!! )"), o(";\u01b7.\u02f9 &;\u01b8.\u02f3 &;\u01b9.\u02ed &;\u01ba.\u02e7 &;\u01bb.\u02e1 &;\u01bc.\u02db &;\u01bd.\u02d5 &;\u01be.\u02cf &;\u01bf.\u02c9 &;\u01c0.\u02c3 &;\u01c1.\u02bd &;\u01c2.\u02b7 &;\u01c3.\u02b1 &;\u01c4.\u02ab &;\u01c5.\u02a5 &;\u01c6.\u029f &;\u01c7.\u0299 &;\u01c8.\u0293 &;\u01c9.\u028d &;\u01ca.\u0287 &;\u01cb.\u0281 &;\u01cc.\u027b &;\u01cd.\u0275 &;\u01ce.\u026f &;\u01cf.\u0269 &;\u01d0.\u0263 &;\u01d1.\u025d &;\u01d2.\u0257 &;\u01d3.\u0251 &;\u01d4.\u024b &;\u01d5.\u0245 &;\u01d6.\u023f &;\u01d7.\u0239 &;\u01d8.\u0233 &;\u01d9.\u022d &;\u01da.\u0227 &;\u01db.\u0221 &;\u01dc.\u021b &;\u01dd.\u0215 &;\u01de.\u020f &;\u01df.\u0209 &;\u01e0.\u0203 &;\u01e1.\u01fd &;\u01e2.\u01f7 &;\u01e3.\u01f1 &;\u01e4.\u01eb &;\u01e5.\u01e5 &;\u01e6.\u01df &;\u01e7.\u01d9 &;\u01e8.\u01d3 &;\u01e9.\u01cd &;\u01ea.\u01c7 &;\u01eb.\u01c1 &;\u01ec.\u01bb &;\u01ed.\u01b5 &;\u01ee.\u01af &;\u01ef.\u01a9 &;\u01f0.\u01a3 &;\u01f1.\u019d &;\u01f2.\u0197 &;\u01f3.\u0191 &;\u01f4.\u018b &;\u01f5.\u0185 &;\u01f6.\u017f &;\u01f7.\u0179 &;\u01f8.\u0173 &;\u01f9.\u016d &;\u01fa.\u0167 &;\u01fb.\u0161 &;\u01fc.\u015b &;\u01fd.\u0155 &;\u01fe.\u014f &;\u01ff.\u0149 &;\u0200.\u0143 &;\u0201.\u013d &;\u0202.\u0137 &;\u0203.\u0131 &;\u0204.\u012b &;\u0205.\u0125 &;\u0206.\u011f &;\u0207.\u0119 &;\u0208.\u0113 &;\u0209.\u010d &;\u020a.\u0107 &;\u020b.\u0101 &;\u020c.\u00fb &;\u020d.\u00f5 &;\u020e.\u00ef &;\u020f.\u00e9 &;\u0210.\u00e3 &;\u0211.\u00dd &;\u0212.\u00d7 &;\u0213.\u00d1 &;\u0214.\u00cb &;\u0215.\u00c5 &;\u0216.\u00bf &;\u0217.\u00b9 &;\u0218.\u00b3 &;\u0219.\u00ad &;\u021a.\u00a7 &;\u021b.\u00a1 &;\u021c.\u009b &;\u021e.\u0095 &;\u021f.\u008f &;\u0220.\u0089 &;\u0221.\u0083 &;\u0223.} &;\u0224.w &;\u0225.q &;\u0226.k &;\u0227.e &;\u0228._ &;\u0229.Y &;\u022a.S &;\u022b.M &;\u022c.G &;\u022d.A &;\u022e.; &;\u022f.5 &;\u0230./ &;\u0231.) &;\u0232.# &;\u0233"), 
    o(";\u01b9.\u0167 &;\u01bb.\u0161 &;\u01bc.\u015b &;\u01be.\u0155 &;\u01bf.\u014f &;\u01c2.\u0149 &;\u01c5.\u0143 &;\u01c8.\u013d &;\u01ca.\u0137 &;\u01cb.\u0131 &;\u01cd.\u012b &;\u01cf.\u0125 &;\u01d0.\u011f &;\u01d6.\u0119 &;\u01d7.\u0113 &;\u01d9.\u010d &;\u01dc.\u0107 &;\u01dd.\u0101 &;\u01df.\u00fb &;\u01e1.\u00f5 &;\u01e2.\u00ef &;\u01e4.\u00e9 &;\u01e8.\u00e3 &;\u01e9.\u00dd &;\u01ec.\u00d7 &;\u01ed.\u00d1 &;\u01f1.\u00cb &;\u01f2.\u00c5 &;\u01f6.\u00bf &;\u01f8.\u00b9 &;\u01f9.\u00b3 &;\u01fa.\u00ad &;\u01fb.\u00a7 &;\u01fc.\u00a1 &;\u0200.\u009b &;\u0204.\u0095 &;\u0205.\u008f &;\u0206.\u0089 &;\u0209.\u0083 &;\u020a.} &;\u020b.w &;\u020f.q &;\u0213.k &;\u021f.e &;\u0220._ &;\u0221.Y &;\u0224.S &;\u0225.M &;\u0226.G &;\u0228.A &;\u0229.; &;\u022a.5 &;\u022b./ &;\u022d.) &;\u0230.# &;\u0231"), 
    o(";\u0238.. &%;\u0239/& 8!:\u038b! )"), o('<%2\u038d""6\u038d7\u038e/\u0087#$%%<4\u038f""5!7\u0390=.##&&!&\'#/1#1""5!7\u023e/#$+")("\'#&\'#0M*%%<4\u038f""5!7\u0390=.##&&!&\'#/1#1""5!7\u023e/#$+")("\'#&\'#&/#$+")("\'#&\'#=." 7\u038c'), o("<%;\u023a/5#;\u023e/,$;\u023b/#$+#)(#'#(\"'#&'#=.\" 7\u0391"), o('2\u0392""6\u03927\u0393'), o('2\u0394""6\u03947\u0395'), o('$%%<;\u023b.# &;\u023a=.##&&!&\'#/1#1""5!7\u023e/#$+")("\'#&\'#/P#0M*%%<;\u023b.# &;\u023a=.##&&!&\'#/1#1""5!7\u023e/#$+")("\'#&\'#&&&#'), 
    o(";\u023c.# &;\u0239"), o('%;\u023d/K#$4\u0396""5!7\u0397.# &;\u023d0/*4\u0396""5!7\u0397.# &;\u023d&/#$+")("\'#&\'#'), o('<%$4\u0396""5!7\u0397.# &;\u02370/*4\u0396""5!7\u0397.# &;\u0237&/\' 8!:-!! )=." 7\u0398'), o('2\u0399""6\u03997\u039a')], I = 0, J = 0, K = [{line:1, column:1}], L = 0, M = [], N = 0, O = {}, P = ["start", "start_streaming", "stmt_list", "semi_optional", "semi_required", "stmt_list_tail", "type_definition", "type_definition_types", "datatype_custom", "datatype_word_tail", 
    "type_definition_args", "definition_args_loop", "literal_value", "literal_null", "literal_date", "literal_string", "literal_string_single", "literal_string_schar", "literal_blob", "literal_text", "number_sign", "literal_number_signed", "literal_number", "literal_number_decimal", "number_decimal_node", "number_decimal_full", "number_decimal_fraction", "number_decimal_exponent", "literal_number_hex", "number_hex", "number_digit", "bind_parameter", "bind_parameter_numbered", "bind_number_id", "bind_parameter_named", 
    "bind_parameter_tcl", "tcl_suffix", "expression_exists", "expression_exists_ne", "expression_raise", "expression_raise_args", "raise_args_ignore", "raise_args_message", "expression_root", "expression_wrapped", "expression_recur", "expression_unary_collate", "expression_unary", "expression_unary_op", "expression_collate", "expression_concat", "expression_multiply", "expression_multiply_op", "expression_add", "expression_add_op", "expression_shift", "expression_shift_op", "expression_compare", 
    ...
    null, null, null, null, null, null, null, null, null, null, null, null, "Line Comment", "Block Comment", null, null, null, null, null, "Whitespace", null], R = "tracer" in b ? b.tracer : new f();
    if ("startRule" in b) {
      if (!(b.startRule in E)) {
  ...
  }, b.exports = {SyntaxError:e, DefaultTracer:f, parse:g};
}, {}], 2:[function(a, b, c) {
  function d(a, b) {
  ...
  c.Tracer = function() {
    function a() {
      return this instanceof a ? (this.events = [], this.indentation = 0, this.whitespaceRule = /(^whitespace)|(char$)|(^[oe]$)|(^sym_)/i, this.statementRule = /Statement$/i, void(this.firstNodeRule = /(Statement|Clause)$/i)) : new a();
    }
    return a.prototype.trace = function(a) {
      ...
      var b, c, d, f, g, h = this, i = {indentation:-1}, j = !1, k = 0, l = this.events.filter(function(a) {
        return null != a.description && !h.whitespaceRule.test(a.rule);
      }).reverse();
      return d = e(l, function(a) {
        if (/^(sym_semi)$/i.test(a.rule) && (k += 1), k > 1) {
          return !1;
        }
        if (j) {
          if (/^(stmt)$/i.test(a.rule)) {
            return j = !0, !0;
          }
        } else {
          a.indentation > i.indentation ? i = a : j = !0;
        }
        return !0;
      ...
      }), f = null != g ? this.statementRule.test(i.description) && this.statementRule.test(g.description) ? g.description : i.description + " (" + g.description + ")" : i.description, b = "Syntax error found near " + f, Object.assign(a, {message:b, location:c})), a;
    }, a;
  }();
}, {}], 3:[function(a, b, c) {
  function d(a, b, c) {
  ...
  function j(a) {
    window.localStorage && window.localStorage.setItem("sqlite-parser-demo", JSON.stringify({sql:a}));
  }
  function k(a) {
  ...
  function l(a) {
    return a.execCommand("selectAll"), a.execCommand("indentAuto"), a.setCursor({line:0, ch:0}), a;
  }
  var m = a("codemirror"), sqliteParser = a("sqlite-parser");
  a("foldgutter"), a("brace-fold"), a("panel"), a("mode-javascript"), a("mode-sql");
  const n = document.getElementById("ast"), o = document.getElementById("ast-header"), p = document.getElementById("sql-text"), q = document.getElementById("ast-text");
/*  
  document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("container").className = "";
    var a = {lineNumbers:!0, theme:"monokai", lineWrapping:!0, tabSize:4, gutters:["CodeMirror-linenumbers", "CodeMirror-foldgutter"]}, b = m.fromTextArea(p, Object.assign({mode:"text/x-plsql"}, a)), c = m.fromTextArea(q, Object.assign({mode:"application/ld+json", foldGutter:!0, readOnly:!0}, a)), e = d(i(b, c), 250);
...
*/  
...
}, {"brace-fold":"brace-fold", codemirror:"codemirror", foldgutter:"foldgutter", "mode-javascript":"mode-javascript", "mode-sql":"mode-sql", panel:"panel", "sqlite-parser":"sqlite-parser"}], "brace-fold":[function(a, b, c) {
  !function(d) {
    ...
    a.registerHelper("fold", "brace", function(b, c) {
      function d(d) {
        for (var h = c.ch, i = 0;;) {
          ...
          if (j != -1) {
            ...
            if (e = b.getTokenTypeAt(a.Pos(f, j + 1)), !/^(comment|string)/.test(e)) {
              return j + 1;
            }
            h = j - 1;
          } else {
      ...
      var e, f = c.line, g = b.getLine(f), h = "{", i = "}", j = d("{");
      if (null == j && (h = "[", i = "]", j = d("[")), null != j) {
        var k, l, m = 1, n = b.lastLine();
        a: for (var o = f; o <= n; ++o) {
          for (var p = b.getLine(o), q = o == f ? j : 0;;) {
            var r = p.indexOf(h, q), s = p.indexOf(i, q);
            if (r < 0 && (r = p.length), s < 0 && (s = p.length), q = Math.min(r, s), q == p.length) {
              break;
            }
        ...
        if (null != k && (f != k || l != j)) {
          return {from:a.Pos(f, j), to:a.Pos(k, l)};
        }
      }
    }), a.registerHelper("fold", "import", function(b, c) {
      function d(c) {
        if (c < b.firstLine() || c > b.lastLine()) {
          return null;
        }
        var d = b.getTokenAt(a.Pos(c, 1));
        if (/\S/.test(d.string) || (d = b.getTokenAt(a.Pos(c, d.end + 1))), "keyword" != d.type || "import" != d.string) {
          return null;
        }
        for (var e = c, f = Math.min(b.lastLine(), c + 10); e <= f; ++e) {
          var g = b.getLine(e), h = g.indexOf(";");
          if (h != -1) {
            return {startCh:d.end, end:a.Pos(e, h)};
          }
        }
      }
      var e, f = c.line, g = d(f);
      if (!g || d(f - 1) || (e = d(f - 2)) && e.end.line == f - 1) {
        return null;
      }
      for (var h = g.end;;) {
        var i = d(h.line + 1);
      ...
      return {from:b.clipPos(a.Pos(f, g.startCh + 1)), to:h};
      ...
      return {from:a.Pos(e, f + 1), to:b.clipPos(a.Pos(g))};
    });
  });
}, {"../../lib/codemirror":"codemirror"}], codemirror:[function(a, b, c) {
  !function(a) {
    if ("object" == typeof c && "object" == typeof b) {
      b.exports = a();
    } else {
    ...
    function a(c, d) {
      ...
      g.wrapper.CodeMirror = this, j(this), h(this), d.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), d.autofocus && !Ef && g.input.focus(), r(this), this.state = {keyMaps:[], overlays:[], modeGen:0, overwrite:!1, delayingBlurEvent:!1, focused:!1, suppressEdits:!1, pasteIncoming:!1, cutIncoming:!1, selectingText:!1, draggingText:!1, highlight:new Ee(), keySeq:null, specialChars:null};
      var i = this;
      ...
      for (var k in cg) {
        cg.hasOwnProperty(k) && cg[k](this, d[k], dg);
      }
    ...
    function b(a, b, c) {
      var d = this;
      this.input = c, d.scrollbarFiller = Re("div", null, "CodeMirror-scrollbar-filler"), d.scrollbarFiller.setAttribute("cm-not-content", "true"), d.gutterFiller = Re("div", null, "CodeMirror-gutter-filler"), d.gutterFiller.setAttribute("cm-not-content", "true"), d.lineDiv = Re("div", null, "CodeMirror-code"), d.selectionDiv = Re("div", null, null, "position: relative; z-index: 1"), d.cursorDiv = Re("div", null, "CodeMirror-cursors"), d.measure = Re("div", null, "CodeMirror-measure"), d.lineMeasure = 
      Re("div", null, "CodeMirror-measure"), d.lineSpace = Re("div", [d.measure, d.lineMeasure, d.selectionDiv, d.cursorDiv, d.lineDiv], null, "position: relative; outline: none"), d.mover = Re("div", [Re("div", [d.lineSpace], "CodeMirror-lines")], null, "position: relative"), d.sizer = Re("div", [d.mover], "CodeMirror-sizer"), d.sizerWidth = null, d.heightForcer = Re("div", null, null, "position: absolute; height: " + Kg + "px; width: 1px;"), d.gutters = Re("div", null, "CodeMirror-gutters"), d.lineGutter = 
      null, d.scroller = Re("div", [d.sizer, d.heightForcer, d.gutters], "CodeMirror-scroll"), d.scroller.setAttribute("tabIndex", "-1"), d.wrapper = Re("div", [d.scrollbarFiller, d.gutterFiller, d.scroller], "CodeMirror"), uf && vf < 8 && (d.gutters.style.zIndex = -1, d.scroller.style.paddingRight = 0), wf || rf && Ef || (d.scroller.draggable = !0), a && (a.appendChild ? a.appendChild(d.wrapper) : a(d.wrapper)), d.viewFrom = d.viewTo = b.first, d.reportedViewFrom = d.reportedViewTo = b.first, d.view = 
      [], d.renderedView = null, d.externalMeasured = null, d.viewOffset = 0, d.lastWrapHeight = d.lastWrapWidth = 0, d.updateLineNumbers = null, d.nativeBarWidth = d.barHeight = d.barWidth = 0, d.scrollbarsClipped = !1, d.lineNumWidth = d.lineNumInnerWidth = d.lineNumChars = null, d.alignWidgets = !1, d.cachedCharWidth = d.cachedTextHeight = d.cachedPaddingH = null, d.maxLine = null, d.maxLineLength = 0, d.maxLineChanged = !1, d.wheelDX = d.wheelDY = d.wheelStartX = d.wheelStartY = null, d.shift = 
      !1, d.selForContextMenu = null, d.activeTouch = null, c.init(d);
    }
    function c(b) {
    ...
    function f(a) {
      var b = tb(a.display), c = a.options.lineWrapping, d = c && Math.max(5, a.display.scroller.clientWidth / ub(a.display) - 3);
      return function(e) {
        if (wd(a.doc, e)) {
          return 0;
        }
    ...
    function j(a) {
      ...
      for (var d = 0; d < c.length; ++d) {
        var e = c[d], f = b.appendChild(Re("div", null, "CodeMirror-gutter " + e));
    ...
    function o(a) {
      var b = a.display, c = b.gutters.offsetWidth, d = Math.round(a.doc.height + Sa(a.display));
    ...
    function p(a, b, c) {
      this.cm = c;
      var d = this.vert = Re("div", [Re("div", null, null, "min-width: 1px")], "CodeMirror-vscrollbar"), e = this.horiz = Re("div", [Re("div", null, null, "height: 100%; min-height: 1px")], "CodeMirror-hscrollbar");
    ...
    function t(a, b) {
      ...
      "block", c.gutterFiller.style.height = d.bottom + "px", c.gutterFiller.style.width = b.gutterWidth + "px") : c.gutterFiller.style.display = "";
    }
    function u(a, b, c) {
      var d = c && null != c.top ? Math.max(0, c.top) : a.scroller.scrollTop;
      d = Math.floor(d - Ra(a));
      var e = c && null != c.bottom ? c.bottom : d + a.wrapper.clientHeight, f = ce(b, d), g = ce(b, e);
      if (c && c.ensure) {
    ...
    function w(a) {
      ...
      if (c.length != d.lineNumChars) {
        var e = d.measure.appendChild(Re("div", [Re("div", c)], "CodeMirror-linenumber CodeMirror-gutter-elt")), f = e.firstChild.offsetWidth, g = e.offsetWidth - f;
    ...
    function B(a, b) {
      ...
      if (!b.force && b.visible.from >= c.viewFrom && b.visible.to <= c.viewTo && (null == c.updateLineNumbers || c.updateLineNumbers >= c.viewTo) && c.renderedView == c.view && 0 == Qb(a)) {
        return !1;
      }
      w(a) && (Mb(a), b.dims = H(a));
    ...
    function C(a, b) {
      for (var c = b.viewport, d = !0; (d && a.options.lineWrapping && b.oldDisplayWidth != Va(a) || (c && null != c.top && (c = {top:Math.min(a.doc.height + Sa(a.display) - Wa(a), c.top)}), b.visible = u(a.display, a.doc, c), !(b.visible.from >= a.display.viewFrom && b.visible.to <= a.display.viewTo))) && B(a, b); d = !1) {
        F(a);
        var e = o(a);
        Ia(a), s(a, e), E(a, e);
      }
    ...
    function P(a, b, c, d) {
      ...
      if (a.options.lineNumbers || f) {
        var e = K(b), g = b.gutter = Re("div", null, "CodeMirror-gutter-wrapper", "left: " + (a.options.fixedGutter ? d.fixedPos : -d.gutterTotalWidth) + "px");
    ...
    function T(a, b, c, d, e) {
      if (b.widgets) {
        for (var f = K(c), g = 0, h = b.widgets; g < h.length; ++g) {
          var i = h[g], j = Re("div", [i.node], "CodeMirror-linewidget");
      ...
      if (g && d.ranges.length > 1) {
        if (Pf && Pf.text.join("\n") == b) {
          if (d.ranges.length % Pf.text.length == 0) {
            i = [];
            for (var j = 0; j < Pf.text.length; j++) {
              i.push(f.splitLines(Pf.text[j]));
            }
          }
        } else {
          h.length == d.ranges.length && (i = Ie(h, function(a) {
            return [a];
          }));
        }
      }
    ...
    function $(a, b) {
      ...
      if (c) {
        return a.preventDefault(), b.isReadOnly() || b.options.disableInput || Eb(b, function() {
          Z(b, c, 0, null, "paste");
        }), !0;
      }
    }
        ...
        for (var c = a.doc.sel, d = c.ranges.length - 1; d >= 0; d--) {
          ...
          if (!(e.head.ch > 100 || d && c.ranges[d - 1].head.line == e.head.line)) {
            ...
            if (f.electricChars) {
              ...
              f.electricInput && f.electricInput.test(Zd(a.doc, e.head.line).text.slice(0, e.head.ch)) && (g = Oc(a, e.head.line, "smart"));
            }
    ...
    function aa(a) {
      for (var b = [], c = [], d = 0; d < a.doc.sel.ranges.length; d++) {
        var e = a.doc.sel.ranges[d].head.line, f = {anchor:Nf(e, 0), head:Nf(e + 1, 0)};
    ...
    function da() {
      var a = Re("textarea", null, null, "position: absolute; bottom: -1em; padding: 0; width: 1px; height: 1em; outline: none"), b = Re("div", [a], null, "overflow: hidden; position: relative; width: 3px; height: 0px;");
    ...
    function fa(a, b) {
      ...
      var d = Zd(a.doc, b.line), e = Ya(c, d, b.line), f = ee(d), g = "left";
      if (f) {
        var h = lf(f, b.ch);
        g = h % 2 ? "right" : "left";
      }
    ...
    function ha(a, b, c) {
      ...
      if (b == a.display.lineDiv) {
        if (d = a.display.lineDiv.childNodes[c], !d) {
          return ga(a.clipPos(Nf(a.display.viewTo - 1)), !0);
        }
        b = null, c = 0;
      } else {
      ...
      function d(b, c, d) {
        for (var e = -1; e < (k ? k.length : 0); e++) {
          for (var f = e < 0 ? j.map : k[e], g = 0; g < f.length; g += 3) {
            var h = f[g + 2];
            if (h == b || h == c) {
              var i = be(e < 0 ? a.line : a.rest[e]), l = f[g] + d;
    ...
    function ja(a, b, c, d, e) {
      ...
      for (var h = "", i = !1, j = a.doc.lineSeparator(); g(b), b != c;) {
        b = b.nextSibling;
      }
      return h;
    }
    ...
    function Ea(a, b, c, d) {
      for (var e, f = 0; f < b.ranges.length; f++) {
        var g = b.ranges[f], h = b.ranges.length == a.sel.ranges.length && a.sel.ranges[f], i = Ga(a, g.anchor, h && h.anchor, c, d), j = Ga(a, g.head, h && h.head, c, d);
        ...
        for (var g = 0; g < f.markedSpans.length; ++g) {
          ...
          if ((null == h.from || (i.inclusiveLeft ? h.from <= b.ch : h.from < b.ch)) && (null == h.to || (i.inclusiveRight ? h.to >= b.ch : h.to > b.ch))) {
            ...
            if (c) {
              ...
              if ((d < 0 ? i.inclusiveRight : i.inclusiveLeft) && (k = Ha(a, k, -d, k && k.line == b.line ? f : null)), k && k.line == b.line && (j = Of(k, c)) && (d < 0 ? j < 0 : j > 0)) {
                return Fa(a, k, b, d, e);
              }
            }
    ...
    function Ga(a, b, c, d, e) {
      var f = d || 1, g = Fa(a, b, c, f, e) || !e && Fa(a, b, c, f, !0) || Fa(a, b, c, -f, e) || !e && Fa(a, b, c, -f, !0);
    ...
    function Ka(a, b, c) {
      var d = ob(a, b, "div", null, null, !a.options.singleCursorHeightPerLine), e = c.appendChild(Re("div", "\u00a0", "CodeMirror-cursor"));
    ...
    function La(a, b, c) {
      ...
      function e(b, c, e) {
        ...
        var h, i, l = Zd(g, b), m = l.text.length;
      ...
      var f = a.display, g = a.doc, h = document.createDocumentFragment(), i = Ta(a.display), j = i.left, k = Math.max(f.sizerWidth, Va(a) - f.sizer.offsetLeft) - i.right, l = b.from(), m = b.to();
      if (l.line == m.line) {
        e(l.line, l.ch, m.ch);
      } else {
        var n = Zd(g, l.line), o = Zd(g, m.line), p = sd(n) == sd(o), q = e(l.line, l.ch, p ? n.text.length + 1 : null).end, r = e(m.line, p ? 0 : null, m.ch).start;
    ...
    function Oa(a) {
      ...
      if (b.frontier < b.first && (b.frontier = b.first), !(b.frontier >= a.display.viewTo)) {
        var c = +new Date() + a.options.workTime, d = jg(b.mode, Qa(a, b.frontier)), e = [];
        b.iter(b.frontier, Math.min(b.first + b.size, a.display.viewTo + 500), function(f) {
          if (b.frontier >= a.display.viewFrom) {
            var g = f.styles, h = f.text.length > a.options.maxHighlightLength, i = Id(a, f, h ? jg(b.mode, d) : d, !0);
            f.styles = i.styles;
            ...
            f.text.length <= a.options.maxHighlightLength && Kd(a, f.text, d), f.stateAfter = b.frontier % 5 == 0 ? jg(b.mode, d) : null;
          }
          if (++b.frontier, +new Date() > c) {
            return Na(a, a.options.workDelay), !0;
          }
    ...
    function Qa(a, b, c) {
      ...
      var f = Pa(a, b, c), g = f > d.first && Zd(d, f - 1).stateAfter;
    ...
    function Ta(a) {
      ...
      var b = Te(a.measure, Re("pre", "x")), c = window.getComputedStyle ? window.getComputedStyle(b) : b.currentStyle, d = {left:parseInt(c.paddingLeft), right:parseInt(c.paddingRight)};
    ...
    function Xa(a, b, c) {
      var d = a.options.lineWrapping, e = d && Va(a);
    ...
    function Za(a, b) {
      b = sd(b);
      var c = be(b), d = a.display.externalMeasured = new Ib(a.doc, b, c);
      d.lineN = c;
    ...
    function bb(a, b, c, d, e) {
      b.before && (c = -1);
      var f, g = c + (d || "");
      return b.cache.hasOwnProperty(g) ? f = b.cache[g] : (b.rect || (b.rect = b.view.text.getBoundingClientRect()), b.hasHeights || (Xa(a, b.view, b.rect), b.hasHeights = !0), f = eb(a, b, c, d), f.bogus || (b.cache[g] = f)), {left:f.left, right:f.right, top:e ? f.rtop : f.top, bottom:e ? f.rbottom : f.bottom};
    }
    function cb(a, b, c) {
    ...
    function eb(a, b, c, d) {
      var e, f = cb(b.map, c, d), g = f.node, h = f.start, i = f.end, j = f.collapse;
      if (3 == g.nodeType) {
        for (var k = 0; k < 4; k++) {
          for (; h && Qe(b.line.text.charAt(f.coverStart + h));) {
            --h;
          }
          for (; f.coverStart + i < f.coverEnd && Qe(b.line.text.charAt(f.coverStart + i));) {
            ++i;
          }
          if (e = uf && vf < 9 && 0 == h && i == f.coverEnd - f.coverStart ? g.parentNode.getBoundingClientRect() : db(Tg(g, h, i).getClientRects(), d), e.left || e.right || 0 == h) {
            break;
          }
          i = h, h -= 1, j = "right";
        }
      ...
      if (uf && vf < 9 && !h && (!e || !e.left && !e.right)) {
        ...
        e = m ? {left:m.left, right:m.left + ub(a.display), top:m.top, bottom:m.bottom} : Tf;
      }
      for (var n = e.top - b.rect.top, o = e.bottom - b.rect.top, p = (n + o) / 2, q = b.view.measure.heights, k = 0; k < q.length - 1 && !(p < q[k]); k++) {
      }
      var r = k ? q[k - 1] : 0, s = q[k], t = {left:("right" == j ? e.right : e.left) - b.rect.left, right:("left" == j ? e.left : e.right) - b.rect.left, top:r, bottom:s};
      return e.left || e.right || (t.bogus = !0), a.options.singleCursorHeightPerLine || (t.rtop = n, t.rbottom = o), t;
    }
    function fb(a, b) {
      if (!window.screen || null == screen.logicalXDPI || screen.logicalXDPI == screen.deviceXDPI || !af(a)) {
        return b;
      }
    ...
    function rb(a, b, c) {
      ...
      var e = ce(d, c), f = d.first + d.size - 1;
      if (e > f) {
        return qb(d.first + d.size - 1, Zd(d, f).text.length, !0, 1);
      }
      b < 0 && (b = 0);
      for (var g = Zd(d, e);;) {
        var h = sb(a, g, e, b, c), i = qd(g), j = i && i.find(0, !0);
    ...
    function sb(a, b, c, d, e) {
      ...
      var g = e - de(b), h = !1, i = 2 * a.display.wrapper.clientWidth, j = ab(a, b), k = ee(b), l = b.text.length, m = ef(b), n = ff(b), o = f(m), p = h, q = f(n), r = h;
      if (d > q) {
        return qb(c, n, r, 1);
      }
      for (;;) {
        if (k ? n == m || n == nf(b, m, 1) : n - m <= 1) {
          ...
          for (; Qe(b.text.charAt(s));) {
            ++s;
          }
          var w = qb(c, s, t, u < -1 ? -1 : u > 1 ? 1 : 0);
          return w;
        }
        var x = Math.ceil(l / 2), y = m + x;
        if (k) {
          y = m;
          for (var z = 0; z < x; ++z) {
            y = nf(b, y, 1);
    ...
    function tb(a) {
      ...
      if (null == Qf) {
        Qf = Re("pre");
        for (var b = 0; b < 49; ++b) {
          Qf.appendChild(document.createTextNode("x")), Qf.appendChild(Re("br"));
        }
    ...
    function ub(a) {
      ...
      var b = Re("span", "xxxxxxxxxx"), c = Re("pre", [b]);
      Te(a.measure, c);
    ...
    function Db(a) {
      ...
      if (a.updatedDisplay && C(b, a.update), null == c.wheelStartX || null == a.scrollTop && null == a.scrollLeft && !a.scrollToPos || (c.wheelStartX = c.wheelStartY = null), null == a.scrollTop || c.scroller.scrollTop == a.scrollTop && !a.forceScroll || (d.scrollTop = Math.max(0, Math.min(c.scroller.scrollHeight - c.scroller.clientHeight, a.scrollTop)), c.scrollbars.setScrollTop(d.scrollTop), c.scroller.scrollTop = d.scrollTop), null == a.scrollLeft || c.scroller.scrollLeft == a.scrollLeft && !a.forceScroll || 
      (d.scrollLeft = Math.max(0, Math.min(c.scroller.scrollWidth - c.scroller.clientWidth, a.scrollLeft)), c.scrollbars.setScrollLeft(d.scrollLeft), c.scroller.scrollLeft = d.scrollLeft, v(b)), a.scrollToPos) {
    ...
    function Kb(a, b, c, d) {
      ...
      if (d && c < e.viewTo && (null == e.updateLineNumbers || e.updateLineNumbers > b) && (e.updateLineNumbers = b), a.curOp.viewChanged = !0, b >= e.viewTo) {
        Mf && ud(a.doc, b) < e.viewTo && Mb(a);
      } else if (c <= e.viewFrom) {
        Mf && vd(a.doc, c + d) > e.viewFrom ? Mb(a) : (e.viewFrom += d, e.viewTo += d);
        ...
        var g = Ob(a, b, b, -1), h = Ob(a, c, c + d, 1);
    ...
    function Ob(a, b, c, d) {
      var e, f = Nb(a, b), g = a.display.view;
      if (!Mf || c == a.doc.first + a.doc.size) {
    ...
    function Rb(a) {
      ...
      Fg(e.scroller, "touchstart", function(b) {
        if (!Ae(a, b) && !c(b)) {
          clearTimeout(f);
          var d = +new Date();
          e.activeTouch = {start:d, moved:!1, prev:d - g.end <= 300 ? g : null}, 1 == b.touches.length && (e.activeTouch.left = b.touches[0].pageX, e.activeTouch.top = b.touches[0].pageY);
        }
      ...
      }), e.dragFunctions = {enter:function(b) {
        Ae(a, b) || Eg(b);
      }, over:function(b) {
        Ae(a, b) || (cc(a, b), Eg(b));
      }, start:function(b) {
        bc(a, b);
      }, drop:Fb(a, ac), leave:function(b) {
        Ae(a, b) || dc(a);
      }};
    ...
    function Sb(b, c, d) {
      var e = d && d != a.Init;
      if (!c != !e) {
        var f = b.display.dragFunctions, g = c ? Fg : Hg;
    ...
    function Vb(a, b, c, d) {
      var e = a.display;
      if (!c && "true" == ve(b).getAttribute("cm-not-content")) {
        return null;
      }
    ...
    function Wb(a) {
      ...
      if (!(Ae(b, a) || c.activeTouch && c.input.supportsTouch())) {
        if (c.shift = a.shiftKey, Ub(c, a)) {
          return void(wf || (c.scroller.draggable = !1, setTimeout(function() {
    ...
    function Xb(a, b, c) {
      ...
      var d, e = +new Date();
      Sf && Sf.time > e - 400 && 0 == Of(Sf.pos, c) ? d = "triple" : Rf && Rf.time > e - 400 && 0 == Of(Rf.pos, c) ? (d = "double", Sf = {time:e, pos:c}) : (d = "single", Rf = {time:e, pos:c});
      var f, g = a.doc.sel, h = Ff ? b.metaKey : b.ctrlKey;
    ...
    function Yb(a, b, c, d) {
      var e = a.display, f = +new Date(), g = Fb(a, function(h) {
    ...
    function Zb(a, b, c, d, e) {
        ...
        if (0 != Of(q, b)) {
          if (q = b, "rect" == d) {
            for (var e = [], f = a.options.tabSize, g = Pg(Zd(j, c.line).text, c.ch, f), h = Pg(Zd(j, b.line).text, b.ch, f), i = Math.min(g, h), n = Math.max(g, h), o = Math.min(c.line, b.line), p = Math.min(a.lastLine(), Math.max(c.line, b.line)); o <= p; o++) {
              var r = Zd(j, o).text, s = Qg(r, i, f);
              i == n ? e.push(new la(Nf(o, s), Nf(o, s))) : r.length > s && e.push(new la(Nf(o, s), Nf(o, Qg(r, n, f))));
            }
            e.length || e.push(new la(c, c)), Aa(j, ma(m.ranges.slice(0, l).concat(e), l), {origin:"*mouse", scroll:!1}), a.scrollIntoView(b);
          } else {
            ...
            if ("single" != d) {
              if ("double" == d) {
                ...
                var w = new la(Nf(b.line, 0), pa(j, Nf(b.line + 1, 0)));
              }
      ...
      if (e && !b.shiftKey ? (l = j.sel.contains(c), k = l > -1 ? n[l] : new la(c, c)) : (k = j.sel.primary(), l = j.sel.primIndex), Gf ? b.shiftKey && b.metaKey : b.altKey) {
        d = "rect", e || (k = new la(c, c)), c = Vb(a, b, !0, !0), l = -1;
      } else if ("double" == d) {
      ...
      e ? l == -1 ? (l = n.length, Aa(j, ma(n.concat([k]), l), {scroll:!1, origin:"*mouse"})) : n.length > 1 && n[l].empty() && "single" == d && !b.shiftKey ? (Aa(j, ma(n.slice(0, l).concat(n.slice(l + 1)), 0), {scroll:!1, origin:"*mouse"}), m = j.sel) : wa(j, l, k, Ng) : (l = 0, Aa(j, new ka([k], 0), Ng), m = j.sel);
      var q = c, r = i.wrapper.getBoundingClientRect(), s = 0, t = Fb(a, function(a) {
        we(a) ? g(a) : h(a);
      }), v = Fb(a, h);
    ...
    function $b(a, b, c, d) {
      ...
      for (var i = 0; i < a.options.gutters.length; ++i) {
        ...
        if (j && j.getBoundingClientRect().right >= e) {
          var k = ce(a.doc, f), l = a.options.gutters[i];
    ...
    function ac(a) {
      ...
      if (dc(b), !Ae(b, a) && !Ub(b.display, a)) {
        Cg(a), uf && (Wf = +new Date());
        var c = Vb(b, a, !0), d = a.dataTransfer.files;
        if (c && !b.isReadOnly()) {
              ...
              if (!b.options.allowDropFileTypes || He(b.options.allowDropFileTypes, a.type) != -1) {
                ...
                h.onload = Fb(b, function() {
                  ...
                  if (/[\x00-\x08\x0e-\x1f]{2}/.test(a) && (a = ""), f[d] = a, ++g == e) {
                    c = pa(b.doc, c);
                    var i = {from:c, to:c, text:b.doc.splitLines(f.join(b.doc.lineSeparator())), origin:"paste"};
              ...
              if (f) {
                ...
                if (Ba(b.doc, na(c, c)), j) {
                  for (var i = 0; i < j.length; ++i) {
                    Gc(b.doc, "", j[i].anchor, j[i].head, "drag");
                  }
                }
    ...
    function bc(a, b) {
      if (uf && (!a.state.draggingText || +new Date() - Wf < 100)) {
        return void Eg(b);
      }
    ...
    function ec(a, b) {
      Math.abs(a.doc.scrollTop - b) < 2 || (a.doc.scrollTop = b, rf || D(a, {top:b}), a.display.scroller.scrollTop != b && (a.display.scroller.scrollTop = b), a.display.scrollbars.setScrollTop(b), rf && D(a), Na(a, 100));
    }
    function fc(a, b, c) {
    ...
    function gc(a, b) {
      var c = Zf(b), d = c.x, e = c.y, f = a.display, g = f.scroller, h = g.scrollWidth > g.clientWidth, i = g.scrollHeight > g.clientHeight;
      if (d && h || e && i) {
        if (e && Ff && wf) {
          a: for (var j = b.target, k = f.view; j != g; j = j.parentNode) {
        ...
        if (d && !rf && !zf && null != Yf) {
          return e && i && ec(a, Math.max(0, Math.min(g.scrollTop + e * Yf, g.scrollHeight - g.clientHeight))), fc(a, Math.max(0, Math.min(g.scrollLeft + d * Yf, g.scrollWidth - g.clientWidth))), (!e || e && i) && Cg(b), void(f.wheelStartX = null);
        }
        if (e && null != Yf) {
          var m = e * Yf, n = a.doc.scrollTop, o = n + f.wrapper.clientHeight;
          m < 0 ? n = Math.max(0, n + m - 50) : o = Math.min(a.doc.height, o + m + 50), D(a, {top:n, bottom:o});
        }
    ...
    function yc(a, b, c) {
      for (var d = [], e = Nf(a.first, 0), f = e, g = 0; g < b.length; g++) {
        var h = b[g], i = xc(h.from, e, f), j = xc(ag(h), e, f);
        if (e = h.to, f = j, "around" == c) {
          var k = a.sel.ranges[g], l = Of(k.head, k.anchor) < 0;
    ...
    function zc(a, b, c) {
      ...
      }), Ig(a, "beforeChange", a, d), a.cm && Ig(a.cm, "beforeChange", a.cm, d), d.canceled ? null : {from:d.from, to:d.to, text:d.text, origin:d.origin};
    }
    function Ac(a, b, c) {
      if (a.cm) {
        if (!a.cm.curOp) {
          return Fb(a.cm, Ac)(a, b, c);
        }
      ...
      if (!(Ce(a, "beforeChange") || a.cm && Ce(a.cm, "beforeChange")) || (b = zc(a, b, !0))) {
        ...
        if (d) {
          for (var e = d.length - 1; e >= 0; --e) {
            Bc(a, {from:d[e].from, to:d[e].to, text:e ? [""] : b.text});
          }
        } else {
          Bc(a, b);
        }
      ...
      if (!a.cm || !a.cm.state.suppressEdits || c) {
        ...
        if (i != g.length) {
          for (e.lastOrigin = e.lastSelOrigin = null; d = g.pop(), d.ranges;) {
            if (me(d, h), c && !d.equals(a.sel)) {
              return void Aa(a, d, {clearRedo:!1});
            }
            f = d;
          }
          var j = [];
          me(f, h), h.push({changes:j, generation:e.generation}), e.generation = d.generation || ++e.maxGeneration;
          for (var k = Ce(a, "beforeChange") || a.cm && Ce(a.cm, "beforeChange"), i = d.changes.length - 1; i >= 0; --i) {
            var l = d.changes[i];
            if (l.origin = b, k && !zc(a, l, !1)) {
              return void(g.length = 0);
            }
            j.push(ge(a, l));
            var m = i ? wc(a, l) : Ge(g);
            Ec(a, l, m, hd(a, l)), !i && a.cm && a.cm.scrollIntoView({from:l.from, to:ag(l)});
            var n = [];
            Xd(a, function(a, b) {
    ...
    function Ec(a, b, c, d) {
      if (a.cm && !a.cm.curOp) {
        return Fb(a.cm, Ec)(a, b, c, d);
      }
      if (b.to.line < a.first) {
        return void Dc(a, b.text.length - 1 - (b.to.line - b.from.line));
      }
      if (!(b.from.line > a.lastLine())) {
        if (b.from.line < a.first) {
          var e = b.text.length - 1 - (a.first - b.from.line);
          Dc(a, e), b = {from:Nf(a.first, 0), to:Nf(b.to.line + e, b.to.ch), text:[Ge(b.text)], origin:b.origin};
        }
        var f = a.lastLine();
        b.to.line > f && (b = {from:b.from, to:Nf(f, Zd(a, f).text.length), text:[b.text[0]], origin:b.origin}), b.removed = $d(a, b.from, b.to), c || (c = wc(a, b)), a.cm ? Fc(a.cm, b, d) : Ud(a, b, d), Ba(a, c, Mg);
      }
    }
    function Fc(a, b, c) {
      ...
      var m = Ce(a, "changes"), n = Ce(a, "change");
      if (n || m) {
    ...
    function Gc(a, b, c, d, e) {
      ...
      "string" == typeof b && (b = a.splitLines(b)), Ac(a, {from:c, to:d, text:b, origin:e});
    }
    function Hc(a, b) {
    ...
    function Ic(a, b, c, d) {
      null == d && (d = 0);
      for (var e = 0; e < 5; e++) {
        var f = !1, g = ob(a, b), h = c && c != b ? ob(a, c) : g, i = Kc(a, Math.min(g.left, h.left), Math.min(g.top, h.top) - d, Math.max(g.left, h.left), Math.max(g.bottom, h.bottom) + d), j = a.doc.scrollTop, k = a.doc.scrollLeft;
        if (null != i.scrollTop && (ec(a, i.scrollTop), Math.abs(a.doc.scrollTop - j) > 1 && (f = !0)), null != i.scrollLeft && (fc(a, i.scrollLeft), Math.abs(a.doc.scrollLeft - k) > 1 && (f = !0)), !f) {
          break;
        }
      }
      return g;
    ...
    function Kc(a, b, c, d, e) {
      var f = a.display, g = tb(a.display);
      c < 0 && (c = 0);
      var h = a.curOp && null != a.curOp.scrollTop ? a.curOp.scrollTop : f.scroller.scrollTop, i = Wa(a), j = {};
      e - c > i && (e = c + i);
      var k = a.doc.height + Sa(f), l = c < g, m = e > k - g;
      if (c < h) {
        j.scrollTop = l ? 0 : c;
      } else if (e > h + i) {
      ...
      var o = a.curOp && null != a.curOp.scrollLeft ? a.curOp.scrollLeft : f.scroller.scrollLeft, p = Va(a) - (a.options.fixedGutter ? f.gutters.offsetWidth : 0), q = d - b > p;
    ...
    function Mc(a) {
      ...
      a.options.lineWrapping || (c = b.ch ? Nf(b.line, b.ch - 1) : b, d = Nf(b.line, b.ch + 1)), a.curOp.scrollToPos = {from:c, to:d, margin:a.options.cursorScrollMargin, isCursor:!0};
    }
    function Nc(a) {
      var b = a.curOp.scrollToPos;
      if (b) {
        a.curOp.scrollToPos = null;
        var c = pb(a, b.from), d = pb(a, b.to), e = Kc(a, Math.min(c.left, d.left), Math.min(c.top, d.top) - b.margin, Math.max(c.right, d.right), Math.max(c.bottom, d.bottom) + b.margin);
    ...
    function Oc(a, b, c, d) {
      ...
      var g = a.options.tabSize, h = Zd(f, b), i = Pg(h.text, null, g);
      ...
      if (m < j && (l += Fe(j - m)), l != k) {
        return Gc(f, l, Nf(b, 0), Nf(b, k.length), "+input"), h.stateAfter = null, !0;
      }
    ...
    function Qc(a, b) {
      ...
      Eb(a, function() {
        for (var b = d.length - 1; b >= 0; b--) {
          Gc(a.doc, "", d[b].from, d[b].to, "+delete");
        }
        Mc(a);
      });
    }
    function Rc(a, b, c, d, e) {
      ...
      var h = b.line, i = b.ch, j = c, k = Zd(a, h);
      if ("char" == d) {
        g();
      } else if ("column" == d) {
        g(!0);
    ...
    function Sc(a, b, c, d) {
      ...
      if ("page" == d) {
        var h = Math.min(a.display.wrapper.clientHeight, window.innerHeight || document.documentElement.clientHeight), i = Math.max(h - .5 * tb(a.display), 3);
    ...
    function Wc(a, b, c, d, e) {
      ...
      if (a.cm && !a.cm.curOp) {
        return Fb(a.cm, Wc)(a, b, c, d, e);
      }
      var f = new sg(a, e), g = Of(b, c);
      if (d && Me(d, f, !1), g > 0 || 0 == g && f.clearWhenEmpty !== !1) {
        return f;
      }
      if (f.replacedWith && (f.collapsed = !0, f.widgetNode = Re("span", [f.replacedWith], "CodeMirror-widget"), d.handleMouseEvents || f.widgetNode.setAttribute("cm-ignore-events", "true"), d.insertLeft && (f.widgetNode.insertLeft = !0)), f.collapsed) {
        if (rd(a, b.line, b, c, f) || b.line != c.line && rd(a, c.line, b, c, f)) {
          throw new Error("Inserting collapsed marker partially overlapping an existing one");
        }
        Mf = !0;
      }
      f.addToHistory && je(a, {from:b, to:c, origin:"markText"}, a.sel, NaN);
    ...
    function Xc(a, b, c, d, e) {
      d = Me(d), d.shared = !1;
      var f = [Wc(a, b, c, d, e)], g = f[0], h = d.widgetNode;
    ...
    function fd(a, b) {
      ...
      var c = ra(a, b.from.line) && Zd(a, b.from.line).markedSpans, d = ra(a, b.to.line) && Zd(a, b.to.line).markedSpans;
      if (!c && !d) {
        return null;
      }
      var e = b.from.ch, f = b.to.ch, g = 0 == Of(b.from, b.to), h = dd(c, e, g), i = ed(d, f, g), j = 1 == b.text.length, k = Ge(b.text).length + (j ? e : 0);
      if (h) {
      ...
      if (!j) {
        ...
        if (q > 0 && h) {
          for (var l = 0; l < h.length; ++l) {
            null == h[l].to && (p || (p = [])).push(new _c(h[l].marker, null, null));
          }
        }
        for (var l = 0; l < q; ++l) {
          o.push(p);
      ...
      for (var e = [{from:b, to:c}], f = 0; f < d.length; ++f) {
        for (var g = d[f], h = g.find(0), i = 0; i < e.length; ++i) {
          ...
          if (!(Of(j.to, h.from) < 0 || Of(j.from, h.to) > 0)) {
            var k = [i, 1], l = Of(j.from, h.from), m = Of(j.to, h.to);
    ...
    function nd(a, b) {
      ...
      var d = a.find(), e = b.find(), f = Of(d.from, e.from) || ld(a) - ld(b);
      if (f) {
        return -f;
      }
    ...
    function od(a, b) {
      ...
      if (d) {
        for (var e, f = 0; f < d.length; ++f) {
          e = d[f], e.marker.collapsed && null == (b ? e.from : e.to) && (!c || nd(c, e.marker) < 0) && (c = e.marker);
        }
      }
      return c;
    }
    ...
    function rd(a, b, c, d, e) {
      var f = Zd(a, b), g = Mf && f.markedSpans;
      if (g) {
        for (var h = 0; h < g.length; ++h) {
          var i = g[h];
          if (i.marker.collapsed) {
            var j = i.marker.find(0), k = Of(j.from, c) || ld(i.marker) - ld(e), l = Of(j.to, d) || md(i.marker) - md(e);
            if (!(k >= 0 && l <= 0 || k <= 0 && l >= 0) && (k <= 0 && (i.marker.inclusiveRight && e.inclusiveLeft ? Of(j.to, c) >= 0 : Of(j.to, c) > 0) || k >= 0 && (i.marker.inclusiveRight && e.inclusiveLeft ? Of(j.from, d) <= 0 : Of(j.from, d) < 0))) {
              return !0;
            }
          }
        }
      ...
      if (c) {
        for (var d, e = 0; e < c.length; ++e) {
          if (d = c[e], d.marker.collapsed) {
            ...
            if (!d.marker.widgetNode && 0 == d.from && d.marker.inclusiveLeft && xd(a, b, d)) {
              return !0;
            }
          }
        }
    ...
    function xd(a, b, c) {
      ...
      for (var e, f = 0; f < b.markedSpans.length; ++f) {
        if (e = b.markedSpans[f], e.marker.collapsed && !e.marker.widgetNode && e.from == c.to && (null == e.to || e.to != c.from) && (e.marker.inclusiveLeft || c.marker.inclusiveRight) && xd(a, b, e)) {
          return !0;
        }
      }
    }
    ...
    function Gd(a, b, c, d) {
      function e(a) {
        return {start:l.start, end:l.pos, string:l.current(), type:f || null, state:a ? jg(g.mode, k) : k};
      }
      var f, g = a.doc, h = g.mode;
      b = pa(g, b);
      var i, j = Zd(g, b.line), k = Qa(a, b.line, c), l = new qg(j.text, a.options.tabSize);
      for (d && (i = []); (d || l.pos < b.ch) && !l.eol();) {
        l.start = l.pos, f = Fd(h, l, k), d && i.push(e(!0));
      }
      return d ? i : e();
    }
    function Hd(a, b, c, d, e, f, g) {
      ...
      var i, j = 0, k = null, l = new qg(b, a.options.tabSize), m = a.options.addModeClass && [null];
      for ("" == b && Dd(Ed(c, d), f); !l.eol();) {
        ...
        if (!h || k != i) {
          for (; j < l.start;) {
            j = Math.min(l.start, j + 5e3), e(j, k);
          }
          k = i;
        }
        l.start = l.pos;
    ...
    function Jd(a, b, c) {
      if (!b.styles || b.styles[0] != a.state.modeGen) {
        var d = Qa(a, be(b)), e = Id(a, b, b.text.length > a.options.maxHighlightLength ? jg(a.doc.mode, d) : d);
    ...
    function Kd(a, b, c, d) {
      var e = a.doc.mode, f = new qg(b, a.options.tabSize);
      for (f.start = f.pos = d || 0, "" == b && Ed(e, c); !f.eol();) {
        Fd(e, f, c), f.start = f.pos;
      }
    }
    function Ld(a, b) {
      if (!a || /^\s*$/.test(a)) {
    ...
    function Md(a, b) {
      var c = Re("span", null, null, wf ? "padding-right: .1px" : null), d = {pre:Re("pre", [c], "CodeMirror-line"), content:c, col:0, pos:0, cm:a, trailingSpace:!1, splitSpaces:(uf || wf) && a.getOption("lineWrapping")};
      b.measure = {};
    ...
    function Od(a, b, c, d, e, f, g) {
      if (b) {
        var h = a.splitSpaces ? Pd(b, a.trailingSpace) : b, i = a.cm.state.specialChars, j = !1;
        if (i.test(b)) {
          for (var k = document.createDocumentFragment(), l = 0;;) {
            ...
            if (l += n + 1, "\t" == m[0]) {
              var p = a.cm.options.tabSize, q = p - a.col % p, o = k.appendChild(Re("span", Fe(q), "cm-tab"));
      ...
      if (d) {
        for (var g, h, i, j, k, l, m, n = e.length, o = 0, p = 1, q = "", r = 0;;) {
          if (r == o) {
            ...
            if (m && (m.from || 0) == o) {
              if (Rd(b, (null == m.to ? n + 1 : m.to) - o, m.marker, null == m.from), null == m.to) {
                return;
              }
              m.to == o && (m = !1);
            }
        ...
        for (var p = 1; p < c.length; p += 2) {
          b.addToken(b, e.slice(f, f = c[p]), Ld(c[p + 1], b.cm.options));
        }
      }
    }
    function Td(a, b) {
    ...
    function Ud(a, b, c, d) {
      ...
      function g(a, b) {
        for (var c = a, f = []; c < b; ++c) {
          f.push(new vg(j[c], e(c), d));
        }
        return f;
      }
      var h = b.from, i = b.to, j = b.text, k = Zd(a, h.line), l = Zd(a, i.line), m = Ge(j), n = e(j.length - 1), o = i.line - h.line;
      if (b.full) {
    ...
    function ge(a, b) {
      var c = {from:V(b.from), to:ag(b), text:$d(a, b.from, b.to)};
    ...
    function je(a, b, c, d) {
      ...
      if ((e.lastOp == d || e.lastOrigin == b.origin && b.origin && ("+" == b.origin.charAt(0) && a.cm && e.lastModTime > g - a.cm.options.historyEventDelay || "*" == b.origin.charAt(0))) && (f = ie(e, e.lastOp == d))) {
        ...
        var i = Ge(e.done);
        for (i && i.ranges || me(a.sel, e.done), f = {changes:[ge(a, b)], generation:e.generation}, e.done.push(f); e.done.length > e.undoDepth;) {
        ...
        if (f.ranges) {
          ...
          for (var i = 0; i < g.length; ++i) {
            ...
            if (h.push({from:k.from, to:k.to, text:k.text}), b) {
              for (var l in k) {
                (j = l.match(/^spans_(\d+)$/)) && He(b, Number(j[1])) > -1 && (Ge(h)[l] = k[l], delete k[l]);
              }
            }
          }
        }
      ...
      for (var e = 0; e < a.length; ++e) {
        ...
        if (f.ranges) {
          ...
          for (var h = 0; h < f.ranges.length; h++) {
            re(f.ranges[h].anchor, b, c, d), re(f.ranges[h].head, b, c, d);
          }
        } else {
          for (var h = 0; h < f.changes.length; ++h) {
            var i = f.changes[h];
            if (c < i.from.line) {
              i.from = Nf(i.from.line + d, i.from.ch), i.to = Nf(i.to.line + d, i.to.ch);
            } else if (b <= i.to.line) {
              g = !1;
              break;
            }
    ...
    function _e(a) {
      ...
      var b = Te(a, document.createTextNode("A\u062eA")), c = Tg(b, 0, 1).getBoundingClientRect(), d = Tg(b, 1, 2).getBoundingClientRect();
    ...
    function af(a) {
      ...
      var b = Te(a, Re("span", "x")), c = b.getBoundingClientRect(), d = Tg(b, 0, 1).getBoundingClientRect();
    ...
    function gf(a, b) {
      var c = Zd(a.doc, b), d = sd(c);
      d != c && (b = be(d));
      var e = ee(d), f = e ? e[0].level % 2 ? ff(d) : ef(d) : 0;
      return Nf(b, f);
    }
    function hf(a, b) {
      for (var c, d = Zd(a.doc, b); c = qd(d);) {
        d = c.find(1, !0).line, b = null;
      }
      var e = ee(d), f = e ? e[0].level % 2 ? ef(d) : ff(d) : d.text.length;
      return Nf(null == b ? be(d) : b, f);
    }
    function jf(a, b) {
      var c = gf(a, b.line), d = Zd(a.doc, c.line), e = ee(d);
      if (!e || 0 == e[0].level) {
    ...
    function lf(a, b) {
      ...
      for (var c, d = 0; d < a.length; ++d) {
        ...
        if (e.from == b || e.to == b) {
          if (null != c) {
            return kf(a, e.level, a[c].level) ? (e.from != e.to && (hh = c), d) : (e.from != e.to && (hh = d), c);
          }
          c = d;
        }
      }
    ...
    function nf(a, b, c, d) {
      ...
      for (var f = lf(e, b), g = e[f], h = mf(a, b, g.level % 2 ? -c : c, d);;) {
        ...
        if (h == g.from || h == g.to) {
          return lf(e, h) == f ? h : (g = e[f += c], c > 0 == g.level % 2 ? g.to : g.from);
        }
        if (g = e[f += c], !g) {
          return null;
        }
    ...
    function of(a, b, c, d) {
      var e = b + c;
      if (d) {
        for (; e > 0 && Qe(a.text.charAt(e));) {
          e += c;
        }
      }
      return e < 0 || e > a.text.length ? null : e;
    }
    var pf = navigator.userAgent, qf = navigator.platform, rf = /gecko\/\d/i.test(pf), sf = /MSIE \d/.test(pf), tf = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(pf), uf = sf || tf, vf = uf && (sf ? document.documentMode || 6 : tf[1]), wf = /WebKit\//.test(pf), xf = wf && /Qt\/\d+\.\d+/.test(pf), yf = /Chrome\//.test(pf), zf = /Opera\//.test(pf), Af = /Apple Computer/.test(navigator.vendor), Bf = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(pf), Cf = /PhantomJS/.test(pf), Df = /AppleWebKit/.test(pf) && /Mobile\/\w+/.test(pf), 
    Ef = Df || /Android|webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(pf), Ff = Df || /Mac/.test(qf), Gf = /\bCrOS\b/.test(pf), Hf = /win/i.test(qf), If = zf && pf.match(/Version\/(\d*\.\d*)/);
    If && (If = Number(If[1])), If && If >= 15 && (zf = !1, wf = !0);
    var Jf = Ff && (xf || zf && (null == If || If < 12.11)), Kf = rf || uf && vf >= 9, Lf = !1, Mf = !1;
    p.prototype = Me({update:function(a) {
    ...
    }}, p.prototype), q.prototype = Me({update:function() {
    ...
    ca.prototype = Me({init:function(a) {
      function b(a) {
        if (!Ae(d, a)) {
          if (d.somethingSelected()) {
            Pf = {lineWise:!1, text:d.getSelections()}, c.inaccurateSelection && (c.prevInput = "", c.inaccurateSelection = !1, f.value = Pf.text.join("\n"), Sg(f));
          } else {
            if (!d.options.lineWiseCopyCut) {
              return;
            }
            var b = aa(d);
            Pf = {lineWise:!0, text:b.text}, "cut" == a.type ? d.setSelections(b.ranges, null, Mg) : (c.prevInput = "", f.value = b.text.join("\n"), Sg(f));
          }
          "cut" == a.type && (d.state.cutIncoming = !0);
        }
      }
      var c = this, d = this.cm, e = this.wrapper = da(), f = this.textarea = e.firstChild;
      a.wrapper.insertBefore(e, a.wrapper.firstChild), Df && (f.style.width = "0px"), Fg(f, "input", function() {
        ...
        c.composing && c.composing.range.clear(), c.composing = {start:a, range:d.markText(a, d.getCursor("to"), {className:"CodeMirror-composing"})};
      }), Fg(f, "compositionend", function() {
        c.composing && (c.poll(), c.composing.range.clear(), c.composing = null);
      });
    }, prepareSelection:function() {
      var a = this.cm, b = a.display, c = a.doc, d = Ja(a);
      ...
      if (!this.contextMenuPending) {
        ...
        if (d.somethingSelected()) {
          ...
          a || (this.prevInput = this.textarea.value = "", uf && vf >= 9 && (this.hasSelection = null));
        }
      ...
      if ("nocursor" != this.cm.options.readOnly && (!Ef || Ue() != this.textarea)) {
        try {
          this.textarea.focus();
        } catch (a) {
        }
      ...
      if (this.contextMenuPending || !a.state.focused || dh(b) && !c && !this.composing || a.isReadOnly() || a.options.disableInput || a.state.keySeq) {
        return !1;
      }
      var d = b.value;
      ...
      if (uf && vf >= 9 && this.hasSelection === d || Ff && /[\uf700-\uf7ff]/.test(d)) {
      ...
      var d = this, e = d.cm, f = e.display, g = d.textarea, h = Vb(e, a), i = f.scroller.scrollTop;
      if (h && !zf) {
        ...
        if (g.style.cssText = "position: absolute; width: 30px; height: 30px; top: " + (a.clientY - m.top - 5) + "px; left: " + (a.clientX - m.left - 5) + "px; z-index: 1000; background: " + (uf ? "rgba(255, 255, 255, .05)" : "transparent") + "; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);", wf) {
      ...
      a || this.reset();
    }, setUneditable:Ke, needsContentAttribute:!1}, ca.prototype), ea.prototype = Me({init:function(a) {
      function b(a) {
        if (!Ae(d, a)) {
          if (d.somethingSelected()) {
            Pf = {lineWise:!1, text:d.getSelections()}, "cut" == a.type && d.replaceSelection("", null, "cut");
          } else {
            if (!d.options.lineWiseCopyCut) {
              return;
            }
            var b = aa(d);
            Pf = {lineWise:!0, text:b.text}, "cut" == a.type && d.operation(function() {
      ...
      var a = window.getSelection(), b = this.cm.doc.sel.primary(), c = ha(this.cm, a.anchorNode, a.anchorOffset), d = ha(this.cm, a.focusNode, a.focusOffset);
      if (!c || c.bad || !d || d.bad || 0 != Of(X(c, d), b.from()) || 0 != Of(W(c, d), b.to())) {
        var e = fa(this.cm, b.from()), f = fa(this.cm, b.to());
        if (e || f) {
          ...
          if (e) {
            ...
            e = {node:g[0].measure.map[2], offset:0};
          }
          try {
      ...
      var f;
      if (d.line == b.viewFrom || 0 == (f = Nb(a, d.line))) {
        var g = be(b.view[0].line), h = b.view[0].node;
      } else {
        var g = be(b.view[f].line), h = b.view[f - 1].node.nextSibling;
      }
      var i = Nb(a, e.line);
      if (i == b.view.length - 1) {
        var j = b.viewTo - 1, k = b.lineDiv.lastChild;
      } else {
        var j = be(b.view[i + 1].line) - 1, k = b.view[i + 1].node.previousSibling;
      }
      ...
      for (var s = Ge(l), t = Ge(m), u = Math.min(s.length - (1 == l.length ? n : 0), t.length - (1 == m.length ? n : 0)); o < u && s.charCodeAt(s.length - o - 1) == t.charCodeAt(t.length - o - 1);) {
        ++o;
      }
      l[l.length - 1] = s.slice(0, s.length - o), l[0] = l[0].slice(n);
      var v = Nf(g, n), w = Nf(j, m.length ? Ge(m).length - o : 0);
    ...
    }, onContextMenu:Ke, resetPosition:Ke, needsContentAttribute:!0}, ea.prototype), a.inputStyles = {textarea:ca, contenteditable:ea}, ka.prototype = {primary:function() {
      ...
      for (var b = 0; b < this.ranges.length; b++) {
        ...
        if (0 != Of(c.anchor, d.anchor) || 0 != Of(c.head, d.head)) {
          return !1;
        }
      }
      return !0;
      ...
      for (var a = [], b = 0; b < this.ranges.length; b++) {
        a[b] = new la(V(this.ranges[b].anchor), V(this.ranges[b].head));
      }
    ...
    var Qf, Rf, Sf, Tf = {left:0, right:0, top:0, bottom:0}, Uf = null, Vf = 0, Wf = 0, Xf = 0, Yf = null;
    ...
    a.prototype = {constructor:a, focus:function() {
      ...
      Je(this.state.overlays, {mode:d, modeSpec:b, opaque:c && c.opaque, priority:c && c.priority || 0}, function(a) {
        return a.priority;
      ...
      for (var b = this.state.overlays, c = 0; c < b.length; ++c) {
        ...
        if (d == a || "string" == typeof a && d.name == a) {
          return b.splice(c, 1), this.state.modeGen++, void Kb(this);
        }
      }
      ...
      for (var b = this.doc.sel.ranges, c = -1, d = 0; d < b.length; d++) {
        var e = b[d];
        if (e.empty()) {
          e.head.line > c && (Oc(this, e.head.line, a, !0), c = e.head.line, d == this.doc.sel.primIndex && Mc(this));
        } else {
      ...
      a = pa(this.doc, a);
      var b, c = Jd(this, Zd(this.doc, a.line)), d = 0, e = (c.length - 1) / 2, f = a.ch;
      if (0 == f) {
        b = c[2];
      } else {
        for (;;) {
      ...
      var c = [];
      if (!ig.hasOwnProperty(b)) {
        return c;
      }
      var d = ig[b], e = this.getModeAt(a);
      ...
      return a = mb(this, {top:a, left:0}, b || "page").top, ce(this.doc, a + this.display.viewOffset);
      ...
      return lb(this, c, {top:0, left:0}, b || "page").top + (d ? this.doc.height - de(c) : 0);
    ...
    }, triggerOnKeyDown:Gb(mc), triggerOnKeyPress:Gb(pc), triggerOnKeyUp:oc, execCommand:function(a) {
      if (lg.hasOwnProperty(a)) {
        return lg[a].call(null, this);
      }
      ...
      for (var g = 0, h = pa(this.doc, a); g < b; ++g) {
        var i = ob(this, h, "div");
        if (null == f ? f = i.left : i.left = f, h = Sc(this, i, e, c), h.hitSide) {
          break;
        }
      }
      return h;
      ...
      var b = this.doc, c = Zd(b, a.line).text, d = a.ch, e = a.ch;
      if (c) {
      ...
      return {left:a.scrollLeft, top:a.scrollTop, height:a.scrollHeight - Ua(this) - this.display.barHeight, width:a.scrollWidth - Ua(this) - this.display.barWidth, clientHeight:Wa(this), clientWidth:Va(this)};
    }, scrollIntoView:Gb(function(a, b) {
      if (null == a ? (a = {from:this.doc.sel.primary().head, to:null}, null == b && (b = this.options.cursorScrollMargin)) : "number" == typeof a ? a = {from:Nf(a, 0), to:null} : null == a.from && (a = {from:a, to:null}), a.to || (a.to = a.from), a.margin = b || 0, null != a.from.line) {
        Nc(this), this.curOp.scrollToPos = a;
      } else {
    ...
    var bg = a.defaults = {}, cg = a.optionHandlers = {}, dg = a.Init = {toString:function() {
    ...
    Tc("value", "", function(a, b) {
      ...
      if (a.doc.lineSep = b, b) {
        ...
        for (var e = c.length - 1; e >= 0; e--) {
          Gc(a.doc, b, c[e], Nf(c[e].line, c[e].ch + b.length));
        }
      }
    ...
    a.defineMode = function(b, c) {
      ...
      if ("string" == typeof b && fg.hasOwnProperty(b)) {
        b = fg[b];
      } else if (b && "string" == typeof b.name && fg.hasOwnProperty(b.name)) {
        var c = fg[b.name];
        "string" == typeof c && (c = {name:c}), b = Le(c, b), b.name = c.name;
      } else {
        if ("string" == typeof b && /^[\w\-]+\/[\w\-]+\+xml$/.test(b)) {
          return a.resolveMode("application/xml");
        }
        if ("string" == typeof b && /^[\w\-]+\/[\w\-]+\+json$/.test(b)) {
          return a.resolveMode("application/json");
        }
      }
      return "string" == typeof b ? {name:b} : b || {name:"null"};
    }, a.getMode = function(b, c) {
      var c = a.resolveMode(c), d = eg[c.name];
      if (!d) {
    ...
    a.registerHelper = function(b, c, d) {
      ig.hasOwnProperty(b) || (ig[b] = a[b] = {_global:[]}), ig[b][c] = d;
    }, a.registerGlobalHelper = function(b, c, d, e) {
      a.registerHelper(b, c, e), ig[b]._global.push({pred:d, val:e});
    };
    ...
    var lg = a.commands = {selectAll:function(a) {
      ...
      Qc(a, function(b) {
        if (b.empty()) {
          ...
          return b.head.ch == c && b.head.line < a.lastLine() ? {from:b.head, to:Nf(b.head.line + 1, 0)} : {from:b.head, to:Nf(b.head.line, c)};
        }
        return {from:b.from(), to:b.to()};
      });
    }, deleteLine:function(a) {
      Qc(a, function(b) {
        return {from:Nf(b.from().line, 0), to:pa(a.doc, Nf(b.to().line + 1, 0))};
      });
    }, delLineLeft:function(a) {
      Qc(a, function(a) {
        return {from:Nf(a.from().line, 0), to:a.from()};
      });
      ...
      for (var b = [], c = a.listSelections(), d = a.options.tabSize, e = 0; e < c.length; e++) {
        var f = c[e].from(), g = Pg(a.getLine(f.line), f.ch, d);
        b.push(Fe(d - g % d));
      }
      ...
      Eb(a, function() {
        for (var b = a.listSelections(), c = [], d = 0; d < b.length; d++) {
          var e = b[d].head, f = Zd(a.doc, e.line).text;
          if (f) {
            if (e.ch == f.length && (e = new Nf(e.line, e.ch - 1)), e.ch > 0) {
              e = new Nf(e.line, e.ch + 1), a.replaceRange(f.charAt(e.ch - 1) + f.charAt(e.ch - 2), Nf(e.line, e.ch - 2), e, "+transpose");
    ...
    mg.basic = {Left:"goCharLeft", Right:"goCharRight", Up:"goLineUp", Down:"goLineDown", End:"goLineEnd", Home:"goLineStartSmart", PageUp:"goPageUp", PageDown:"goPageDown", Delete:"delCharAfter", Backspace:"delCharBefore", "Shift-Backspace":"delCharBefore", Tab:"defaultTab", "Shift-Tab":"indentAuto", Enter:"newlineAndIndent", Insert:"toggleOverwrite", Esc:"singleSelection"}, mg.pcDefault = {"Ctrl-A":"selectAll", "Ctrl-D":"deleteLine", "Ctrl-Z":"undo", "Shift-Ctrl-Z":"redo", "Ctrl-Y":"redo", "Ctrl-Home":"goDocStart", 
    "Ctrl-End":"goDocEnd", "Ctrl-Up":"goLineUp", "Ctrl-Down":"goLineDown", "Ctrl-Left":"goGroupLeft", "Ctrl-Right":"goGroupRight", "Alt-Left":"goLineStart", "Alt-Right":"goLineEnd", "Ctrl-Backspace":"delGroupBefore", "Ctrl-Delete":"delGroupAfter", "Ctrl-S":"save", "Ctrl-F":"find", "Ctrl-G":"findNext", "Shift-Ctrl-G":"findPrev", "Shift-Ctrl-F":"replace", "Shift-Ctrl-R":"replaceAll", "Ctrl-[":"indentLess", "Ctrl-]":"indentMore", "Ctrl-U":"undoSelection", "Shift-Ctrl-U":"redoSelection", "Alt-U":"redoSelection", 
    fallthrough:"basic"}, mg.emacsy = {"Ctrl-F":"goCharRight", "Ctrl-B":"goCharLeft", "Ctrl-P":"goLineUp", "Ctrl-N":"goLineDown", "Alt-F":"goWordRight", "Alt-B":"goWordLeft", "Ctrl-A":"goLineStart", "Ctrl-E":"goLineEnd", "Ctrl-V":"goPageDown", "Shift-Ctrl-V":"goPageUp", "Ctrl-D":"delCharAfter", "Ctrl-H":"delCharBefore", "Alt-D":"delWordAfter", "Alt-Backspace":"delWordBefore", "Ctrl-K":"killLine", "Ctrl-T":"transposeChars", "Ctrl-O":"openLine"}, mg.macDefault = {"Cmd-A":"selectAll", "Cmd-D":"deleteLine", 
    ...
    "Cmd-]":"indentMore", "Cmd-Backspace":"delWrappedLineLeft", "Cmd-Delete":"delWrappedLineRight", "Cmd-U":"undoSelection", "Shift-Cmd-U":"redoSelection", "Ctrl-Up":"goDocStart", "Ctrl-Down":"goDocEnd", fallthrough:["basic", "emacsy"]}, mg.default = Ff ? mg.macDefault : mg.pcDefault, a.normalizeKeyMap = function(a) {
      var b = {};
      for (var c in a) {
    ...
    var ng = a.lookupKey = function(a, b, c, d) {
      ...
      if (zf && 34 == a.keyCode && a.char) {
        return !1;
      }
      var c = gh[a.keyCode], d = c;
    ...
    var rg = 0, sg = a.TextMarker = function(a, b) {
    ...
    De(sg), sg.prototype.clear = function() {
      if (!this.explicitlyCleared) {
        ...
        for (var d = null, e = null, f = 0; f < this.lines.length; ++f) {
          var g = this.lines[f], h = ad(g.markedSpans, this);
      ...
      for (var c, d, e = 0; e < this.lines.length; ++e) {
        var f = this.lines[e], g = ad(f.markedSpans, this);
        if (null != g.from && (c = Nf(b ? f : be(f), g.from), a == -1)) {
          return c;
        }
        if (null != g.to && (d = Nf(b ? f : be(f), g.to), 1 == a)) {
          return d;
        }
      }
      ...
      a && c && Eb(c, function() {
        var d = a.line, e = be(a.line), f = _a(c, e);
    ...
    var rg = 0, tg = a.SharedTextMarker = function(a, b) {
    ...
    De(ug), ug.prototype.clear = function() {
      var a = this.doc.cm, b = this.line.widgets, c = this.line, d = be(c);
      if (null != d && b) {
    ...
    var yg = 0, zg = a.Doc = function(a, b, c, d) {
      ...
      var e = Nf(c, 0);
      this.sel = na(e), this.history = new fe(null), this.id = ++yg, this.modeOption = b, this.lineSep = d, this.extend = !1, "string" == typeof a && (a = this.splitLines(a)), Ud(this, {from:e, to:e, text:a}), Aa(this, na(e), Mg);
    };
    zg.prototype = Le(Wd.prototype, {constructor:zg, iter:function(a, b, c) {
      ...
      var b = Nf(this.first, 0), c = this.first + this.size - 1;
      Ac(this, {from:b, to:Nf(c, Zd(this, c).text.length), text:this.splitLines(a), origin:"setValue", full:!0}, !0), Aa(this, na(b));
      ...
      for (var h = b && "end" != b && yc(this, d, b), f = d.length - 1; f >= 0; f--) {
        Ac(this, d[f]);
      }
      ...
      return {done:qe(this.history.done), undone:qe(this.history.undone)};
      ...
      a = pa(this, a);
      var b = [], c = Zd(this, a.line).markedSpans;
      if (c) {
        for (var d = 0; d < c.length; ++d) {
          var e = c[d];
      ...
      return a.sharedHist && (d.history = this.history), (this.linked || (this.linked = [])).push({doc:d, sharedHist:a.sharedHist}), d.linked = [{doc:this, isParent:!0, sharedHist:a.sharedHist}], Zc(d, Yc(this)), d;
    ...
    for (var Bg in zg.prototype) {
      zg.prototype.hasOwnProperty(Bg) && He(Ag, Bg) < 0 && (a.prototype[Bg] = function(a) {
        return function() {
    ...
    }, Jg = null, Kg = 30, Lg = a.Pass = {toString:function() {
      return "CodeMirror.Pass";
    }}, Mg = {scroll:!1}, Ng = {origin:"*mouse"}, Og = {origin:"+move"};
    ...
    var Tg, Ug = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/, Vg = a.isWordChar = function(a) {
    ...
    var Yg, Zg, $g = a.rmClass = function(a, b) {
      var c = a.className, d = Ve(b).exec(c);
      if (d) {
    ...
    !function() {
      for (var a = 0; a < 10; a++) {
        gh[a + 48] = gh[a + 96] = String(a);
      }
      for (var a = 65; a <= 90; a++) {
        gh[a] = String.fromCharCode(a);
      }
      for (var a = 1; a <= 12; a++) {
        gh[a + 111] = gh[a + 63235] = "F" + a;
      }
    }();
    var hh, ih = function() {
      function a(a) {
  ...
  !function(d) {
    ...
    function b(b, e, f, g) {
      ...
      if (f && f.call) {
        ...
        var i = d(b, f, "rangeFinder");
      }
      "number" == typeof e && (e = a.Pos(e, 0));
      var j = d(b, f, "minFoldSize"), k = h(!0);
      if (d(b, f, "scanUp")) {
        for (; !k && e.line > b.firstLine();) {
          e = a.Pos(e.line - 1, 0), k = h(!1);
        }
      }
      if (k && !k.cleared && "unfold" !== g) {
        ...
        var m = b.markText(k.from, k.to, {replacedWith:l, clearOnEnter:d(b, f, "clearOnEnter"), __isFold:!0});
    ...
    a.newFoldFunction = function(a, c) {
      ...
      b.operation(function() {
        for (var c = b.firstLine(), d = b.lastLine(); c <= d; c++) {
          b.foldCode(a.Pos(c, 0), null, "fold");
        }
      });
    }, a.commands.unfoldAll = function(b) {
      b.operation(function() {
        for (var c = b.firstLine(), d = b.lastLine(); c <= d; c++) {
          b.foldCode(a.Pos(c, 0), null, "unfold");
        }
      });
    ...
    var e = {rangeFinder:a.fold.auto, widget:"\u2194", minFoldSize:0, scanUp:!1, clearOnEnter:!0};
    a.defineOption("foldOptions", null), a.defineExtension("foldOption", function(a, b) {
      return d(this, a, b);
    });
  });
}, {"../../lib/codemirror":"codemirror"}], foldgutter:[function(a, b, c) {
  !function(d) {
    ...
    function d(a, b) {
      for (var c = a.findMarks(l(b, 0), l(b + 1, 0)), d = 0; d < c.length; ++d) {
        if (c[d].__isFold && c[d].find().from.line == b) {
          return c[d];
        }
      }
    }
    ...
    function f(a, b, c) {
      var f = a.state.foldGutter.options, g = b, h = a.foldOption(f, "minFoldSize"), i = a.foldOption(f, "rangeFinder");
      a.eachLine(b, c, function(b) {
        var c = null;
        if (d(a, g)) {
          c = e(f.indicatorFolded);
        } else {
          var j = l(g, 0), k = i && i(a, j);
...
}, {"../../lib/codemirror":"codemirror", "./foldcode":"foldcode"}], "mode-javascript":[function(a, b, c) {
  !function(d) {
    "object" == typeof c && "object" == typeof b ? d(a("../../lib/codemirror")) : "function" == typeof define && define.amd ? define(["../../lib/codemirror"], d) : d(CodeMirror);
  }(function(a) {
    function b(a, b, c) {
    ...
    a.defineMode("javascript", function(c, d) {
      ...
      function g(a, c) {
        var d = a.next();
        if ('"' == d || "'" == d) {
          return c.tokenize = h(d), c.tokenize(a, c);
        }
        if ("." == d && a.match(/^\d+(?:[eE][+\-]?\d+)?/)) {
        ...
        if ("0" == d && a.eat(/x/i)) {
          return a.eatWhile(/[\da-f]/i), f("number", "number");
        }
        if ("0" == d && a.eat(/o/i)) {
          return a.eatWhile(/[0-7]/i), f("number", "number");
        }
        if ("0" == d && a.eat(/b/i)) {
          return a.eatWhile(/[01]/i), f("number", "number");
        }
        if (/\d/.test(d)) {
          return a.match(/^\d*(?:\.\d*)?(?:[eE][+\-]?\d+)?/), f("number", "number");
        }
        if ("/" == d) {
          return a.eat("*") ? (c.tokenize = i, i(a, c)) : a.eat("/") ? (a.skipToEnd(), f("comment", "comment")) : b(a, c, 1) ? (e(a), a.match(/^\b(([gimyu])(?![gimyu]*\2))+\b/), f("regexp", "string-2")) : (a.eatWhile(Ga), f("operator", "operator", a.current()));
        }
        if ("`" == d) {
          return c.tokenize = j, j(a, c);
        }
        if ("#" == d) {
          return a.skipToEnd(), f("error", "error");
        }
        if (Ga.test(d)) {
          return a.eatWhile(Ga), f("operator", "operator", a.current());
        }
        if (Ea.test(d)) {
          a.eatWhile(Ea);
      ...
      function h(a) {
        return function(b, c) {
          var d, e = !1;
          if (Ba && "@" == b.peek() && b.match(Ha)) {
            return c.tokenize = g, f("jsonld-keyword", "meta");
          }
          for (; null != (d = b.next()) && (d != a || e);) {
            e = !e && "\\" == d;
          }
      ...
      function k(a, b) {
        ...
        if (!(c < 0)) {
          for (var d = 0, e = !1, f = c - 1; f >= 0; --f) {
            var g = a.string.charAt(f), h = Ia.indexOf(g);
            if (h >= 0 && h < 3) {
              if (!d) {
                ++f;
                break;
      ...
      function w(a, b) {
        return "var" == a ? p(t("vardef", b.length), _, v(";"), u) : "keyword a" == a ? p(t("form"), z, w, u) : "keyword b" == a ? p(t("form"), w, u) : "{" == a ? p(t("}"), T, u) : ";" == a ? p() : "if" == a ? ("else" == Ka.state.lexical.info && Ka.state.cc[Ka.state.cc.length - 1] == u && Ka.state.cc.pop()(), p(t("form"), z, w, u, ea)) : "function" == a ? p(ka) : "for" == a ? p(t("form"), fa, w, u) : "variable" == a ? p(t("stat"), M) : "switch" == a ? p(t("form"), z, t("}", "switch"), v("{"), T, 
        u, u) : "case" == a ? p(x, v(":")) : "default" == a ? p(v(":")) : "catch" == a ? p(t("form"), r, v("("), la, v(")"), w, u, s) : "class" == a ? p(t("form"), ma, u) : "export" == a ? p(t("stat"), qa, u) : "import" == a ? p(t("stat"), ra, u) : "module" == a ? p(t("form"), aa, t("}"), v("{"), T, u, u) : "type" == a ? p(W, v("operator"), W, v(";")) : "async" == a ? p(w) : o(t("stat"), x, v(";"), u);
      }
      function x(a) {
        return A(a, !1);
      }
      ...
      function G(a) {
        if ("}" == a) {
          return Ka.marked = "string-2", Ka.state.tokenize = j, p(F);
        }
      }
      function H(a) {
      ...
      function K(a, b) {
        if ("target" == b) {
          return Ka.marked = "keyword", p(D);
        }
      }
      function L(a, b) {
        if ("target" == b) {
          return Ka.marked = "keyword", p(E);
        }
      }
      function M(a) {
      ...
      function ea(a, b) {
        if ("keyword b" == a && "else" == b) {
          return p(t("form", "else"), w, u);
        }
      }
      function fa(a) {
        if ("(" == a) {
      ...
      function ta(a, b) {
        if ("as" == b) {
          return Ka.marked = "keyword", p(sa);
        }
      }
      function ua(a, b) {
        if ("from" == b) {
          return Ka.marked = "keyword", p(x);
        }
      }
      function va(a) {
        return "]" == a ? p() : o(R(y, "]"));
      ...
      var xa, ya, za = c.indentUnit, Aa = d.statementIndent, Ba = d.jsonld, Ca = d.json || Ba, Da = d.typescript, Ea = d.wordCharacters || /[\w$\xa1-\uffff]/, Fa = function() {
        function a(a) {
        ...
        this:a("this"), class:a("class"), super:a("atom"), yield:d, export:a("export"), import:a("import"), extends:d, await:d, async:a("async")};
        if (Da) {
          var h = {type:"variable", style:"variable-3"}, i = {interface:a("class"), implements:d, namespace:d, module:a("module"), enum:a("module"), type:a("type"), public:a("modifier"), private:a("modifier"), protected:a("modifier"), abstract:a("modifier"), as:e, string:h, number:h, boolean:h, any:h};
          for (var j in i) {
            g[j] = i[j];
          }
        }
        return g;
      }(), Ga = /[+\-*&%=<>!?|~^]/, Ha = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/, Ia = "([{}])", Ja = {atom:!0, number:!0, variable:!0, string:!0, regexp:!0, this:!0, "jsonld-keyword":!0}, Ka = {state:null, column:null, marked:null, cc:null}, La = {name:"this", next:{name:"arguments"}};
      return u.lex = !0, {startState:function(a) {
        var b = {tokenize:g, lastType:"sof", cc:[], lexical:new l((a || 0) - za, 0, "block", !1), localVars:d.localVars, context:d.localVars && {vars:d.localVars}, indented:a || 0};
        return d.globalVars && "object" == typeof d.globalVars && (b.globalVars = d.globalVars), b;
      }, token:function(a, b) {
        if (a.sol() && (b.lexical.hasOwnProperty("align") || (b.lexical.align = !1), b.indented = a.indentation(), k(a, b)), b.tokenize != i && a.eatSpace()) {
          return null;
        }
        ...
        for (; ("stat" == h.type || "form" == h.type) && ("}" == f || (e = b.cc[b.cc.length - 1]) && (e == D || e == E) && !/^[,\.=+\-*:?[\(]/.test(c));) {
          h = h.prev;
        }
      ...
      }, electricInput:/^\s*(?:case .*?:|default:|\{|\})$/, blockCommentStart:Ca ? null : "/*", blockCommentEnd:Ca ? null : "*/", lineComment:Ca ? null : "//", fold:"brace", closeBrackets:"()[]{}''\"\"``", helperType:Ca ? "json" : "javascript", jsonldMode:Ba, jsonMode:Ca, expressionAllowed:b, skipExpression:function(a) {
        var b = a.cc[a.cc.length - 1];
        b != x && b != y || a.cc.pop();
      }};
    }), a.registerHelper("wordChars", "javascript", /[\w$]/), a.defineMIME("text/javascript", "javascript"), a.defineMIME("text/ecmascript", "javascript"), a.defineMIME("application/javascript", "javascript"), a.defineMIME("application/x-javascript", "javascript"), a.defineMIME("application/ecmascript", "javascript"), a.defineMIME("application/json", {name:"javascript", json:!0}), a.defineMIME("application/x-json", {name:"javascript", json:!0}), a.defineMIME("application/ld+json", {name:"javascript", 
...
}, {"../../lib/codemirror":"codemirror"}], "mode-sql":[function(a, b, c) {
  !function(d) {
    "object" == typeof c && "object" == typeof b ? d(a("../../lib/codemirror")) : "function" == typeof define && define.amd ? define(["../../lib/codemirror"], d) : d(CodeMirror);
  }(function(a) {
    a.defineMode("sql", function(b, c) {
      function d(a, b) {
        ...
        if (1 == n.hexNumber && ("0" == c && a.match(/^[xX][0-9a-fA-F]+/) || ("x" == c || "X" == c) && a.match(/^'[0-9a-fA-F]+'/))) {
          return "number";
        }
        if (1 == n.binaryNumber && (("b" == c || "B" == c) && a.match(/^'[01]+'/) || "0" == c && a.match(/^b[01]+/))) {
          return "number";
        }
        if (c.charCodeAt(0) > 47 && c.charCodeAt(0) < 58) {
          return a.match(/^[0-9]*\.?[0-9]+([eE][-+]?[0-9]+)?/), 1 == n.decimallessFloat && a.eat("."), "number";
        }
        if ("?" == c && (a.eatSpace() || a.eol() || a.eat(";"))) {
          return "variable-3";
        }
        if ("'" == c || '"' == c && n.doubleQuote) {
          return b.tokenize = e(c), b.tokenize(a, b);
        }
        if ((1 == n.nCharCast && ("n" == c || "N" == c) || 1 == n.charsetCast && "_" == c && a.match(/[a-z][a-z0-9]*/i)) && ("'" == a.peek() || '"' == a.peek())) {
          return "keyword";
        }
        if (/^[\(\),;\[\]]/.test(c)) {
          return null;
        }
        if (n.commentSlashSlash && "/" == c && a.eat("/")) {
          return a.skipToEnd(), "comment";
        }
        if (n.commentHash && "#" == c || "-" == c && a.eat("-") && (!n.commentSpaceRequired || a.eat(" "))) {
          return a.skipToEnd(), "comment";
        }
        if ("/" == c && a.eat("*")) {
          return b.tokenize = f, b.tokenize(a, b);
        }
        if ("." != c) {
          if (m.test(c)) {
            return a.eatWhile(m), null;
          }
      ...
      var i = c.client || {}, j = c.atoms || {false:!0, true:!0, null:!0}, k = c.builtin || {}, l = c.keywords || {}, m = c.operatorChars || /^[*+\-%<>!=&|~^]/, n = c.support || {}, o = c.hooks || {}, p = c.dateSQL || {date:!0, time:!0, timestamp:!0};
      return {startState:function() {
        return {tokenize:d, context:null};
      }, token:function(a, b) {
        if (a.sol() && b.context && null == b.context.align && (b.context.align = !1), a.eatSpace()) {
          return null;
        }
        var c = b.tokenize(a, b);
        if ("comment" == c) {
      ...
      }, blockCommentStart:"/*", blockCommentEnd:"*/", lineComment:n.commentSlashSlash ? "//" : n.commentHash ? "#" : null};
    }), function() {
      function b(a) {
      ...
      a.defineMIME("text/x-sql", {name:"sql", keywords:e(f + "begin"), builtin:e("bool boolean bit blob enum long longblob longtext medium mediumblob mediumint mediumtext time timestamp tinyblob tinyint tinytext text bigint int int1 int2 int3 int4 int8 integer float float4 float8 double char varbinary varchar varcharacter precision real date datetime year unsigned signed decimal numeric"), atoms:e("false true null unknown"), operatorChars:/^[*+\-%<>!=]/, dateSQL:e("date time timestamp"), support:e("ODBCdotTable doubleQuote binaryNumber hexNumber")}), 
      a.defineMIME("text/x-mssql", {name:"sql", client:e("charset clear connect edit ego exit go help nopager notee nowarning pager print prompt quit rehash source status system tee"), keywords:e(f + "begin trigger proc view index for add constraint key primary foreign collate clustered nonclustered declare"), builtin:e("bigint numeric bit smallint decimal smallmoney int tinyint money float real char varchar text nchar nvarchar ntext binary varbinary image cursor timestamp hierarchyid uniqueidentifier sql_variant xml table "), 
  ...
  !function(d) {
    ...
    function c(a) {
      var b = a.getWrapperElement(), c = window.getComputedStyle ? window.getComputedStyle(b) : b.currentStyle, d = parseInt(c.height), e = a.state.panels = {setHeight:b.style.height, heightLeft:d, panels:0, wrapper:document.createElement("div")};
    ...
    a.defineExtension("addPanel", function(a, d) {
      ...
      var e = this.state.panels, f = e.wrapper, g = this.getWrapperElement();
      ...
      var b = null == a ? this.node.offsetHeight : a, c = this.cm.state.panels;
      this.cm._setSize(null, c.height += b - this.height), this.height = b;
    };
  });
}, {"../../lib/codemirror":"codemirror"}], "sqlite-parser":[function(a, b, c) {
  function sqliteParser(a, b, c) {
    var f = (0,e.Tracer)();
    2 === arguments.length && "function" == typeof b && (c = b, b = {});
    var g = "function" == typeof c, h = {tracer:f, startRule:"start"};
    if (b && b.streaming && (h.startRule = "start_streaming"), g) {
      setTimeout(function() {
  ...
  Object.defineProperty(c, "__esModule", {value:!0}), c.default = sqliteParser;
  var d = a("./parser"), e = a("./tracer"), f = a("./streaming");
