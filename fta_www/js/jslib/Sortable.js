...
*/(function(global,factory){
        ...
        (typeof exports === 'object' && typeof module !== 'undefined') ? ( module.exports=factory() ) : ( ((typeof define === 'function' && define.amd) ? ( define(factory) ) : ( global=global || self , global.Sortable=factory() )) );}(this,(function(){
                ...
                return({"captureAnimationState" : function captureAnimationState(){
                            ...
                            animationStates.forEach(function(state){
                                ...
                                if(time){
                                    ...
                                    target.animationResetTimer=setTimeout(function(){
                                        ...
                                        target.thisAnimationDuration=null;},time);
                            ...
                            if(duration){
                                ...
                                target.animated=setTimeout(function(){
                                    ...
                                    target.animatingY=false;},duration);
                            }
                        }});
            }
         ...
         || Safari){
            ...
            if(scrolling && (!(pointerElemChangedInterval) || x !== lastAutoScrollX || y !== lastAutoScrollY)){
                ...
                pointerElemChangedInterval=setInterval(function(){
                    ...
                    autoScroll(evt,_this.options,newElem,fallback);},10);
                lastAutoScrollX=x;
                lastAutoScrollY=y;
            }
        }else{
            ...
            var autoScroll = throttle(function(evt,options,rootEl,isFallback){
                ...
                scrolling=scrollThisInstance;},30);
