        ...
        typeof exports === 'object' && typeof module !== 'undefined' ? ( module.exports=factory() ) : ( (typeof define === 'function' && define.amd ? ( define(factory) ) : ( global=global || self,global.Sortable=factory() )) );
            ...
            function closest(/* #HTMLElement */el,/* #String */selector,/* #HTMLElement */ctx,includeCTX){
                if(el){
                    ...
                    }while(el=getParentOrHost( /*  jshint boss:true  */ el));
                }
                return null;
            }
            var R_SPACE=/\s+/g;
...
*/
            ...
            function AnimationStateManager(){
                ...
                return({captureAnimationState:function captureAnimationState(){
                        animationStates=[];
            ...
            var PluginManager={mount:function mount(plugin){
...
*/
            ...
            var supportCssPointerEvents = function(){
                ...
                el.style.cssText='pointer-events:auto';return(el.style.pointerEvents === 'auto');
            }();
            var _detectDirection = function _detectDirection(el,options){
                ...
                if(child1 && firstChildCSS["float"] && firstChildCSS["float"] !== 'none'){
                    var touchingSideChild2 = (firstChildCSS["float"] === 'left' ? ( 'left' ) : ( 'right' ));return(child2 && (secondChildCSS.clear === 'both' || secondChildCSS.clear === touchingSideChild2) ? ( 'vertical' ) : ( 'horizontal' ));
            ...
            var _detectNearestEmptySortable = function _detectNearestEmptySortable( /* #      * Detects first nearest empty sortable to X and Y position using emptyInsertThreshold.      * @param  {Number} x      X position      * @param  {Number} y      Y position      * @return {HTMLElement}   Element of the first found nearest Sortable       */ x,y){
                var ret;
...
*/
            ...
            Sortable.prototype={
                ...
                _isOutsideThisEl:
                function _isOutsideThisEl(target){
                    if(!(this.el.contains(target)) && target !== this.el){
                        lastTarget=null;
                    }
                },
                _getDirection:
                function _getDirection(evt,target){return(typeof this.options.direction === 'function' ? ( this.options.direction.call(this,evt,target,dragEl) ) : ( this.options.direction ));
                },
                _onTapStart:
                ...
                _prepareDragStart:
                function _prepareDragStart( /* # Event  */ evt, /* # Touch  */ touch, /* # HTMLElement  */ target){
                    var _this=this;
                    var el=_this.el;
                ...
                _triggerDragStart:
                function _triggerDragStart( /* # Event  */ evt, /* # Touch  */ touch){
                ...
                function _onTouchMove( /* #TouchEvent */ evt){
                    if(tapEvt){
                        ...
                        var dy = (touch.clientY - tapEvt.clientY + fallbackOffset.y) / (scaleY || 1) + (relativeScrollOffset ? ( relativeScrollOffset[1] - ghostRelativeParentInitialScroll[1] ) : ( 0 )) / (scaleY || 1);
                ...
                _onDragStart:
                function _onDragStart( /* #Event */ evt, /* #boolean */ fallback){
                    var _this=this;
                ...
                function _onDragOver( /* #Event */ evt){
                    ...
                    if(activeSortable
                     && !(options.disabled)
                     && (isOwner ? ( (canSort
                     || (revert=parentEl !== rootEl)) ) : ( (putSortable === this
                ...
                handleEvent:
                function handleEvent( /* #Event */ evt){
                    switch (evt.type){
                        case 'drop':
  ...
  */
                sort:
                function sort(order,useAnimation){
                    var items={};
                    var rootEl=this.el;
  ...
  */
                ...
                _showClone:
                function _showClone(putSortable){
            ...
            function _ghostIsFirst(evt,vertical,sortable){
                ...
                var spacer=10;return(vertical ? ( (evt.clientX < childContainingRect.left - spacer || evt.clientY < firstElRect.top && evt.clientX < firstElRect.right) ) : ( (evt.clientY < childContainingRect.top - spacer || evt.clientY < firstElRect.bottom && evt.clientX < firstElRect.left) ));
            }
            function _ghostIsLast(evt,vertical,sortable){
                var lastElRect = getRect(lastChild(sortable.el,sortable.options.draggable));
                var childContainingRect = getChildContainingRectFromElement(sortable.el,sortable.options,ghostEl);
                var spacer=10;return(vertical ? ( (evt.clientX > childContainingRect.right + spacer || evt.clientY > lastElRect.bottom && evt.clientX > lastElRect.left) ) : ( (evt.clientY > childContainingRect.bottom + spacer || evt.clientX > lastElRect.right && evt.clientY > lastElRect.top) ));
            }
...
*/
            ...
            function AutoScrollPlugin(){
                ...
                AutoScroll.prototype={
                    ...
                    dragOverCompleted:
                    function dragOverCompleted(_ref2){
                    ...
                    _handleAutoScroll:
                    function _handleAutoScroll(evt,fallback){
                        var _this=this;
            ...
            Revert.prototype={startIndex:null,dragStart:function dragStart(_ref2){
            ...
            Remove.prototype={onSpill:function onSpill(_ref4){
            ...
            function SwapPlugin(){
                ...
                Swap.prototype={dragStart:function dragStart(_ref){
                        var dragEl=_ref.dragEl;
                        lastSwapEl=dragEl;
            ...
            function MultiDragPlugin(){
                function MultiDrag(sortable){
                    ...
                    this.defaults={selectedClass:'sortable-selected',multiDragKey:null,avoidImplicitDeselect:false,setData:function setData(dataTransfer,dragEl){
                            var data='';
                ...
                MultiDrag.prototype={
                    ...
                    isMultiDrag:false,
                    delayStartGlobal:
                    function delayStartGlobal(_ref){
                    ...
                    dragStartGlobal:
                    function dragStartGlobal(_ref6){
                    ...
                    dragOverCompleted:
                    function dragOverCompleted(_ref10){
                    ...
                    _deselectMultiDrag:
                    function _deselectMultiDrag(evt){
                    ...
                    _checkKeyDown:
                    function _checkKeyDown(evt){
                        if(evt.key === this.options.multiDragKey){
                            this.multiDragKeyDown=true;
                        }
                    },
                    _checkKeyUp:
                    function _checkKeyUp(evt){
                        if(evt.key === this.options.multiDragKey){
                            this.multiDragKeyDown=false;
                        }
                    }
                };
                return(_extends(MultiDrag,{pluginName:'multiDrag','utils':{
                        /*#
