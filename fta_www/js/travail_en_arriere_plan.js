         ...
         if(liste_des_travaux_en_arriere_plan[i].etat_du_travail==='travail_en_arriere_plan_enregistré_en_session'){
             ...
             try{
                 ...
                 */
                 ...
                 /*
                 self.importScripts('module1.js');
                 var le_carre=new Rectangle(10,10);
                 console.log('%c le_carre=','background:yellow;color:red;', le_carre, le_carre.surface, le_carre.hauteur, le_carre.largeur );
                 */
