...
class c_rev_vers_sql1{
    ...
    */
    ...
    /*
      =============================================================================================================
    */
    #traite_sqlite_fonction_de_champ(id,niveau,options){
        var t='';
        if(this.#tb[id][1] === 'champ' && this.#tb[id][2] === 'f'){
            if(this.#tb[id][8] === 1 && this.#tb[id + 1][2] === 'c'){
                t+=maConstante(this.#tb[id + 1]);
                return({"__xst" : true ,"__xva" : t});
            }else if(this.#tb[id][8] === 2 && this.#tb[id + 1][2] === 'c' && this.#tb[id + 2][2] === 'c'){
                t+=maConstante(this.#tb[id + 1]) + '.' + maConstante(this.#tb[id + 2]);
                if(options.au_format_php === true
                    ...
                    for( var i=0 ; i < options.tableau_des_tables_utilisees.length ; i++ ){
                        if(options.tableau_des_tables_utilisees[i].nom_de_l_alias === this.#tb[id + 1][1]){
                            for( var j=0 ; i < options.tableau_des_tables_utilisees[i].champs.length ; j++ ){
                                if(options.tableau_des_tables_utilisees[i].champs[j].nom_du_champ === this.#tb[id + 2][1]){
                                    options.type_de_champ_pour_where=options.tableau_des_tables_utilisees[i].champs[j].type;
                                    options.nom_du_champ_pour_where=maConstante(this.#tb[id + 1]) + '.' + maConstante(this.#tb[id + 2]);
                                    break;
                                }
                            }
                        }
                ...
                return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '0114 traite_sqlite_fonction_de_champ'}));
            }
        }
        var operateur_rev=this.#tb[id][1];
        if(operateur_rev === 'sql'){
            ...
            if(obj.__xst === true){
                ...
                return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : 'sql.js 0186 traite_sqlite_fonction_de_champ'}));
            }
            return({"__xst" : true ,"__xva" : t ,"operateur" : operateur_rev});
        }
        var operateur=this.#recuperer_operateur_sqlite(this.#tb[id][1]);
            ...
            if(this.#tb[i][7] === id){
                if(premierChamp === false){
                    if(operateur === 'concat' || operateur === 'max' || operateur === 'min'){
                        ...
                        t=' LIMIT ' + t;
                    }else if(operateur === '' && this.#tb[this.#tb[i][7]][1] === '' && this.#tb[this.#tb[i][7]][2] === 'f' && this.#tb[this.#tb[id][7]][1] === 'dans'){
                ...
                if(this.#tb[i][2] === 'c'){
                    if(this.#tb[i][1].toLowerCase() === 'null'){
                        t+='NULL';
                    }else{
                        if(this.#tb[i][4] === 0){
                            if(options.au_format_php === true){
                                if(this.#tb[i][1].substr(0,1) === ':'){
                                    if(operateur_rev === '' && this.#tb[this.#tb[id][7]][1] === 'dans' || operateur_rev === 'dans'){
                                        debugger;
                                        t+='\'.sq0($par[\'' + this.#tb[i][1].substr(1) + '\']).\'';
                                    }else{
                                        t+='\'.sq1($par[\'' + this.#tb[i][1].substr(1) + '\']).\'';
                                    }
                                }else{
                                    if(operateur_rev === 'moins' && this.#tb[this.#tb[i][7]][8] === 1){
                                        t+='-' + this.#tb[i][1];
                                    }else{
                                        t+=this.#tb[i][1];
                                    }
                            ...
                            if(options.au_format_php === true){
                                if(this.#tb[i][1].substr(0,1) === ':'){
                                    if(operateur_rev === '' && this.#tb[this.#tb[id][7]][1] === 'dans' || operateur_rev === 'dans'){
                                        debugger;
                                        t+='\'.sq0($par[\'' + this.#tb[i][1].substr(1).replace(/\'/g,"''") + '\']).\'';
                                    }else{
                                        t+='\'.sq1($par[\'' + this.#tb[i][1].substr(1).replace(/\'/g,"''") + '\']).\'';
                                    }
                                }else{
                                    t+='\'' + this.#tb[i][1].replace(/\'/g,"''") + '\'';
                                }
                            }else{
                                t+='\'' + this.#tb[i][1].replace(/\'/g,"''") + '\'';
                            }
                    ...
                    var obj=this.#traite_sqlite_fonction_de_champ(i,niveau,options);
                    if(obj.__xst === true){
                        if(premierChamp === false && this.#tb[i][1] === 'sql' && this.#tb[i][2] === 'f'){
                            t+='(' + obj.__xva + ')';
                        }else{
                            t+=obj.__xva;
                        }
                        ...
                        return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '0078 traite_sqlite_fonction_de_champ "' + this.#tb[i][1] + '"'}));
                    }
                }
            }
        }
        if(operateur === 'conditions'){
            ...
            t='concat(' + t + ')';
        }else if(operateur === '' && this.#tb[this.#tb[id][7]][1] === 'dans' && this.#tb[this.#tb[id][7]][2] === 'f'){
            t='(' + t + ')';
    ...
    */
    #rev_sql1(id,niveau,options){
        ...
        var un_espace=espacesn(true,niveau);
        var meta='';
                         ...
                         */
                                         ...
                                         */
                                                     ...
                                                     if(this.#tb[n][1] === 'nom_de_la_table'){
                                                         ...
                                                         for( o=n + 1 ; o < this.#l02 ; o=this.#tb[o][12] ){
                                                             if(this.#tb[o][2] === 'c'){
                                                                 ...
                                                                 return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '0257 nom_de_la_table doit avoir que 1 ou 2 ou 3 paramètre(s) "' + this.#tb[n][1] + '"'}));
                                                             }
                                                         }
                                                         if(nom_de_la_table === ''){
                                                             return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '0262 nom_de_la_table non trouvé "' + this.#tb[n][1] + '"'}));
                                                         }
                                                         if(options.au_format_php === true){
                                                         ...
                                                         if(this.#tb[l][1] === 'jointure_gauche'){
                                                             ...
                                                             return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '0271 type jointure non prévue "' + this.#tb[n][1] + '"'}));
                                                         }
                                                         if(nom_de_l_alias !== ''){
                                                         ...
                                                         return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '0245 seuls nom_de_la_table() et #() sont permis dans source  "' + this.#tb[n][1] + '"'}));
                                                     }
                                                 }
                                             }
                                         }
                                         for( m=l + 1 ; m < this.#l02 ; m=this.#tb[m][12] ){
                                             if(this.#tb[m][1] === 'contrainte'){
                                                 ...
                                                 obj=this.#traite_sqlite_fonction_de_champ(m + 1,niveau,options);
                                                 if(obj.__xst === true){
                                                     liste_des_tables+=' ON ' + obj.__xva + '\n';
                                                 }else{
                                                     return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '0198 erreur sur fonction dans select "' + this.#tb[l][1] + '"'}));
                                                 }
                                             }
                                         }
                                     }
                                 ...
                                 for( l=j + 1 ; l < this.#l02 ; l=this.#tb[l][12] ){
                                     ...
                                     if(this.#tb[l][2] === 'f' && this.#tb[l][1] === '#'){
                                         ...
                                         if(this.#tb[l][8] === 1 && this.#tb[l + 1][2] === 'c'){
                                             ...
                                             */
                                             nom_du_champ=maConstante(this.#tb[l + 1]);
                                             if(options.au_format_php === true){
                                             ...
                                             */
                                             ...
                                             if(tableau_des_alias.length > 0 && dans_tableau_des_alias >= 0){
                                                 nom_du_champ='`' + tableau_des_alias[dans_tableau_des_alias].original + '`.' + maConstante(this.#tb[l + 2]);
                                                 if(options.au_format_php === true){
                                                 ...
                                                 return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '314 erreur select champ "' + this.#tb[l + 1][1] + '"'}));
                                             }
                                             ...
                                             nom_du_champ=maConstante(this.#tb[l + 1]) + ' as ' + maConstante(this.#tb[l + 3]);
                                             if(options.au_format_php === true){
                                                 tableau_des_champs_pour_select_php.push({"type" : 'champ' ,"nom_du_champ" : this.#tb[l + 2][1] ,"alias_champ" : maConstante(this.#tb[l + 3])});
                                             }
                                             ...
                                             if(tableau_des_alias.length > 0 && dans_tableau_des_alias >= 0){
                                                 nom_du_champ='`' + tableau_des_alias[dans_tableau_des_alias].original + '`.' + maConstante(this.#tb[l + 2]) + ' as ' + maConstante(this.#tb[l + 4]);
                                                 if(options.au_format_php === true){
                                                     tableau_des_champs_pour_select_php.push({
                                                             "type" : 'champ' ,
                                                             "alias" : tableau_des_alias[dans_tableau_des_alias].original ,
                                                             "nom_du_champ" : this.#tb[l + 2][1] ,
                                                             "alias_champ" : maConstante(this.#tb[l + 4])
                                                         });
                                                 }
                                             }else{
                                                 return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '314 erreur select champ "' + this.#tb[l + 1][1] + '"'}));
                                             ...
                                             return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '327 erreur select champ "' + this.#tb[l + 1][1] + '"'}));
                                         }
                                         ...
                                         if(this.#tb[l][2] === 'f'){
                                             options.tableau_des_alias=tableau_des_alias;
                                             obj=this.#traite_sqlite_fonction_de_champ(l,niveau,options);
                                             if(obj.__xst === true){
                                             ...
                                             if(this.#tb[l][1].toLowerCase() === 'null'){
                                                 ...
                                                 */
                                                 ...
                                                 if(this.#tb[l][4] === 1){
                                                     ...
                                                     nom_du_champ=maConstante(this.#tb[l]);
                                                 }
                                                 if(options.au_format_php === true){
                                                     tableau_des_champs_pour_select_php.push({"type" : 'constante' ,"valeur" : nom_du_champ});
                                                 }
                         ...
                         for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                             if(this.#tb[j][1] === 'conditions' && this.#tb[j][8] >= 1){
                                 options.tableau_des_alias=tableau_des_alias;
                                 obj=this.#traite_sqlite_fonction_de_champ(j,niveau,options);
                                 if(obj.__xst === true){
                                     liste_des_conditions=obj.__xva;
                                 }else{
                                     return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '0354 erreur sur conditions dans select '}));
                                 }
                             }
                         }
                         ...
                         for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                             if(this.#tb[j][1] === 'complements'){
                                 for( k=j + 1 ; k < this.#l02 && this.#tb[k][3] > this.#tb[k][3] ; k++ ){
                                     if(this.#tb[k][1] === 'limité_à' && this.#tb[k][8] >= 1){
                                         options.tableau_des_alias=tableau_des_alias;
                                         obj=this.#traite_sqlite_fonction_de_champ(k,niveau,options);
                                         if(obj.__xst === true){
                         ...
                         if(liste_des_valeurs !== ''){
                             ...
                             return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '0231 erreur dans select, pas de valeurs sélectionnées'}));
                         }
                   break;
                    case 'modifier' :
                    case 'insérer' :
                         ...
                         for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                             ...
                             if(this.#tb[j][1] === 'sql' && this.#tb[j][8] >= 1){
                                 ...
                                 if(obj.__xst === true){
                                     ...
                                     return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : 'sql.js 828 insert update delete '}));
                                 }
                                     ...
                                     if(this.#tb[l][1] === 'affecte'){
                                         for( m=l + 1 ; m < this.#l02 ; m=this.#tb[m][12] ){
                                             if(this.#tb[m][2] === 'f' && this.#tb[m][1] === 'champ'){
                                                 ...
                                                 if(this.#tb[m][2] === 'f'){
                                                     obj=this.#traite_sqlite_fonction_de_champ(m,niveau,options);
                                                     if(obj.__xst === true){
                                                         valeur_du_champ=obj.__xva;
                                                     }else{
                                                         return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '0198 erreur sur fonction dans update conditions "' + this.#tb[l][1] + '"'}));
                                                     }
                                                 }else{
                         ...
                         for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                             ...
                             if(this.#tb[j][1] === 'meta' && this.#tb[j][2] === 'f' && this.#tb[j][8] > 0){
                                 ...
                                 if(obj.__xst === true){
                                     ...
                                     return(this.#rev_sql_logerreur({"__xst" : false ,"__xva" : t ,"id" : i ,"__xme" : '0930 sql.js erreur dans un meta'}));
                                 }
                             }
                         }
                         if(nam !== '' && list !== '' && def !== ''){
                         ...
                         for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                             ...
                             if(this.#tb[j][1] === 'new_def'){
                                 ...
                                 if(obj.__xst === true){
                                     ...
                                     return(this.#rev_sql_logerreur({"__xst" : false ,"__xva" : t ,"id" : i ,"__xme" : 'sql.js erreur dans un sql définit dans un php'}));
                                 }
                             }
                         }
                         if(nam !== '' && oldnam !== ''){
                   ...
                   break;
                    case 'use' :
                         if(this.#tb[i][8] === 1 && this.#tb[i + 1][2] === 'c'){
                             ...
                             return(this.#rev_sql_logerreur({"__xst" : false ,"__xva" : t ,"id" : i ,"__xme" : 'sql.js erreur dans un sql(use) définit dans un php'}));
                         }
                   break;
                    case 'set' :
                         if(this.#tb[i][8] === 2 && this.#tb[i + 1][2] === 'c' && this.#tb[i + 2][2] === 'c'){
                             ...
                             return(this.#rev_sql_logerreur({"__xst" : false ,"__xva" : t ,"id" : i ,"__xme" : 'sql.js cas non prévu dans un SET()'}));
                         }
                   break;
                    case 'field' :
                         /*
                         ...
                         */
                         ...
                         for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                             if(this.#tb[j][1] === 'nom_du_champ' && this.#tb[j][8] === 1 && this.#tb[j + 1][2] === 'c'){
                                 ...
                                 */
                             ...
                             }else if((this.#tb[j][1] === 'notnull' || this.#tb[j][1] === 'non_nulle' || this.#tb[j][1] === 'not_null') && this.#tb[j][8] === 0){
                                 ...
                                 if(this.#tb[j + 1][1].toLowerCase() === 'null'){
                                     ...
                                     if(this.#tb[j + 1][4] === 0){
                                         definition_sql_du_champ+=' ' + maConstante(this.#tb[j + 1]) + ' ';
                                         variables_pour_tableau_tables.defaut.est_defini=true;
                                         variables_pour_tableau_tables.defaut.valeur=maConstante(this.#tb[j + 1]);
                                     }else if(this.#tb[j + 1][4] === 1){
                                         definition_sql_du_champ+=' \'' + this.#tb[j + 1][1].replace(/\\\'/g,'\'\'').replace(/\\\\/g,'\\') + '\' ';
                                         variables_pour_tableau_tables.defaut.est_defini=true;
                                         variables_pour_tableau_tables.defaut.valeur=maConstante(this.#tb[j + 1]);
                                     }else{
                                         return(this.#rev_sql_logerreur({
                                             "__xst" : false ,
                                             "__xva" : t ,
                                             "id" : i ,
                                 ...
                                 definition_sql_du_champ+=' REFERENCES ' + maConstante(this.#tb[j + 1]) + '(' + maConstante(this.#tb[j + 2]) + ') ';
                                 variables_pour_tableau_tables.reference.est_defini=true;
                                 variables_pour_tableau_tables.reference.table=+maConstante(this.#tb[j + 1]);
                                 variables_pour_tableau_tables.reference.champ=+maConstante(this.#tb[j + 2]);
                                 ...
                                 if(this.#tb[j][8] === 1){
                                     if(this.#tb[j + 1][2] === 'c'){
                                         ...
                                         if(this.#tb[j + 2][2] === 'c'){
                                             ...
                                             return(this.#rev_sql_logerreur({"__xst" : false ,"__xva" : t ,"id" : i ,"__xme" : '0732 sql.js erreur dans un type'}));
                                         }
                                     }
                                     ...
                                     return(this.#rev_sql_logerreur({"__xst" : false ,"id" : i ,"__xme" : '0271 sql.js erreur dans un field'}));
                                 }
                                 ...
                                 return(this.#rev_sql_logerreur({"__xst" : false ,"id" : i ,"__xme" : '0275 sql.js erreur dans un field pour ' + this.#tb[j][1]}));
                             }
                         }
                    ...
                    case  'créer_table' :
                         ...
                         for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                             if(this.#tb[j][1] === 'ifexists' && this.#tb[j][8] === 0){
                                 ...
                                 /*
                                   for( k=j + 1 ; k < this.#l02 ; k++ ){
                                   if(this.#tb[k][3] > this.#tb[j][3]){
                                   }else{
                                   j=k - 1;
                                   debugger
                                   break;
                                 ...
                                 */
                                 ...
                                 t+=' todo sql.js repere 0350 ' + this.#tb[j][1];
                             }
                         }
                    ...
                    case 'drop_table' :
                         ...
                         for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                             if(this.#tb[j][1] === 'ifexists' && this.#tb[j][8] === 0){
                                 ...
                                 t+=' todo sql.js repere 0375 "' + this.#tb[j][1] + '" ';
                             }
                         }
                         t+=';';
                   break;
                         ...
                         for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                             if(this.#tb[j][3] === this.#tb[i][3] + 1){
                                 if(this.#tb[j][1] === 'ifnotexists' && this.#tb[j][8] === 0){
                                     ...
                                     t+=' todo sql.js repere 1374 "' + this.#tb[j][1] + '"';
                                 }
                             }
                         }
                         t+=';';
                   ...
                   break;
                    case  'meta' :
                         ...
                         if(obj.__xst === true){
                             ...
                             return(this.#rev_sql_logerreur({"__xst" : false ,"__xva" : t ,"id" : i ,"__xme" : '1057 sql.js erreur dans un meta'}));
                         }
