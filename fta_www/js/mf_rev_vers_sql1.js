        ...
        for( var i=id + 1 ; i < l01 ; i=tab[i][12] ){
            ...
            if(tab[i][2] === 'c'){
                ...
                if(obj.__xst === true){
                    ...
                    return(this.#rev_sql_logerreur({"__xst" : false ,"__xme" : '0078 traite_sqlite_fonction_de_champ "' + tab[i][1] + '"'}));
                }
            }
        }
                   ...
                   break;
                    case  'transaction':
                         ...
                         if(obj.__xst === true){
                             ...
                             return(this.#rev_sql_logerreur({"__xst" : false ,"__xva" : t ,"id" : i ,"__xme" : nl()+'transaction'}));
                         }
                   break;
                    case '#':
                         if(this.#tb[i][13] === ''){
