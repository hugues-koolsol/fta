        ...
        if(tab[i][1]==='definir' && tab[i][2]==='f' ){
            ...
            if(tab[i+2][2]==='f' && tab[i+2][1] === 'appelf' ){
             ...
             if(obj.__xst===true){
              ...
              return php_logerr({__xst:false,__xva:t,id:id,tab:tab,__xme:'il faut un nom de fonction à appeler n(xxxx)'});
             }
            }else if(tab[i+2][2]==='c' ){
                 ...
                 for(j=positionDeclarationFonction+1;j<l01 && tab[j][3]>tab[positionDeclarationFonction][3];j++){
                     if(tab[j][1]==='argument' && tab[j][3]===tab[positionDeclarationFonction][3]+1){
                         if(tab[j][8]===1){
                             ...
                             return php_logerr({__xst:false,__xva:t,id:i,tab:tab,__xme:'0325 les arguments passés à la fonction doivent être sous la forme  a(xxx) '});
                         }
...
//                             return php_logerr({__xst:false,__xva:t,id:i,tab:tab,__xme:'0331 les arguments passés à la fonction doivent être sous la forme  a(xxx) '});
                         }else{
                             return php_logerr({__xst:false,__xva:t,id:i,tab:tab,__xme:'0268 les arguments passés à la fonction doivent être sous la forme  a(xxx) '});
                         }
                     }
                 }
      ...
      //   console.log('\n\n\n\n=====commentaire = "'+tab[i][13]+'"\n====\ntab='+JSON.stringify(tab)+'\n=============\n' )
          ...
          if(obj.__xst===true){
           ...
           return(php_logerr({__xst:false,__xva:t,id:i,tab:tab,__xme:'php dans php_tabToPhp1 0936 pour i='+i+' et tab[i][1]="'+tab[i][1]+'"'}));
          }
     ...
     for( var i=ind+1;i<l01 && tab[i][3]>tab[ind][3];i++){
         if(tab[i][7]===ind){
             if(tab[i][1]==='definition' && tab[i][2]==='f'){
                 for(var j=i+1;j<l01 && tab[j][3]>tab[i][3];j++){
                     if(tab[j][7]===i){
                         if(tab[j][1]==='nomm' && tab[j][2]==='f' && tab[j][8]===1 && tab[j+1][2]==='c'){
                             ...
                             return( php_logerr({__xst:false,__xva:t,id:ind,tab:tab,__xme:'1358 dans php_traiteElement'}));
                         }
                     }
                 }
                 if(nom_methode===''){
                 ...
                 return(php_logerr({__xst:false,__xva:t,id:ind,tab:tab,__xme:'1344 dans php_traiteElement'}));
             }
         }
     }
...
//      t=obj.__xva;
     ...
     if(tab[ind][8]===2){
         ...
         if(obj1.__xst===true){
            ...
            return(php_logerr({__xst:false,__xva:t,ind:ind,tab:tab,__xme:'1634 php_traiteElement propriété '}));
         }
     ...
     if(tab[ind][8]===1 && tab[ind+1][2]==='c'){
      ...
      return php_logerr({__xst:false,__xva:t,id:ind,tab:tab,__xme:'php.js 1506 php_traiteElement "'+tab[ind][1]+'" non traité '});
     /*#
      ========================================================
...
function php_traiteAppelFonction(tab,i,dansConditionOuDansFonction,niveau){
 ...
 if(positionAppelFonction>0 && nomFonction!='' ){
  ...
  return php_logerr({__xst:false,__xva:t,id:i,tab:tab,__xme:'il faut un nom de fonction à appeler n(xxxx)'});
 }
 return {__xst:true,__xva:t};
}
//=====================================================================================================================
