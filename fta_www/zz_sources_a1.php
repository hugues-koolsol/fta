...
if(!(isset($_SESSION[CLE_APPLI]['cible_courante']))){
...
function erreur_dans_champs_saisis_sources(){
    ...
    if($_SESSION[CLE_APPLI][NAV][BNF]['chp_nom_source'] === ''){
    ...
    if(substr($_SESSION[CLE_APPLI][NAV][BNF]['chp_nom_source'],0,1) === ' '){
...
if((isset($_POST)) && (sizeof($_POST) >= 1)){
    ...
    $_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source']=((isset($_POST['chi_id_source']))?decrypter($_POST['chi_id_source']):'');
    $_SESSION[CLE_APPLI][NAV][BNF]['chp_nom_source']=$_POST['chp_nom_source']??'';
    $_SESSION[CLE_APPLI][NAV][BNF]['chp_type_source']=$_POST['chp_type_source']??'normal';
    $_SESSION[CLE_APPLI][NAV][BNF]['chx_cible_id_source']=$_POST['chx_cible_id_source']??$_SESSION[CLE_APPLI]['cible_courante']['chi_id_cible'];
    $_SESSION[CLE_APPLI][NAV][BNF]['chp_commentaire_source']=$_POST['chp_commentaire_source']??'';
    $_SESSION[CLE_APPLI][NAV][BNF]['chp_rev_source']=$_POST['chp_rev_source']??'';
    $_SESSION[CLE_APPLI][NAV][BNF]['chp_genere_source']=$_POST['chp_genere_source']??'';
    $_SESSION[CLE_APPLI][NAV][BNF]['chx_dossier_id_source']=((isset($_POST['chx_dossier_id_source']))?decrypter($_POST['chx_dossier_id_source']):'');
    ...
    if(isset($_POST['__importer_le_fichier_source_de_fta'])){
        ...
        */
        ...
        if(($_SESSION[CLE_APPLI]['cible_courante']['chp_nom_cible'] === 'fta') && ($_SESSION[CLE_APPLI]['cible_courante']['chp_dossier_cible'] !== 'fta')){

            $__valeurs=recupere_une_donnees_des_sources_avec_parents($_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source'],$GLOBALS[BDD][BDD_1][LIEN_BDD]);
        ...
        recharger_la_page(BNF.'?__action=__modification&__id='.$_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source']);
        ...
        */
        ...
        if($_SESSION[CLE_APPLI][NAV][BNF]['chp_genere_source'] !== ''){

            require_once('../fta_inc/phplib/sqlite.php');
            $ret=produire_un_tableau_de_la_structure_d_une_bdd_grace_a_un_source_de_structure($_SESSION[CLE_APPLI][NAV][BNF]['chp_genere_source']);

            if($ret['status'] === true){

                $_SESSION[CLE_APPLI][NAV][BNF]['tableauDesTables']=$ret['value'];
        ...
        */
        ...
        if(($__valeurs['T2.chp_dossier_cible'] !== null) && ($__valeurs['T1.chp_nom_dossier'] !== null)){
            ...
            $nomCompletSource='../../'.$__valeurs['T2.chp_dossier_cible'].$__valeurs['T1.chp_nom_dossier'].'/'.$_SESSION[CLE_APPLI][NAV][BNF]['chp_nom_source'];
            ...
            if($fd=fopen($nomCompletSource,'w')){
                ...
                $ret=fwrite($fd,$_SESSION[CLE_APPLI][NAV][BNF]['chp_genere_source']);
        ...
        */
        ...
        if(erreur_dans_champs_saisis_sources()){
            ...
            if((isset($_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source'])) && (is_numeric($_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source']))){

                recharger_la_page(BNF.'?__action=__modification&__id='.$_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source']);

            }else{

                ajouterMessage('erreur',__LINE__.' : POST __id1 = '.$_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source']);
        ...
        if($_SESSION[CLE_APPLI][NAV][BNF]['verification'][0] != $_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source']){
        ...
        if($_SESSION[CLE_APPLI][NAV][BNF]['chx_dossier_id_source'] === ''){


        }else{

            $nouveau_dossier=recupere_une_donnees_des_dossiers_avec_parents($_SESSION[CLE_APPLI][NAV][BNF]['chx_dossier_id_source'],$GLOBALS[BDD][BDD_1][LIEN_BDD]);
            /*      echo __FILE__ . ' ' . __LINE__ . ' $nouveau_dossier = <pre>' . var_export( $nouveau_dossier , true ) . '</pre>' ; exit(0);*/
            $nom_complet_du_nouveau_fichier='../../'.$nouveau_dossier['T1.chp_dossier_cible'].$nouveau_dossier['T0.chp_nom_dossier'].'/'.$_SESSION[CLE_APPLI][NAV][BNF]['chp_nom_source'];
   ...
   UPDATE `'.$GLOBALS[BDD][BDD_1]['nom_bdd'].'`.`tbl_sources` SET 
      `chp_nom_source`         = \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chp_nom_source']).'\'
    , `chp_type_source`        = \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chp_type_source']).'\'
    , `chx_dossier_id_source`  = \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chx_dossier_id_source']).'\'
    , `chx_cible_id_source`    = \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chx_cible_id_source']).'\'
    , `chp_commentaire_source` = \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chp_commentaire_source']).'\'
    , `chp_rev_source`         = \''.sq1($_SESSION[CLE_APPLI][NAV][BNF]['chp_rev_source']).'\'  
    , `chp_genere_source`      = \''.sq1($_SESSION[CLE_APPLI][NAV][BNF]['chp_genere_source']).'\'
    
    
    WHERE 
      `chi_id_source`          = '.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source']).'
  ';
        /* */
        /*  echo $sql;*/
        ...
        */
        ...
        if($_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source'] !== false){

            $__valeurs=recupere_une_donnees_des_sources_avec_parents($_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source'],$GLOBALS[BDD][BDD_1][LIEN_BDD]);

            if((CLE_APPLI !== 'fta') && ($__valeurs['T2.chp_dossier_cible'] === 'fta')){
        ...
        $sql='DELETE FROM `'.$GLOBALS[BDD][BDD_1]['nom_bdd'].'`.tbl_revs WHERE `chx_source_rev` = '.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source']).' ';
        ...
        if(false === $GLOBALS[BDD][BDD_1][LIEN_BDD]->exec($sql)){
            ...
            $sql='DELETE FROM `'.$GLOBALS[BDD][BDD_1]['nom_bdd'].'`.tbl_sources WHERE `chi_id_source` = \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chi_id_source']).'\' ';
   ...
   INSERT INTO `'.$GLOBALS[BDD][BDD_1]['nom_bdd'].'`.`tbl_sources` (`chp_nom_source` , chx_dossier_id_source , chx_cible_id_source, `chp_commentaire_source`, `chp_rev_source` , chp_genere_source , chp_type_source  ) VALUES
     (
        \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chp_nom_source']).'\'
      , \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chx_dossier_id_source']).'\'
      , \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chx_cible_id_source']).'\'
      , \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chp_commentaire_source']).'\'
      , \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chp_rev_source']).'\'
      , \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chp_genere_source']).'\'      
      , \''.sq0($_SESSION[CLE_APPLI][NAV][BNF]['chp_type_source']).'\'
     )
  ';
        /*  echo __FILE__ . ' ' . __LINE__ . ' __LINE__ = <pre>' . var_export( $sql , true ) . '</pre>' ; exit(0);*/
        ...
        unset($_SESSION[CLE_APPLI][NAV][BNF]);
    ...
    */
    ...
    if(isset($_SESSION[CLE_APPLI][NAV][BNF])){
...
$o1.='<h1>gestion de source (dossier '.$_SESSION[CLE_APPLI]['cible_courante']['chp_dossier_cible'].')'.bouton_retour_a_la_liste('zz_sources_l1.php').'</h1>';
...
if((isset($_GET['__action'])) && ($_GET['__action'] == '__suppression')){
    ...
    */
    /*
      ...
      http://localhost/functToArray/fta/fta_www/zz_sources_a1.php?__id=2&__action=__suppression
    */
    $_SESSION[CLE_APPLI][NAV][BNF]['verification']=array( $__id);
    ...
    */
    ...
    $chp_nom_source=((isset($_SESSION[CLE_APPLI][NAV][BNF]['chp_nom_source']))?$_SESSION[CLE_APPLI][NAV][BNF]['chp_nom_source']:'');
    ...
    $o1.='  </div></div>'.CRLF;
    $o1.=' </div>'.CRLF;
    $chp_type_source=((isset($_SESSION[CLE_APPLI][NAV][BNF]['chp_type_source']))?$_SESSION[CLE_APPLI][NAV][BNF]['chp_type_source']:'normal');
    $o1.=' <div class="yyfdiv1">'.CRLF;
    ...
    $o1.='  </div></div>'.CRLF;
    $o1.=' </div>'.CRLF;
    $chx_dossier_id_source=((isset($_SESSION[CLE_APPLI][NAV][BNF]['chx_dossier_id_source']))?$_SESSION[CLE_APPLI][NAV][BNF]['chx_dossier_id_source']:'');
    $o1.=' <div class="yyfdiv1">'.CRLF;
    ...
    */
    $chp_commentaire_source=((isset($_SESSION[CLE_APPLI][NAV][BNF]['chp_commentaire_source']))?$_SESSION[CLE_APPLI][NAV][BNF]['chp_commentaire_source']:'');
    $o1.=' <div class="yyfdiv1">'.CRLF;
    ...
    */
    ...
    $_SESSION[CLE_APPLI][NAV][BNF]['verification']=array( $__id);
    $__valeurs['T0.chp_nom_source']=$_SESSION[CLE_APPLI][NAV][BNF]['chp_nom_source']??$__valeurs['T0.chp_nom_source'];
    $__valeurs['T0.chp_type_source']=$_SESSION[CLE_APPLI][NAV][BNF]['chp_type_source']??$__valeurs['T0.chp_type_source'];
    $__valeurs['T0.chx_dossier_id_source']=$_SESSION[CLE_APPLI][NAV][BNF]['chx_dossier_id_source']??$__valeurs['T0.chx_dossier_id_source'];
    $__valeurs['T0.chx_cible_id_source']=$_SESSION[CLE_APPLI][NAV][BNF]['chx_cible_id_source']??$__valeurs['T0.chx_cible_id_source'];
    $__valeurs['T0.chp_commentaire_source']=$_SESSION[CLE_APPLI][NAV][BNF]['chp_commentaire_source']??$__valeurs['T0.chp_commentaire_source'];
    $__valeurs['T0.chp_rev_source']=$_SESSION[CLE_APPLI][NAV][BNF]['chp_rev_source']??$__valeurs['T0.chp_rev_source'];
    $__valeurs['T0.chp_genere_source']=$_SESSION[CLE_APPLI][NAV][BNF]['chp_genere_source']??$__valeurs['T0.chp_genere_source'];
    ...
    if($__valeurs['T0.chp_type_source'] === 'module_js'){
        ...
        if(strpos($__valeurs['T0.chp_nom_source'],'.js') !== false){
            ...
            $o1.='   <a class="yyinfo" href="javascript:convertir_rev_en_js(\'chp_rev_source\',\'chp_genere_source\','.$__id.','.$_SESSION[CLE_APPLI]['cible_courante']['chi_id_cible'].')">R-&gt;J&#8615;</a>'.CRLF;
        ...
        if(strpos($__valeurs['T0.chp_nom_source'],'.js') !== false){
            ...
            $o1.='   <a class="yyinfo" href="javascript:convertir_rev_en_html(\'chp_rev_source\',\'chp_genere_source\','.$__id.','.$_SESSION[CLE_APPLI]['cible_courante']['chi_id_cible'].')">R2H&#8615;</a>'.CRLF;
            ...
            $o1.='   <a class="yyinfo" href="javascript:convertir_rev_en_php_et_sauvegarde_rev(\'chp_rev_source\',\'chp_genere_source\','.$__id.','.$_SESSION[CLE_APPLI]['cible_courante']['chi_id_cible'].')">R2P&#8615;</a>'.CRLF;
            ...
            $o1.='   <a class="yyinfo" href="javascript:convertir_rev_en_sql(\'chp_rev_source\',\'chp_genere_source\','.$__id.','.$_SESSION[CLE_APPLI]['cible_courante']['chi_id_cible'].')">&#8615; rev =&gt; sql &#8615;</a>'.CRLF;
            ...
            $o1.='   <a class="yyinfo" href="javascript:convertir_rev_en_texte(\'chp_rev_source\',\'chp_genere_source\','.$__id.','.$_SESSION[CLE_APPLI]['cible_courante']['chi_id_cible'].')">&#8615; rev =&gt; texte &#8615;</a>'.CRLF;
    ...
    if((isset($_SESSION[CLE_APPLI][NAV][BNF]['tableauDesTables'])) && (count($_SESSION[CLE_APPLI][NAV][BNF]['tableauDesTables']) > 0)){

        /* echo __FILE__ . ' ' . __LINE__ . ' __LINE__ = <pre>' . var_export( $_SESSION[APP_KEY][NAV][BNF]['tableauDesTables'] , true ) . '</pre>' ; */
        $js_a_executer_apres_chargement[]=array( 'nomDeLaFonctionAappeler' => 'traite_le_tableau_de_la_base_sqlite_v2', 'parametre' => array( 'donnees' => $_SESSION[CLE_APPLI][NAV][BNF]['tableauDesTables'], 'zone_rev' => 'chp_rev_source'));
        unset($_SESSION[CLE_APPLI][NAV][BNF]['tableauDesTables']);
